...
enum class ESlotClickType : uint8_t
{
	...
	ESlotClickType__All            = 10,
	ESlotClickType__ESlotClickType_MAX = 11
};
...
struct FBlockParam
{
	...
	struct FText                                       DisplayName;                                              // 0x000C(0x000C) (Edit, BlueprintVisible)
	bool                                               bIsEnabled;                                               // 0x0018(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
...
struct FBlockySlotString
{
	...
	struct FString                                     CustomStr;                                                // 0x0028(0x000C) (ZeroConstructor)
};
...
struct FGraphString
{
	...
	struct FString                                     DisplayName;                                              // 0x001C(0x000C) (ZeroConstructor)
	struct FString                                     TemplateName;                                             // 0x0028(0x000C) (ZeroConstructor)
};
...
struct FCustomConfigString
{
	struct FGuid                                       ID;                                                       // 0x0000(0x0010) (IsPlainOldData)
	struct FString                                     Name;                                                     // 0x0010(0x000C) (ZeroConstructor)
	TEnumAsByte<ECustomBlockType>                      Type;                                                     // 0x001C(0x0001) (ZeroConstructor, IsPlainOldData)
...
{
	struct FString                                     RectName;                                                 // 0x0000(0x000C) (ZeroConstructor)
	struct FString                                     TexturePath;                                              // 0x000C(0x000C) (ZeroConstructor)
	float                                              TextureWidth;                                             // 0x0018(0x0004) (ZeroConstructor, IsPlainOldData)
	float                                              TextureHeight;                                            // 0x001C(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                DrawTypeInt;                                              // 0x0020(0x0004) (ZeroConstructor, IsPlainOldData)
	struct FVector2D                                   StartUV;                                                  // 0x0024(0x0008) (IsPlainOldData)
	struct FVector2D                                   SizeUV;                                                   // 0x002C(0x0008) (IsPlainOldData)
	struct FMargin                                     RectMargin;                                               // 0x0034(0x0010) (IsPlainOldData)
	int                                                CrossDelta;                                               // 0x0044(0x0004) (ZeroConstructor, IsPlainOldData)
	float                                              RectAngle;                                                // 0x0048(0x0004) (ZeroConstructor, IsPlainOldData)
	struct FVector2D                                   RectSize;                                                 // 0x004C(0x0008) (IsPlainOldData)
};
...
struct FSequence
{
	TArray<struct FString>                             SequenceNames;                                            // 0x0000(0x000C) (ZeroConstructor)
};
...
struct FType
{
	...
	struct FString                                     TypeName;                                                 // 0x0040(0x000C) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor)
...
{
	class UBrushData*                                  Brush;                                                    // 0x0000(0x0004) (ZeroConstructor, IsPlainOldData)
	class UBlockBase*                                  InsideHostBlock;                                          // 0x0004(0x0004) (ZeroConstructor, IsPlainOldData)
...
{
	class UClass*                                      BlockType;                                                // 0x0000(0x0004) (ZeroConstructor, IsPlainOldData)
...
struct FStubType
{
	...
	class UScriptStruct*                               Struct;                                                   // 0x0004(0x0004) (ZeroConstructor, IsPlainOldData)
};
...
{
	class UObject*                                     OverrideContext;                                          // 0x0000(0x0004) (ZeroConstructor, IsPlainOldData)
	class UObject*                                     Host;                                                     // 0x0004(0x0004) (ZeroConstructor, IsPlainOldData)
	struct FString                                     Name;                                                     // 0x0008(0x000C) (ZeroConstructor)
	TArray<unsigned char>                              ArgumentsData;                                            // 0x0014(0x000C) (ZeroConstructor)
	TArray<unsigned char>                              ReturnData;                                               // 0x0020(0x000C) (ZeroConstructor)
	TArray<struct FStubType>                           ArgTypes;                                                 // 0x002C(0x000C) (ZeroConstructor)
	struct FStubType                                   ReturnType;                                               // 0x0038(0x0008)
...
{
	TArray<struct FString>                             Infos;                                                    // 0x0000(0x000C) (ZeroConstructor)
	class UBlockBase*                                  SlotHostBlock;                                            // 0x000C(0x0004) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x14];                                      // 0x0010(0x0014) MISSED OFFSET
	class UBlockBase*                                  TargetBlock;                                              // 0x0024(0x0004) (ZeroConstructor, IsPlainOldData)
...
struct FQuoteData
{
	...
	struct FString                                     BlockName;                                                // 0x0008(0x000C) (Edit, BlueprintVisible, ZeroConstructor)
	struct FString                                     GraphName;                                                // 0x0014(0x000C) (Edit, BlueprintVisible, ZeroConstructor)
};
...
struct FMsgData
{
	struct FText                                       Info;                                                     // 0x0000(0x000C)
	class UBlockBase*                                  SourceBlock;                                              // 0x000C(0x0004) (ZeroConstructor, IsPlainOldData)
...
struct FNamedVarData
{
	...
	unsigned char                                      UnknownData00[0x3];                                       // 0x0001(0x0003) MISSED OFFSET
	class UVarDefiner*                                 Definer;                                                  // 0x0004(0x0004) (ZeroConstructor, IsPlainOldData)
	bool                                               bIsArray;                                                 // 0x0008(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x3];                                       // 0x0009(0x0003) MISSED OFFSET
	struct FString                                     InitValueString;                                          // 0x000C(0x000C) (ZeroConstructor)
};
