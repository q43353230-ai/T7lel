...
public:
	...
	struct FScriptMulticastDelegate                    OnRenderQualityChangedEvent;                              // 0x015C(0x000C) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	class UWorld*                                      CurrentGameStatusWorld;                                   // 0x0168(0x0004) (ZeroConstructor, IsPlainOldData)
...
public:
	...
	TMap<struct FString, class UProperty*>             NameToProperty;                                           // 0x008C(0x0050) (ZeroConstructor)
...
public:
	...
	class UCanvasPanel*                                ContainerCache;                                           // 0x0360(0x0004) (ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData)
