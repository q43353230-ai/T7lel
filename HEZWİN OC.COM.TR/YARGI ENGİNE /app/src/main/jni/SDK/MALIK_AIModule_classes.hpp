...
public:
	...
	unsigned char                                      bStopAILogicOnUnposses : 1;                               // 0x03A8(0x0001) (Edit, BlueprintVisible)
	unsigned char                                      bLOSflag : 1;                                             // 0x03A8(0x0001)
	unsigned char                                      bSkipExtraLOSChecks : 1;                                  // 0x03A8(0x0001)
	unsigned char                                      bAllowStrafe : 1;                                         // 0x03A8(0x0001)
	unsigned char                                      bWantsPlayerState : 1;                                    // 0x03A8(0x0001)
	unsigned char                                      bSetControlRotationFromPawnOrientation : 1;               // 0x03A8(0x0001) (Edit, BlueprintVisible)
	unsigned char                                      UnknownData01[0x3];                                       // 0x03A9(0x0003) MISSED OFFSET
	class UPathFollowingComponent*                     PathFollowingComponent;                                   // 0x03AC(0x0004) (Edit, ExportObject, ZeroConstructor, DisableEditOnInstance, EditConst, InstancedReference, IsPlainOldData)
	class UBrainComponent*                             BrainComponent;                                           // 0x03B0(0x0004) (BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData)
	class UAIPerceptionComponent*                      PerceptionComponent;                                      // 0x03B4(0x0004) (Edit, ExportObject, ZeroConstructor, DisableEditOnInstance, EditConst, InstancedReference, IsPlainOldData)
	class UPawnActionsComponent*                       ActionsComp;                                              // 0x03B8(0x0004) (BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, InstancedReference, IsPlainOldData)
	class UBlackboardComponent*                        Blackboard;                                               // 0x03BC(0x0004) (BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, InstancedReference, IsPlainOldData)
	class UGameplayTasksComponent*                     CachedGameplayTasksComponent;                             // 0x03C0(0x0004) (ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData)
	class UClass*                                      DefaultNavigationFilterClass;                             // 0x03C4(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	struct FScriptMulticastDelegate                    ReceiveMoveCompleted;                                     // 0x03C8(0x000C) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	unsigned char                                      UnknownData02[0x1];                                       // 0x03D4(0x0001) MISSED OFFSET
	bool                                               UseGameplayTasksComponent;                                // 0x03D5(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bShareNavigationSystem;                                   // 0x03D6(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData03[0x1];                                       // 0x03D7(0x0001) MISSED OFFSET
	struct FVector                                     ShareNavSysOffset;                                        // 0x03D8(0x000C) (Edit, BlueprintVisible, IsPlainOldData)
	bool                                               bEnableActiveRegion;                                      // 0x03E4(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData04[0x3];                                       // 0x03E5(0x0003) MISSED OFFSET
...
public:
	...
	TArray<struct FAIDynamicParam>                     QueryConfig;                                              // 0x0668(0x000C) (Edit, ZeroConstructor)
	float                                              TimeLimitPerStep;                                         // 0x0674(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	int                                                StepToDebugDraw;                                          // 0x0678(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	EEnvQueryHightlightMode                            HighlightMode;                                            // 0x067C(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      bDrawLabels : 1;                                          // 0x067D(0x0001) (Edit)
	unsigned char                                      bDrawFailedItems : 1;                                     // 0x067D(0x0001) (Edit)
	unsigned char                                      bReRunQueryOnlyOnFinishedMove : 1;                        // 0x067D(0x0001) (Edit)
	unsigned char                                      bShouldBeVisibleInGame : 1;                               // 0x067D(0x0001) (Edit)
	unsigned char                                      bTickDuringGame : 1;                                      // 0x067D(0x0001) (Edit)
	TEnumAsByte<EEnvQueryRunMode>                      QueryingMode;                                             // 0x067E(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x21];                                      // 0x067F(0x0021) MISSED OFFSET
