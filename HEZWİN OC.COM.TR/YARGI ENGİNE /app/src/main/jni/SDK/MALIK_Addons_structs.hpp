...
{
	TArray<class UProperty*>                           Properties;                                               // 0x0000(0x000C) (ZeroConstructor, Transient)
};
...
{
	class UAnimInstance*                               SourceAnimInstance;                                       // 0x0460(0x0004) (ZeroConstructor, Transient, IsPlainOldData)
	TArray<struct FName>                               SourceInstancePropertyNames;                              // 0x0464(0x000C) (ZeroConstructor, Transient)
	TArray<class UProperty*>                           SourceInstanceProperty;                                   // 0x0470(0x000C) (ZeroConstructor, Transient)
	TMap<class UAnimInstance*, struct FCopyPropertyData> DestInstancePropertyMap;                                  // 0x047C(0x0050) (ZeroConstructor, Transient)
...
{
	class UAnimMontage*                                CreatureMontage;                                          // 0x0000(0x0004) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	class UAnimMontage*                                RiderMontage;                                             // 0x0004(0x0004) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	class UCurveVector*                                LocationCurve;                                            // 0x0008(0x0004) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	class UCurveVector*                                RotationCurve;                                            // 0x000C(0x0004) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	float                                              PlayRate;                                                 // 0x0010(0x0004) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	float                                              Duration;                                                 // 0x0014(0x0004) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	float                                              StartTime;                                                // 0x0018(0x0004) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	float                                              CameraLerpStartTime;                                      // 0x001C(0x0004) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	float                                              CameraLerpDuration;                                       // 0x0020(0x0004) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
};
...
{
	class UCurveVector*                                CurveOmega;                                               // 0x0000(0x0004) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	float                                              OmegaAccel;                                               // 0x0004(0x0004) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	float                                              RPMScale;                                                 // 0x0008(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
};
...
{
	class UMaterial*                                   BaseMaterial;                                             // 0x0000(0x0004) (ZeroConstructor, Transient, IsPlainOldData)
	TMap<struct FName, class UTexture*>                ParamNameToTexture2DMap;                                  // 0x0004(0x0050) (ZeroConstructor, Transient)
};
...
{
	TArray<class USkeletalMeshComponent*>              MeshComponentToMerge;                                     // 0x0000(0x000C) (ExportObject, ZeroConstructor, Transient)
	TMap<class UMaterialInterface*, struct FAvatarMaterialGameThreadInfo> MatInterfaceToGameThreadInfoMap;                          // 0x000C(0x0050) (ZeroConstructor, Transient)
	TMap<int, struct FWaitSetParamTexture>             WaitForUpdateAndSetParamTextureMap;                       // 0x0048(0x0050) (ZeroConstructor, Transient)
	TArray<class UTexture2D*>                          CreateForAsyncThreadTextureArray;                         // 0x0084(0x000C) (ZeroConstructor, Transient)
	TMap<class UMaterial*, class UMaterialInstanceDynamic*> CreateForAsyncThreadMaterialMap;                          // 0x0090(0x0050) (ZeroConstructor, Transient)
	class UMaterialInstanceDynamic*                    CreateForAsyncThreadBasicMaterial;                        // 0x00CC(0x0004) (ZeroConstructor, Transient, IsPlainOldData)
...
struct FFlyBioVehicleFlyingConfig
{
	...
	class UCurveFloat*                                 FlySteeringRotationSpeedCurve;                            // 0x0024(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
};
...
struct FCustomVOHelper
{
	...
	TArray<struct FHitResult>                          VO_Obstacles;                                             // 0x0018(0x000C) (ZeroConstructor)
	float                                              VO_Duration;                                              // 0x0024(0x0004) (ZeroConstructor, IsPlainOldData)
	struct FVector                                     VO_CacheVelocity;                                         // 0x0028(0x000C) (IsPlainOldData)
	struct FVector                                     VO_ObstacleCenter;                                        // 0x0034(0x000C) (IsPlainOldData)
	struct FVector                                     VO_OriginLoc;                                             // 0x0040(0x000C) (IsPlainOldData)
	int                                                VO_Step;                                                  // 0x004C(0x0004) (ZeroConstructor, IsPlainOldData)
	struct FVector                                     Jump_Velocity;                                            // 0x0050(0x000C) (IsPlainOldData)
	float                                              CD;                                                       // 0x005C(0x0004) (ZeroConstructor, IsPlainOldData)
};
...
struct FBlanketDanceData
{
	...
	unsigned char                                      UnknownData00[0x3];                                       // 0x0001(0x0003) MISSED OFFSET
	class ASTExtraBaseCharacter*                       LookAtCharacter;                                          // 0x0004(0x0004) (ZeroConstructor, IsPlainOldData)
};
...
struct FBuffNodeBlackboardSetting
{
	...
	struct FString                                     Execute_String;                                           // 0x0068(0x000C) (Edit, BlueprintVisible, ZeroConstructor)
	...
	unsigned char                                      UnknownData06[0x28];                                      // 0x0098(0x0028) UNKNOWN PROPERTY: SoftObjectProperty Addons.BuffNodeBlackboardSetting.End_Object
	unsigned char                                      UnknownData07[0x28];                                      // 0x00C0(0x0028) UNKNOWN PROPERTY: SoftClassProperty Addons.BuffNodeBlackboardSetting.End_Class
	...
	unsigned char                                      UnknownData09[0x3];                                       // 0x00F5(0x0003) MISSED OFFSET
	struct FString                                     End_String;                                               // 0x00F8(0x000C) (Edit, BlueprintVisible, ZeroConstructor)
	unsigned char                                      UnknownData10[0x4];                                       // 0x0104(0x0004) MISSED OFFSET
...
{
	class ASTExtraCharacter*                           Character;                                                // 0x0000(0x0004) (ZeroConstructor, IsPlainOldData)
	float                                              Attractive;                                               // 0x0004(0x0004) (ZeroConstructor, IsPlainOldData)
};
...
{
	class ASTExtraBaseCharacter*                       UpdatedPlayer;                                            // 0x0000(0x0004) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	class UHorsePlayerCurvedUpdateComponent*           OwnerComponent;                                           // 0x0004(0x0004) (BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData)
	class AHorseVehicle*                               HorseOwner;                                               // 0x0008(0x0004) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	class UCurveVector*                                UsedLocationUpdateCurve;                                  // 0x000C(0x0004) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	class UCurveVector*                                UsedRotationUpdateCurve;                                  // 0x0010(0x0004) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	struct FVector                                     RealExitLocation;                                         // 0x0014(0x000C) (BlueprintVisible, IsPlainOldData)
	float                                              Rate;                                                     // 0x0020(0x0004) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              CameraLerpStartTime;                                      // 0x0024(0x0004) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              CameraLerpDuration;                                       // 0x0028(0x0004) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bActived;                                                 // 0x002C(0x0001) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bValid;                                                   // 0x002D(0x0001) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x2];                                       // 0x002E(0x0002) MISSED OFFSET
	float                                              TimeAccumulator;                                          // 0x0030(0x0004) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              ZScale;                                                   // 0x0034(0x0004) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              MaxCurveTime;                                             // 0x0038(0x0004) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
};
...
{
	TArray<struct FName>                               ExitHorseSockets;                                         // 0x0000(0x000C) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance)
};
...
{
	unsigned char                                      UnknownData00[0x3C];                                      // 0x0000(0x003C) UNKNOWN PROPERTY: SetProperty Addons.MechaStateSet.States
};
...
struct FHitDymaicParams
{
	...
	class AActor*                                      OwnedActor;                                               // 0x002C(0x0004) (ZeroConstructor, IsPlainOldData)
};
...
struct FHeadItem
{
	...
	class UOBModePositionWidget*                       HeadItemWidget;                                           // 0x000C(0x0004) (BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData)
};
...
struct FTeamData
{
	TArray<struct FHeadItem>                           TeamHeadItems;                                            // 0x0000(0x000C) (BlueprintVisible, ZeroConstructor)
};
...
{
	struct FString                                     ModName;                                                  // 0x0000(0x000C) (ZeroConstructor)
...
struct FODMGearSpeedCurve
{
	...
	class UCurveFloat*                                 SpeedCurve;                                               // 0x0004(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
};
...
struct FMonsterLeisureItem
{
	...
	class UAnimationAsset*                             AnimSeq;                                                  // 0x000C(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
};
...
{
	TArray<struct FMonsterLeisureItem>                 LeisureArrs;                                              // 0x0000(0x000C) (Edit, ZeroConstructor)
};
...
{
	class UAnimationAsset*                             TriggerEmote;                                             // 0x0000(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	class UAnimationAsset*                             VehicleEmote;                                             // 0x0004(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	class UAnimationAsset*                             DriverEmote;                                              // 0x0008(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	class UAnimationAsset*                             PassengerEmote;                                           // 0x000C(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
};
...
{
	TArray<struct FEmoteInteractAsset>                 EmoteInteractArrs;                                        // 0x0000(0x000C) (Edit, ZeroConstructor)
};
...
struct FRepPandaEmoteInteract
{
	...
	class AActor*                                      Trigger;                                                  // 0x0008(0x0004) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bPlayPassengerAnim;                                       // 0x000C(0x0001) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x3];                                       // 0x000D(0x0003) MISSED OFFSET
};
...
{
	struct FString                                     PlatformLimit;                                            // 0x0000(0x000C) (ZeroConstructor)
	int8_t                                             FPSLimit;                                                 // 0x000C(0x0001) (ZeroConstructor, IsPlainOldData)
	int8_t                                             RenderQualityLimit;                                       // 0x000D(0x0001) (ZeroConstructor, IsPlainOldData)
	int8_t                                             CharacterSimulatedMinURO;                                 // 0x000E(0x0001) (ZeroConstructor, IsPlainOldData)
...
struct FBuffAttachmentItem
{
	...
	unsigned char                                      UnknownData01[0x28];                                      // 0x0004(0x0028) UNKNOWN PROPERTY: SoftObjectProperty Addons.BuffAttachmentItem.ParticleSystem
...
struct FBACustomDamageData
{
	...
	unsigned char                                      UnknownData00[0x2];                                       // 0x0006(0x0002) MISSED OFFSET
	TArray<TEnumAsByte<EWeaponTypeNew>>                ValidWeaponTypeMap;                                       // 0x0008(0x000C) (Edit, BlueprintVisible, ZeroConstructor)
};
...
struct FBACustomDistDamageData : public FBACustomDamageData
{
	...
	float                                              MaxDist;                                                  // 0x0018(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
};
...
{
	float                                              MinHpPer;                                                 // 0x0014(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              MaxHpPer;                                                 // 0x0018(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
};

// ScriptStruct Addons.BACustomTypeDamageData
// 0x0018 (0x002C - 0x0014)
struct FBACustomTypeDamageData : public FBACustomDamageData
{
	TArray<int>                                        ResIDArray;                                               // 0x0014(0x000C) (Edit, BlueprintVisible, ZeroConstructor)
	TArray<struct FName>                               TagArray;                                                 // 0x0020(0x000C) (Edit, BlueprintVisible, ZeroConstructor)
};
...
struct FPostEventParams
{
	...
	TMap<struct FName, struct FString>                 ActionParams;                                             // 0x0018(0x0050) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor)
	TArray<struct FUAEBlackboardKeySelector>           BBKeySelectors;                                           // 0x0054(0x000C) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor)
};
...
struct FReplaceAvatarMaterialParams
{
	...
	class UCurveFloat*                                 ParameterValueCurve;                                      // 0x0008(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
...
struct FBAWeaponAttrModifyConfig
{
	...
	float                                              ModifyValue;                                              // 0x000C(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	EAttrModifyRefType                                 AttrRefValueType;                                         // 0x0010(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               MultiplyOnLayer;                                          // 0x0011(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x2];                                       // 0x0012(0x0002) MISSED OFFSET
	uint32_t                                           ModifyID;                                                 // 0x0014(0x0004) (ZeroConstructor, Transient, IsPlainOldData)
};
...
struct FTPlanTeamInfo
{
	...
	TArray<struct FTPlanPlayerInfo>                    PlayerInfos;                                              // 0x000C(0x000C) (BlueprintVisible, ZeroConstructor)
	TArray<struct FVector>                             EscapePosi;                                               // 0x0018(0x000C) (BlueprintVisible, ZeroConstructor)
};
...
struct FBunchAction
{
	class UUTSkillAction*                              Effect;                                                   // 0x0000(0x0004) (Edit, BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData)
...
struct FViewInfoCurve
{
	...
	struct FMinimalViewInfo                            AdditiveCameraViewInfo;                                   // 0x0010(0x0580) (Edit, BlueprintVisible)
	class UCurveFloat*                                 FovCurve;                                                 // 0x0590(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
...
struct FSkillAction_SequenceCreateData
{
	...
	class UUTSkillLocationPicker*                      LocationPicker;                                           // 0x0034(0x0004) (Edit, BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData)
	class UUAESkillPicker*                             DamagePicker;                                             // 0x0038(0x0004) (Edit, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData)
	bool                                               bSetLocationToBB;                                         // 0x003C(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x3];                                       // 0x003D(0x0003) MISSED OFFSET
	struct FName                                       BBName;                                                   // 0x0040(0x0008) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               bDestroyedAtSkillEnd;                                     // 0x0048(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bForceDestroyedAtSkillEnd;                                // 0x0049(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData02[0x6];                                       // 0x004A(0x0006) MISSED OFFSET
	struct FUAEBlackboardKeySelector                   CachedSpawnActorKey;                                      // 0x0050(0x0008) (Edit, BlueprintVisible)
};
...
struct FSlotMaterialParameterValue
{
	...
	class UCurveFloat*                                 SlotParameterValueCurve;                                  // 0x0008(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	float                                              SlotParameterValue;                                       // 0x000C(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
};
...
struct FSkillAction_SpawnActorCreateData
{
	class UClass*                                      ActorTemplate;                                            // 0x0000(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x4];                                       // 0x0004(0x0004) MISSED OFFSET
	unsigned char                                      UnknownData01[0x28];                                      // 0x0004(0x0028) UNKNOWN PROPERTY: SoftClassProperty Addons.SkillAction_SpawnActorCreateData.SoftActorTemplate
	...
	class UUAESkillPicker*                             DamagePicker;                                             // 0x0034(0x0004) (Edit, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData)
	bool                                               bSetLocationToBB;                                         // 0x0038(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               bSetLocationToSkillBB;                                    // 0x0039(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData03[0x6];                                       // 0x003A(0x0006) MISSED OFFSET
	struct FName                                       BBName;                                                   // 0x0040(0x0008) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               bTraceGround;                                             // 0x0048(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData04[0x3];                                       // 0x0049(0x0003) MISSED OFFSET
	struct FVector                                     TraceGroundOffset;                                        // 0x004C(0x000C) (Edit, BlueprintVisible, IsPlainOldData)
	class UUTSkillLocationPicker*                      LocationPicker;                                           // 0x0058(0x0004) (Edit, BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData)
	bool                                               bLocalSpawn;                                              // 0x005C(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bClientSpawn;                                             // 0x005D(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bDestroyedAtSkillEnd;                                     // 0x005E(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bForceDestroyedAtSkillEnd;                                // 0x005F(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              DelayDestroyedAtSkillEnd;                                 // 0x0060(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bUseOffsetWithOutLocationPicker;                          // 0x0064(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bUseOffsetWithDamagePicker;                               // 0x0065(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bEnableAttach;                                            // 0x0066(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData05[0x1];                                       // 0x0067(0x0001) MISSED OFFSET
	struct FName                                       AttachSocket;                                             // 0x0068(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bAlignMainMesh;                                           // 0x0070(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bAlignRotation;                                           // 0x0071(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bAlignScale3D;                                            // 0x0072(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData06[0x1];                                       // 0x0073(0x0001) MISSED OFFSET
	struct FVector                                     OffsetLocationStand;                                      // 0x0074(0x000C) (Edit, BlueprintVisible, IsPlainOldData)
	struct FVector                                     OffsetLocationCrouch;                                     // 0x0080(0x000C) (Edit, BlueprintVisible, IsPlainOldData)
	struct FVector                                     OffsetLocationProne;                                      // 0x008C(0x000C) (Edit, BlueprintVisible, IsPlainOldData)
	struct FRotator                                    OffsetRotation;                                           // 0x0098(0x000C) (Edit, BlueprintVisible, IsPlainOldData)
	bool                                               bAllowChangePoseWillUpdating;                             // 0x00A4(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData07[0x3];                                       // 0x00A5(0x0003) MISSED OFFSET
	struct FUAEBlackboardKeySelector                   CachedSpawnActorKey;                                      // 0x00A8(0x0008) (Edit, BlueprintVisible)
	float                                              DelaySecondsDestroy;                                      // 0x00B0(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
...
struct FSpawnMonsterConfig
{
	...
	TArray<TEnumAsByte<EObjectTypeQuery>>              ObjectTypes;                                              // 0x0020(0x000C) (Edit, ZeroConstructor)
	float                                              NineGridSearchRadius;                                     // 0x002C(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	int                                                NineGridSearchFloor;                                      // 0x0030(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               bSearchRandom;                                            // 0x0034(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x3F];                                      // 0x0035(0x003F) MISSED OFFSET
};
...
struct FUTSkillAppearance_ParticleSystem_Item
{
	...
	unsigned char                                      UnknownData00[0x28];                                      // 0x0010(0x0028) UNKNOWN PROPERTY: SoftObjectProperty Addons.UTSkillAppearance_ParticleSystem_Item.TemplateSelfTeam_Effect_Soft
	unsigned char                                      UnknownData01[0x28];                                      // 0x0038(0x0028) UNKNOWN PROPERTY: SoftObjectProperty Addons.UTSkillAppearance_ParticleSystem_Item.TemplateEnermyTeam_Effect_Soft
	unsigned char                                      UnknownData02[0x28];                                      // 0x0060(0x0028) UNKNOWN PROPERTY: SoftObjectProperty Addons.UTSkillAppearance_ParticleSystem_Item.TemplateSelfTeamFPP_Effect_Soft
	bool                                               bLoop;                                                    // 0x0088(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               StopAfterPhase;                                           // 0x0089(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData03[0x2];                                       // 0x008A(0x0002) MISSED OFFSET
	float                                              Scale;                                                    // 0x008C(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	struct FName                                       SocketName;                                               // 0x0090(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	struct FName                                       RefSocketName;                                            // 0x0098(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	struct FVector                                     LocationOffset;                                           // 0x00A0(0x000C) (Edit, BlueprintVisible, IsPlainOldData)
	struct FRotator                                    RotationOffset;                                           // 0x00AC(0x000C) (Edit, BlueprintVisible, IsPlainOldData)
	struct FVector                                     LocationOffsetTPP;                                        // 0x00B8(0x000C) (Edit, BlueprintVisible, IsPlainOldData)
	struct FRotator                                    RotationOffsetTPP;                                        // 0x00C4(0x000C) (Edit, BlueprintVisible, IsPlainOldData)
	float                                              ScaleTPP;                                                 // 0x00D0(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData04[0x4];                                       // 0x00D4(0x0004) MISSED OFFSET
	struct FName                                       HurtRotationSocketName;                                   // 0x00D8(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              AutoDispearTime;                                          // 0x00E0(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bAttachToPawn;                                            // 0x00E4(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bNeedEmitter;                                             // 0x00E5(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               DisableOnLowCPU;                                          // 0x00E6(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData05[0x1];                                       // 0x00E7(0x0001) MISSED OFFSET
	struct FName                                       DamageableInterfaceTag;                                   // 0x00E8(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
};
...
struct FUTSkillAppearance_SoundCue_Item
{
	...
	unsigned char                                      UnknownData01[0x28];                                      // 0x0008(0x0028) UNKNOWN PROPERTY: SoftObjectProperty Addons.UTSkillAppearance_SoundCue_Item.AkEvent_SoftPtr
	unsigned char                                      UnknownData02[0x28];                                      // 0x0030(0x0028) UNKNOWN PROPERTY: SoftObjectProperty Addons.UTSkillAppearance_SoundCue_Item.StopAkEvent_SoftPtr
...
struct FSeatMountMontageSetting
{
	...
	TMap<TEnumAsByte<EMountFromDirection>, struct FMountMontagePair> DisMountMontageParis;                                     // 0x003C(0x0050) (Edit, ZeroConstructor, DisableEditOnInstance)
};
...
struct FAnimNode_AdvanceBlendSpacePlayer : public FAnimNode_AssetPlayerBase
{
	...
	bool                                               bResetPlayTimeWhenBlendSpaceChanges;                      // 0x0061(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	...
	EBlendCrossFadeOption                              CFadeStyle;                                               // 0x00EC(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData02[0x3];                                       // 0x00ED(0x0003) MISSED OFFSET
	float                                              CFadeBlendTime;                                           // 0x00F0(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	EAlphaBlendOption                                  BlendType;                                                // 0x00F4(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData03[0x3];                                       // 0x00F5(0x0003) MISSED OFFSET
	class UCurveFloat*                                 CustomBlendCurve;                                         // 0x00F8(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               bUseBlendInTheSameCache;                                  // 0x00FC(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData04[0x3];                                       // 0x00FD(0x0003) MISSED OFFSET
	class UBlendSpaceBase*                             SourceBlendSpace;                                         // 0x0100(0x0004) (ZeroConstructor, Transient, IsPlainOldData)
	class UBlendSpaceBase*                             TargetBlendSpace;                                         // 0x0104(0x0004) (ZeroConstructor, Transient, IsPlainOldData)
	unsigned char                                      UnknownData05[0x1BC];                                     // 0x0108(0x01BC) MISSED OFFSET
	class USkeletalMesh*                               CachedSkeletalMesh;                                       // 0x02C4(0x0004) (ZeroConstructor, IsPlainOldData)
};
...
{
	TArray<struct FAngularRangeLimit>                  AngularRangeLimits;                                       // 0x0058(0x000C) (Edit, ZeroConstructor)
	TArray<struct FVector>                             AngularOffsets;                                           // 0x0064(0x000C) (Edit, BlueprintVisible, EditFixedSize, ZeroConstructor)
};
...
{
	struct FVector                                     EffectorLocation;                                         // 0x0058(0x000C) (Edit, IsPlainOldData)
	TEnumAsByte<EBoneControlSpace>                     EffectorLocationSpace;                                    // 0x0064(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0xB];                                       // 0x0065(0x000B) MISSED OFFSET
	struct FBoneSocketTarget                           EffectorTarget;                                           // 0x0070(0x0060) (Edit)
	struct FBoneReference                              TipBone;                                                  // 0x00D0(0x0018) (Edit)
	struct FBoneReference                              RootBone;                                                 // 0x00E8(0x0018) (Edit)
	float                                              Precision;                                                // 0x0100(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	int                                                MaxIterations;                                            // 0x0104(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               bStartFromTail;                                           // 0x0108(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               bEnableRotationLimit;                                     // 0x0109(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x2];                                       // 0x010A(0x0002) MISSED OFFSET
	TArray<float>                                      RotationLimitPerJoints;                                   // 0x010C(0x000C) (Edit, EditFixedSize, ZeroConstructor)
...
struct FAnimNode_CloseToWall : public FAnimNode_SkeletalControlBase
{
	...
	TArray<struct FBoneReference>                      TraceBones;                                               // 0x0070(0x000C) (Edit, ZeroConstructor)
	TArray<TEnumAsByte<ECollisionChannel>>             ObjectTypesToTrace;                                       // 0x007C(0x000C) (Edit, ZeroConstructor)
	float                                              TraceSphereRadius;                                        // 0x0088(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	float                                              TraceForwardOffset;                                       // 0x008C(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	float                                              TraceBackwardOffset;                                      // 0x0090(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	struct FVector                                     forwardDir;                                               // 0x0094(0x000C) (Edit, IsPlainOldData)
	float                                              IntendedWallDis;                                          // 0x00A0(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	float                                              InterpSpeed;                                              // 0x00A4(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               bDrawDebug;                                               // 0x00A8(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
...
struct FAnimNode_DistanceMatching : public FAnimNode_SequencePlayer
{
	...
	float                                              Distance;                                                 // 0x0068(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x4];                                       // 0x006C(0x0004) MISSED OFFSET
	struct FName                                       RootBoneName;                                             // 0x0070(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              AcceptedDistanceError;                                    // 0x0078(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bUseSuperUpdate;                                          // 0x007C(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x3];                                       // 0x007D(0x0003) MISSED OFFSET
	struct FFloatCurve                                 DistanceCurve;                                            // 0x0080(0x0070)
	bool                                               bHasValidDistanceCurve;                                   // 0x00F0(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData02[0x4F];                                      // 0x00F1(0x004F) MISSED OFFSET
};
...
struct FAnimNode_FourLeggedIK : public FAnimNode_SkeletalControlBase
{
	...
	bool                                               bEnableFootAdapt;                                         // 0x005A(0x0001) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	bool                                               bEnableNeckAdapt;                                         // 0x005B(0x0001) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	bool                                               bUseSocketTrace;                                          // 0x005C(0x0001) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	bool                                               bEnableTraceOptimization;                                 // 0x005D(0x0001) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	bool                                               bTraceNotHitUseOriginPosition;                            // 0x005E(0x0001) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	bool                                               bProcessLeftRightOverDistance;                            // 0x005F(0x0001) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	float                                              MaxLeftRightSideDifference;                               // 0x0060(0x0004) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	bool                                               bSendTraceResultsMessage;                                 // 0x0064(0x0001) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	unsigned char                                      UnknownData00[0x3];                                       // 0x0065(0x0003) MISSED OFFSET
	class UCurveFloat*                                 SlopeHeightAdaptedCurve;                                  // 0x0068(0x0004) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	float                                              SlopeHeightAdditive;                                      // 0x006C(0x0004) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	class UCurveFloat*                                 SlopePitchAdaptedCurve;                                   // 0x0070(0x0004) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	float                                              SlopePitchAdditive;                                       // 0x0074(0x0004) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	TArray<TEnumAsByte<ECollisionChannel>>             ObjectTypesToTrace;                                       // 0x0078(0x000C) (Edit, ZeroConstructor, DisableEditOnInstance)
	float                                              TraceUpOffset;                                            // 0x0084(0x0004) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	float                                              TraceDownOffset;                                          // 0x0088(0x0004) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	float                                              TraceSphereRadius;                                        // 0x008C(0x0004) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	float                                              SlopeAdaptionMaxPitch;                                    // 0x0090(0x0004) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	float                                              SlopeAdaptionMaxZ;                                        // 0x0094(0x0004) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	float                                              SlopeAdaptLerpSpeed;                                      // 0x0098(0x0004) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	float                                              FootAdaptMaxRoll;                                         // 0x009C(0x0004) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	float                                              FootAdaptMaxPitch;                                        // 0x00A0(0x0004) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	float                                              FootIKAdaptMaxZ;                                          // 0x00A4(0x0004) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	float                                              FootIKLerpSpeed;                                          // 0x00A8(0x0004) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	...
	struct FBoneDeclare                                LeftHandBone;                                             // 0x02F0(0x0060) (Edit, DisableEditOnInstance)
	struct FBoneDeclare                                RightHandBone;                                            // 0x0350(0x0060) (Edit, DisableEditOnInstance)
	struct FBoneDeclare                                LeftFootBone;                                             // 0x03B0(0x0060) (Edit, DisableEditOnInstance)
	struct FBoneDeclare                                RightFootBone;                                            // 0x0410(0x0060) (Edit, DisableEditOnInstance)
	struct FBoneSocketTarget                           LeftHandTraceSocket;                                      // 0x0470(0x0060) (Edit, DisableEditOnInstance)
	struct FBoneSocketTarget                           RightHandTraceSocket;                                     // 0x04D0(0x0060) (Edit, DisableEditOnInstance)
	struct FBoneSocketTarget                           LeftFootTraceSocket;                                      // 0x0530(0x0060) (Edit, DisableEditOnInstance)
	struct FBoneSocketTarget                           RightFootTraceSocket;                                     // 0x0590(0x0060) (Edit, DisableEditOnInstance)
	struct FAnimNode_TwoBoneIK                         LeftHandIK;                                               // 0x05F0(0x01A0) (Edit, DisableEditOnInstance)
	struct FAnimNode_TwoBoneIK                         RightHandIK;                                              // 0x0790(0x01A0) (Edit, DisableEditOnInstance)
	struct FAnimNode_TwoBoneIK                         LeftFootIK;                                               // 0x0930(0x01A0) (Edit, DisableEditOnInstance)
	struct FAnimNode_TwoBoneIK                         RightFootIK;                                              // 0x0AD0(0x01A0) (Edit, DisableEditOnInstance)
	float                                              DebugSphereRadius;                                        // 0x0C70(0x0004) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	float                                              DebugLineWidth;                                           // 0x0C74(0x0004) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	float                                              DebugArrowSize;                                           // 0x0C78(0x0004) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	struct FColor                                      DebugNegativeColor;                                       // 0x0C7C(0x0004) (Edit, DisableEditOnInstance, IsPlainOldData)
	struct FColor                                      DebugPositiveColor;                                       // 0x0C80(0x0004) (Edit, DisableEditOnInstance, IsPlainOldData)
	struct FColor                                      DebugInfoColor;                                           // 0x0C84(0x0004) (Edit, DisableEditOnInstance, IsPlainOldData)
	struct FVector2D                                   DebugTextSize;                                            // 0x0C88(0x0008) (Edit, DisableEditOnInstance, IsPlainOldData)
	class APawn*                                       OwnerPawn;                                                // 0x0C90(0x0004) (ZeroConstructor, Transient, IsPlainOldData)
	unsigned char                                      UnknownData02[0xFC];                                      // 0x0C94(0x00FC) MISSED OFFSET
};
...
{
	struct FName                                       Root;                                                     // 0x0058(0x0008) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	struct FIKBodyInertia                              BodyInertia;                                              // 0x0060(0x0014) (Edit)
	TArray<struct FIKFoot>                             Feet;                                                     // 0x0074(0x000C) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance)
	float                                              FeetDeltaSmoothSpeed;                                     // 0x0080(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              RootRotationMultiplier;                                   // 0x0084(0x0004) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	struct FFootIKCollision                            FootCollision;                                            // 0x0088(0x0014) (Edit, BlueprintVisible, DisableEditOnInstance)
	unsigned char                                      UnknownData00[0x4];                                       // 0x009C(0x0004) MISSED OFFSET
	struct FFootIKSlope                                FootSlope;                                                // 0x00A0(0x0098) (Edit, BlueprintVisible)
	TArray<struct FIKBoneBendDirection>                BendDirections;                                           // 0x0138(0x000C) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance)
	TArray<struct FIKExcludedBone>                     ExcludedBones;                                            // 0x0144(0x000C) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance)
	TArray<struct FIKBoneLimit>                        JointLimits;                                              // 0x0150(0x000C) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance)
	unsigned char                                      UnknownData01[0x10];                                      // 0x015C(0x0010) MISSED OFFSET
	int                                                MaxSquashIterations;                                      // 0x016C(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	int                                                MaxStretchIterations;                                     // 0x0170(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	int                                                MaxFinalIterations;                                       // 0x0174(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               AllowBoneTranslation;                                     // 0x0178(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData02[0x3];                                       // 0x0179(0x0003) MISSED OFFSET
	float                                              SolverAlpha;                                              // 0x017C(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	float                                              DebugDrawSize;                                            // 0x0180(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	class UWorld*                                      World;                                                    // 0x0184(0x0004) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData03[0x128];                                     // 0x0188(0x0128) MISSED OFFSET
};

// ScriptStruct Addons.AnimNode_HumanoidLeggedIK
// 0x0498 (0x04F0 - 0x0058)
struct FAnimNode_HumanoidLeggedIK : public FAnimNode_SkeletalControlBase
{
	struct FBoneReference                              RootBone;                                                 // 0x0058(0x0018) (Edit)
	struct FBoneReference                              LeftFootBone;                                             // 0x0070(0x0018) (Edit)
	struct FBoneReference                              LeftBallBone;                                             // 0x0088(0x0018) (Edit)
	struct FBoneReference                              RightFootBone;                                            // 0x00A0(0x0018) (Edit)
	struct FBoneReference                              RightBallBone;                                            // 0x00B8(0x0018) (Edit)
	class UCurveFloat*                                 StretchBallCurve;                                         // 0x00D0(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	class UBoneParamDefineAsset*                       BoneParamDefine;                                          // 0x00D4(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               bEnableRootAdaption;                                      // 0x00D8(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bEnableLegAdaption;                                       // 0x00D9(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bEnableFootAdaption;                                      // 0x00DA(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x1];                                       // 0x00DB(0x0001) MISSED OFFSET
	TArray<TEnumAsByte<ECollisionChannel>>             ObjectTypesToTrace;                                       // 0x00DC(0x000C) (Edit, ZeroConstructor)
	float                                              FootTraceUpOffset;                                        // 0x00E8(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	float                                              FootTraceDownOffset;                                      // 0x00EC(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	float                                              FootTraceSphereRadius;                                    // 0x00F0(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               bIgnoreSelfType;                                          // 0x00F4(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x3];                                       // 0x00F5(0x0003) MISSED OFFSET
	float                                              RootPositionInterpolateSpeed;                             // 0x00F8(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	float                                              FootPositionInterpolateSpeed;                             // 0x00FC(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	float                                              FootRotationInterpolateSpeed;                             // 0x0100(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	float                                              RootHeightOffsetScale;                                    // 0x0104(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	float                                              RootMaxHeightOffset;                                      // 0x0108(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	float                                              FootMaxHeightOffset;                                      // 0x010C(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	float                                              FootMaxPitchOffset;                                       // 0x0110(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	float                                              FootMaxRollOffset;                                        // 0x0114(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	float                                              BallShrinkDistance;                                       // 0x0118(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData02[0x4];                                       // 0x011C(0x0004) MISSED OFFSET
	struct FAnimNode_TwoBoneIK                         LeftFootIKNode;                                           // 0x0120(0x01A0) (Edit, DisableEditOnInstance)
	struct FAnimNode_TwoBoneIK                         RightFootIKNode;                                          // 0x02C0(0x01A0) (Edit, DisableEditOnInstance)
	unsigned char                                      UnknownData03[0x90];                                      // 0x0460(0x0090) MISSED OFFSET
};
...
struct FAnimNode_LayeredBoneBlendWithoutExclusive : public FAnimNode_Base
{
	...
	class USkeletalMesh*                               BaseSkeletalMesh;                                         // 0x0044(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x14];                                      // 0x0048(0x0014) MISSED OFFSET
	TArray<float>                                      BlendWeights;                                             // 0x005C(0x000C) (Edit, BlueprintVisible, EditFixedSize, ZeroConstructor)
	bool                                               bMeshSpaceRotationBlend;                                  // 0x0068(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	TEnumAsByte<ECurveBlendOption>                     CurveBlendOption;                                         // 0x0069(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bBlendRootMotionBasedOnRootBone;                          // 0x006A(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               bHasRelevantPoses;                                        // 0x006B(0x0001) (ZeroConstructor, Transient, IsPlainOldData)
	TArray<struct FPerBoneBlendWeight>                 PerBoneBlendWeights;                                      // 0x006C(0x000C) (ZeroConstructor)
	struct FGuid                                       SkeletonGuid;                                             // 0x0078(0x0010) (IsPlainOldData)
	struct FGuid                                       VirtualBoneGuid;                                          // 0x0088(0x0010) (IsPlainOldData)
...
{
	class UMirrorPoseProfile*                          MirrorPoseProfile;                                        // 0x002C(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bMirror;                                                  // 0x0030(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x3];                                       // 0x0031(0x0003) MISSED OFFSET
	struct FPoseLink                                   Source;                                                   // 0x0034(0x000C) (Edit)
...
{
	TArray<class UAnimSequence*>                       CandidateSequences;                                       // 0x0138(0x000C) (Edit, BlueprintVisible, ZeroConstructor)
	TArray<struct FBoneReference>                      ConsideredBones;                                          // 0x0144(0x000C) (Edit, BlueprintVisible, ZeroConstructor)
	float                                              PositionWeight;                                           // 0x0150(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              VelocityWeight;                                           // 0x0154(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              PoseInterval;                                             // 0x0158(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	class UAnimPoseRecorder*                           PoseRecorder;                                             // 0x015C(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	TArray<struct FAnimJointData>                      AnimJointDatas;                                           // 0x0160(0x000C) (ZeroConstructor)
...
struct FAnimNode_OffsetRootBone : public FAnimNode_Base
{
	...
	float                                              RotationHalfLife;                                         // 0x0038(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	float                                              TranslationHalfLife;                                      // 0x003C(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	float                                              MaxTransitionError;                                       // 0x0040(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	EOffsetRootBoneMode                                RotationMode;                                             // 0x0044(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	EOffsetRootBoneMode                                TranslationMode;                                          // 0x0045(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x62];                                      // 0x0046(0x0062) MISSED OFFSET
	class UWorld*                                      CachedWorldContext;                                       // 0x00A8(0x0004) (ZeroConstructor, Transient, IsPlainOldData)
	unsigned char                                      UnknownData01[0x4];                                       // 0x00AC(0x0004) MISSED OFFSET
};
...
{
	struct FVector                                     TargetEffectorLocation;                                   // 0x0058(0x000C) (Edit, BlueprintVisible, IsPlainOldData)
	bool                                               bDrawDebug;                                               // 0x0064(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x3];                                       // 0x0065(0x0003) MISSED OFFSET
	struct FBoneReference                              TipBone;                                                  // 0x0068(0x0018) (Edit)
	struct FBoneReference                              RootBone;                                                 // 0x0080(0x0018) (Edit)
	float                                              DefaultScaleStep;                                         // 0x0098(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	class UCurveFloat*                                 StretchScaleStepCurve;                                    // 0x009C(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
...
struct FAnimNode_StretchBoneChainSafety : public FAnimNode_SkeletalControlBase
{
	...
	bool                                               bDrawDebug;                                               // 0x0064(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x3];                                       // 0x0065(0x0003) MISSED OFFSET
	TArray<struct FBoneReference>                      BoneChain;                                                // 0x0068(0x000C) (Edit, ZeroConstructor)
	float                                              DefaultScaleStep;                                         // 0x0074(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	class UCurveFloat*                                 StretchScaleStepCurve;                                    // 0x0078(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
...
struct FAnimNode_SyncBlendSpacePlayerSafety : public FAnimNode_BlendSpacePlayer
{
	struct FName                                       SyncGroupName;                                            // 0x00F0(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bIsLeader;                                                // 0x00F8(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bUseExperimentalSync;                                     // 0x00F9(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x2];                                       // 0x00FA(0x0002) MISSED OFFSET
	class UAnimInstance*                               LinkedAnimInstance;                                       // 0x00FC(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	class UAnimInstance*                               LinkedAnimInstanceLastFrame;                              // 0x0100(0x0004) (ZeroConstructor, IsPlainOldData)
	TArray<class UProperty*>                           PropagatedProperties;                                     // 0x0104(0x000C) (ZeroConstructor)
...
{
	struct FRotator                                    TargetRotator;                                            // 0x006C(0x000C) (Edit, IsPlainOldData)
	float                                              RootMotionThreshold;                                      // 0x0078(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
...
struct FAvatarObjectAsyncInfo
{
	...
	class UAvatarMerger*                               AvatarMerger;                                             // 0x0010(0x0004) (ZeroConstructor, Transient, IsPlainOldData)
...
{
	TArray<int>                                        ItemList;                                                 // 0x0000(0x000C) (ZeroConstructor)
};
...
struct FMaterialTextureMergeInfo
{
	...
	class UMaterialInterface*                          OwnerMaterial;                                            // 0x0004(0x0004) (ZeroConstructor, IsPlainOldData)
	struct FTex2DMergeChunk                            MergeChunk;                                               // 0x0008(0x002C)
...
{
	class UMaterialInterface*                          Material;                                                 // 0x0000(0x0004) (ZeroConstructor, Transient, IsPlainOldData)
	TMap<struct FName, struct FMaterialTextureMergeInfo> ParamName2TextureInfoMap;                                 // 0x0004(0x0050) (ZeroConstructor, Transient)
...
struct FTitanCurveMovingData
{
	...
	class UCurveVector*                                CurveAsset;                                               // 0x0008(0x0004) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	unsigned char                                      UnknownData00[0x4];                                       // 0x000C(0x0004) MISSED OFFSET
};
...
struct FAddCameraViewInfoStruct
{
	...
	class UCurveFloat*                                 CurFOVCurve;                                              // 0x000C(0x0004) (ZeroConstructor, IsPlainOldData)
...
{
	struct FMarkDispatchAction                         MarkDispatchAction;                                       // 0x0000(0x0078)
};
...
// ScriptStruct Addons.KnockAwayData
// 0x0020
struct FKnockAwayData
{
	int                                                InternalBlowUpID;                                         // 0x0000(0x0004) (ZeroConstructor, IsPlainOldData)
	struct FVector                                     LaunchVelocity;                                           // 0x0004(0x000C) (IsPlainOldData)
	TWeakObjectPtr<class AActor>                       HitActor;                                                 // 0x0010(0x0008) (ZeroConstructor, IsPlainOldData)
	TWeakObjectPtr<class UPrimitiveComponent>          HitComponent;                                             // 0x0018(0x0008) (ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData)
};
