...
{
	TArray<struct FBuildingActorDSBuildCheckData>      DSCheckCfg;                                               // 0x0000(0x000C) (Edit, BlueprintVisible, ZeroConstructor)
	TEnumAsByte<ECollisionChannel>                     CheckChannel;                                             // 0x000C(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
