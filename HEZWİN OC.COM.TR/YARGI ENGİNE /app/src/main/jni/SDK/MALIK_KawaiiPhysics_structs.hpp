...
// GENERATE ON Wed May  7 14:35:36 2025
...
struct FNewAnimNode_KawaiiPhysics : public FAnimNode_SkeletalControlBase
{
	...
	struct FVector                                     MaxDistance;                                              // 0x00F8(0x000C) (Edit, BlueprintVisible, IsPlainOldData)
	struct FVector                                     MinDistance;                                              // 0x0104(0x000C) (Edit, BlueprintVisible, IsPlainOldData)
	bool                                               bEnableWind;                                              // 0x0110(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData03[0x3];                                       // 0x0111(0x0003) MISSED OFFSET
	float                                              WindScale;                                                // 0x0114(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	TArray<struct FKawaiiPhysicsModifyBone>            ModifyBones;                                              // 0x0118(0x000C) (ZeroConstructor)
	float                                              TotalBoneLength;                                          // 0x0124(0x0004) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData04[0x8];                                       // 0x0128(0x0008) MISSED OFFSET
	struct FTransform                                  PreSkelCompTransform;                                     // 0x0130(0x0030) (IsPlainOldData)
	bool                                               bInitPhysicsSettings;                                     // 0x0160(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData05[0x2F];                                      // 0x0161(0x002F) MISSED OFFSET
};
