...
{
public:
	EMediaSoundChannels                                Channels;                                                 // 0x0540(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x3];                                       // 0x0540(0x0003) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	class UMediaPlayer*                                MediaPlayer;                                              // 0x0544(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x18];                                      // 0x0548(0x0018) MISSED OFFSET
...
public:
	...
	struct FLinearColor                                ClearColor;                                               // 0x00B4(0x0010) (Edit, BlueprintVisible, IsPlainOldData)
	class UMediaPlayer*                                MediaPlayer;                                              // 0x00C4(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x38];                                      // 0x00C8(0x0038) MISSED OFFSET
