...
enum class EStatePlayerType : uint8_t
{
	...
	EStatePlayerType__EStatePlayerType_MAX = 9
};
...
struct FAIStateInfoBase
{
	...
	TArray<struct FString>                             IgnoreNames;                                              // 0x0008(0x000C) (ZeroConstructor)
...
{
	int                                                Type;                                                     // 0x0014(0x0004) (ZeroConstructor, IsPlainOldData)
	struct FAIStateXYZ                                 Location;                                                 // 0x0018(0x000C)
...
struct FAIPlayerStateBaseMod : public FAIStateInfoBase
{
	...
	struct FString                                     player_name;                                              // 0x0020(0x000C) (ZeroConstructor)
	int                                                team_id;                                                  // 0x002C(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                team_index;                                               // 0x0030(0x0004) (ZeroConstructor, IsPlainOldData)
	struct FAIStateXYZ                                 Position;                                                 // 0x0034(0x000C)
	struct FAIStateXYZ                                 Rotation;                                                 // 0x0040(0x000C)
	struct FAIStateXYZ                                 Speed;                                                    // 0x004C(0x000C)
	float                                              HP;                                                       // 0x0058(0x0004) (ZeroConstructor, IsPlainOldData)
	float                                              Energy;                                                   // 0x005C(0x0004) (ZeroConstructor, IsPlainOldData)
	float                                              dying_hp;                                                 // 0x0060(0x0004) (ZeroConstructor, IsPlainOldData)
	float                                              oxygen;                                                   // 0x0064(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                active_weapon_slot;                                       // 0x0068(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                weapon_status;                                            // 0x006C(0x0004) (ZeroConstructor, IsPlainOldData)
	bool                                               is_switching;                                             // 0x0070(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x3];                                       // 0x0071(0x0003) MISSED OFFSET
	int                                                alive_state;                                              // 0x0074(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                kill_count;                                               // 0x0078(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                assist_count;                                             // 0x007C(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                Damages;                                                  // 0x0080(0x0004) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x4];                                       // 0x0084(0x0004) MISSED OFFSET
	uint64_t                                           pawn_states;                                              // 0x0088(0x0008) (ZeroConstructor, IsPlainOldData)
	bool                                               is_left_probe;                                            // 0x0090(0x0001) (ZeroConstructor, IsPlainOldData)
	bool                                               is_right_probe;                                           // 0x0091(0x0001) (ZeroConstructor, IsPlainOldData)
	bool                                               is_floating;                                              // 0x0092(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData02[0x1];                                       // 0x0093(0x0001) MISSED OFFSET
	int                                                using_skill_id;                                           // 0x0094(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                skill_phase_index;                                        // 0x0098(0x0004) (ZeroConstructor, IsPlainOldData)
	bool                                               is_pose_acting;                                           // 0x009C(0x0001) (ZeroConstructor, IsPlainOldData)
	bool                                               is_picking;                                               // 0x009D(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData03[0x2];                                       // 0x009E(0x0002) MISSED OFFSET
	int                                                body_state;                                               // 0x00A0(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                location_state;                                           // 0x00A4(0x0004) (ZeroConstructor, IsPlainOldData)
	bool                                               has_smoke;                                                // 0x00A8(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData04[0x3];                                       // 0x00A9(0x0003) MISSED OFFSET
	int                                                player_type;                                              // 0x00AC(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                ai_level;                                                 // 0x00B0(0x0004) (ZeroConstructor, IsPlainOldData)
	TArray<struct FAIAttribute>                        Attributes;                                               // 0x00B4(0x000C) (ZeroConstructor)
	bool                                               is_lost_connection;                                       // 0x00C0(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData05[0x3];                                       // 0x00C1(0x0003) MISSED OFFSET
	int                                                ai_kill_count;                                            // 0x00C4(0x0004) (ZeroConstructor, IsPlainOldData)
	bool                                               in_delivery_pool;                                         // 0x00C8(0x0001) (ZeroConstructor, IsPlainOldData)
	bool                                               has_gone;                                                 // 0x00C9(0x0001) (ZeroConstructor, IsPlainOldData)
	bool                                               in_afk;                                                   // 0x00CA(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData06[0x1];                                       // 0x00CB(0x0001) MISSED OFFSET
	int                                                emote_id;                                                 // 0x00CC(0x0004) (ZeroConstructor, IsPlainOldData)
	bool                                               is_move_has_collision;                                    // 0x00D0(0x0001) (ZeroConstructor, IsPlainOldData)
	...
	int                                                zone_id;                                                  // 0x00DC(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                Gender;                                                   // 0x00E0(0x0004) (ZeroConstructor, IsPlainOldData)
	...
	bool                                               is_weapon_near_wall;                                      // 0x00F0(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData08[0x3];                                       // 0x00F1(0x0003) MISSED OFFSET
	struct FAIStateXYZ                                 head_position;                                            // 0x00F4(0x000C)
	struct FAIStateXYZ                                 muzzle_position;                                          // 0x0100(0x000C)
	uint32_t                                           ally_master_id;                                           // 0x010C(0x0004) (ZeroConstructor, IsPlainOldData)
};
...
struct FCameraState : public FAIStateInfoBase
{
	...
	struct FAIStateXYZ                                 view_position;                                            // 0x002C(0x000C)
};
...
struct FAIWeaponStateInfo : public FUniqueStateInfo
{
	...
	TArray<int>                                        attachments;                                              // 0x0034(0x000C) (ZeroConstructor)
	int                                                bullet_in_backpak;                                        // 0x0040(0x0004) (ZeroConstructor, IsPlainOldData)
	uint32_t                                           weapon_avatar_id;                                         // 0x0044(0x0004) (ZeroConstructor, IsPlainOldData)
};
...
struct FAIDamageInfo : public FAIStateInfoBase
{
	...
	int                                                damage_weapon_type;                                       // 0x0020(0x0004) (ZeroConstructor, IsPlainOldData)
	uint32_t                                           damage_part;                                              // 0x0024(0x0004) (ZeroConstructor, IsPlainOldData)
	float                                              damage_before_cal_armor;                                  // 0x0028(0x0004) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x4];                                       // 0x002C(0x0004) MISSED OFFSET
};
...
{
	TArray<struct FAIDamageInfo>                       active_damage;                                            // 0x0014(0x000C) (ZeroConstructor)
	TArray<struct FAIDamageInfo>                       passive_damage;                                           // 0x0020(0x000C) (ZeroConstructor)
	TArray<uint32_t>                                   kill_list;                                                // 0x002C(0x000C) (ZeroConstructor)
	TArray<uint32_t>                                   knock_down_list;                                          // 0x0038(0x000C) (ZeroConstructor)
...
{
	TArray<struct FAIStateXYZ>                         damage_source;                                            // 0x0014(0x000C) (ZeroConstructor)
	TArray<int>                                        damage_type;                                              // 0x0020(0x000C) (ZeroConstructor)
	TArray<int>                                        damage_weapon_type;                                       // 0x002C(0x000C) (ZeroConstructor)
};
...
{
	struct FAIStateXYZ                                 damage_source;                                            // 0x0014(0x000C)
	...
	uint32_t                                           damage_source_id;                                         // 0x0028(0x0004) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x4];                                       // 0x002C(0x0004) MISSED OFFSET
};
...
{
	int                                                Type;                                                     // 0x0014(0x0004) (ZeroConstructor, IsPlainOldData)
	float                                              remain_time;                                              // 0x0018(0x0004) (ZeroConstructor, IsPlainOldData)
	uint32_t                                           targetid;                                                 // 0x001C(0x0004) (ZeroConstructor, IsPlainOldData)
};
...
{
	uint32_t                                           ID;                                                       // 0x0014(0x0004) (ZeroConstructor, IsPlainOldData)
	bool                                               has_smoke;                                                // 0x0018(0x0001) (ZeroConstructor, IsPlainOldData)
...
{
	struct FAISimplifyStateBaseMod                     State;                                                    // 0x0020(0x0030)
};
...
{
	int                                                fire_count;                                               // 0x0014(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                hit_count;                                                // 0x0018(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                hit_head_count;                                           // 0x001C(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                hit_count_filter;                                         // 0x0020(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                hit_head_filter;                                          // 0x0024(0x0004) (ZeroConstructor, IsPlainOldData)
};
...
{
	TArray<struct FAIStateXYZ>                         hole_pos;                                                 // 0x0014(0x000C) (ZeroConstructor)
	TArray<struct FAIStateXYZ>                         hole_source_pos;                                          // 0x0020(0x000C) (ZeroConstructor)
	unsigned char                                      UnknownData00[0x4];                                       // 0x002C(0x0004) MISSED OFFSET
};
...
{
	struct FAIStateXYZ                                 hole_pos;                                                 // 0x0014(0x000C)
	struct FAIStateXYZ                                 hole_source_pos;                                          // 0x0020(0x000C)
	uint32_t                                           hole_source_id;                                           // 0x002C(0x0004) (ZeroConstructor, IsPlainOldData)
};
...
struct FAIStateConfig : public FAIStateInfoBase
{
	...
	int                                                Style;                                                    // 0x0018(0x0004) (ZeroConstructor, IsPlainOldData)
...
struct FDamageRate : public FAIStateInfoBase
{
	...
	float                                              Rate;                                                     // 0x0018(0x0004) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x4];                                       // 0x001C(0x0004) MISSED OFFSET
};
...
{
	TArray<struct FDamageRate>                         damage_rate_map;                                          // 0x0014(0x000C) (ZeroConstructor)
	TArray<struct FDamageRate>                         revive_damage_rate_map;                                   // 0x0020(0x000C) (ZeroConstructor)
	float                                              near_death_damage_rate;                                   // 0x002C(0x0004) (ZeroConstructor, IsPlainOldData)
};
...
{
	struct FString                                     msg_content;                                              // 0x0014(0x000C) (ZeroConstructor)
	uint32_t                                           item_id;                                                  // 0x0020(0x0004) (ZeroConstructor, IsPlainOldData)
	uint32_t                                           msg_id;                                                   // 0x0024(0x0004) (ZeroConstructor, IsPlainOldData)
	struct FAIStateXYZ                                 hit_position;                                             // 0x0028(0x000C)
...
{
	struct FAIStateXYZ                                 hit_pos;                                                  // 0x0014(0x000C)
	uint32_t                                           item_id;                                                  // 0x0020(0x0004) (ZeroConstructor, IsPlainOldData)
	uint32_t                                           msg_type;                                                 // 0x0024(0x0004) (ZeroConstructor, IsPlainOldData)
};
...
{
	struct FAIStateXYZ                                 mapmark_loc;                                              // 0x0014(0x000C)
	TArray<struct FAIStateXYZ>                         mapmultimark_list;                                        // 0x0020(0x000C) (ZeroConstructor)
	unsigned char                                      UnknownData00[0x4];                                       // 0x002C(0x0004) MISSED OFFSET
};
...
{
	float                                              max_destroy_time_float;                                   // 0x0014(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                max_destroy_num;                                          // 0x0018(0x0004) (ZeroConstructor, IsPlainOldData)
	float                                              destroy_cd_float;                                         // 0x001C(0x0004) (ZeroConstructor, IsPlainOldData)
	float                                              destroy_bullet_prob;                                      // 0x0020(0x0004) (ZeroConstructor, IsPlainOldData)
...
// 0x0388 (0x03A8 - 0x0020)
struct FAIStateInfoBaseMod : public FUniqueStateInfo
{
	struct FAIPlayerStateBaseMod                       State;                                                    // 0x0020(0x0110)
	struct FCameraState                                Camera;                                                   // 0x0130(0x0038)
	struct FAIPlayerWeapon                             Weapon;                                                   // 0x0168(0x000C)
	struct FAIPlayerBackpack                           BackPack;                                                 // 0x0174(0x000C)
	struct FAIPlayerEquipment                          equipment;                                                // 0x0180(0x000C)
	uint32_t                                           Key;                                                      // 0x018C(0x0004) (ZeroConstructor, IsPlainOldData)
	struct FAIPlayerInteractInfo                       player_interact_info;                                     // 0x0190(0x0048)
	struct FAIHeardSound                               Sound;                                                    // 0x01D8(0x000C)
	unsigned char                                      UnknownData00[0x4];                                       // 0x01E4(0x0004) MISSED OFFSET
	struct FAIDamageSources                            damage_sources;                                           // 0x01E8(0x0038)
	TArray<struct FDamageSource>                       all_damage_source;                                        // 0x0220(0x000C) (ZeroConstructor)
	unsigned char                                      UnknownData01[0x4];                                       // 0x022C(0x0004) MISSED OFFSET
	struct FProgressBarState                           progress_bar;                                             // 0x0230(0x0020)
	TArray<struct FAINearbyPlayerBaseMod>              nearby_player;                                            // 0x0250(0x000C) (ZeroConstructor)
	TArray<struct FItemStateData>                      nearby_item;                                              // 0x025C(0x000C) (ZeroConstructor)
	TArray<struct FAINearbyThrown>                     nearby_thrown;                                            // 0x0268(0x000C) (ZeroConstructor)
	unsigned char                                      UnknownData02[0x4];                                       // 0x0274(0x0004) MISSED OFFSET
	struct FAIPlayerHitInfo                            player_hit_info;                                          // 0x0278(0x0028)
	struct FAIBulletHoles                              bullet_holes;                                             // 0x02A0(0x0030)
	TArray<struct FAIBulletHole>                       all_bullet_hole;                                          // 0x02D0(0x000C) (ZeroConstructor)
	uint32_t                                           ai_style;                                                 // 0x02DC(0x0004) (ZeroConstructor, IsPlainOldData)
	struct FAIStateConfig                              Config;                                                   // 0x02E0(0x0020)
	unsigned char                                      UnknownData03[0x1C];                                      // 0x0300(0x001C) MISSED OFFSET
	TArray<uint64_t>                                   nearby_item_index;                                        // 0x031C(0x000C) (ZeroConstructor)
	TArray<uint64_t>                                   nearby_thrown_index;                                      // 0x0328(0x000C) (ZeroConstructor)
	unsigned char                                      UnknownData04[0x4];                                       // 0x0334(0x0004) MISSED OFFSET
	struct FDamageRateInfo                             damage_rate_info;                                         // 0x0338(0x0030)
	TArray<struct FChatMsgInfo>                        chatmsg_info_list;                                        // 0x0368(0x000C) (ZeroConstructor)
	TArray<struct FSignMsgInfo>                        signmsg_info_list;                                        // 0x0374(0x000C) (ZeroConstructor)
	TArray<struct FMapMarkInfo>                        mapmark_info_list;                                        // 0x0380(0x000C) (ZeroConstructor)
	TArray<struct FAIAvatarInfo>                       avatar_info;                                              // 0x038C(0x000C) (ZeroConstructor)
	TArray<struct FAIDestroyBulletProbInfo>            destroy_bullet_prob_info;                                 // 0x0398(0x000C) (ZeroConstructor)
	unsigned char                                      UnknownData05[0x4];                                       // 0x03A4(0x0004) MISSED OFFSET
};
...
{
	TArray<struct FAIAttribute>                        Values;                                                   // 0x0014(0x000C) (ZeroConstructor)
	TArray<uint64_t>                                   del_item_id;                                              // 0x0020(0x000C) (ZeroConstructor)
	unsigned char                                      UnknownData00[0x4];                                       // 0x002C(0x0004) MISSED OFFSET
};
...
struct FDiffAIPlayerStateBaseModGeneral : public FAIStateInfoBase
{
	...
	bool                                               is_pose_acting;                                           // 0x009C(0x0001) (ZeroConstructor, IsPlainOldData)
	bool                                               is_picking;                                               // 0x009D(0x0001) (ZeroConstructor, IsPlainOldData)
	bool                                               is_weapon_near_wall;                                      // 0x009E(0x0001) (ZeroConstructor, IsPlainOldData)
	...
	int                                                player_type;                                              // 0x00AC(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                ai_level;                                                 // 0x00B0(0x0004) (ZeroConstructor, IsPlainOldData)
	bool                                               is_move_has_collision;                                    // 0x00B4(0x0001) (ZeroConstructor, IsPlainOldData)
	bool                                               is_lost_connection;                                       // 0x00B5(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData05[0x2];                                       // 0x00B6(0x0002) MISSED OFFSET
	float                                              rating_score;                                             // 0x00B8(0x0004) (ZeroConstructor, IsPlainOldData)
	float                                              real_hidden_score;                                        // 0x00BC(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                zone_id;                                                  // 0x00C0(0x0004) (ZeroConstructor, IsPlainOldData)
	...
	struct FDiffAIAttributesGeneral                    Attributes;                                               // 0x00C8(0x0030)
	int                                                ai_kill_count;                                            // 0x00F8(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                Gender;                                                   // 0x00FC(0x0004) (ZeroConstructor, IsPlainOldData)
	bool                                               has_gone;                                                 // 0x0100(0x0001) (ZeroConstructor, IsPlainOldData)
	bool                                               in_afk;                                                   // 0x0101(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData07[0x2];                                       // 0x0102(0x0002) MISSED OFFSET
	int                                                emote_id;                                                 // 0x0104(0x0004) (ZeroConstructor, IsPlainOldData)
	...
	struct FAIStateXYZ                                 head_position;                                            // 0x0114(0x000C)
	struct FAIStateXYZ                                 muzzle_position;                                          // 0x0120(0x000C)
	uint32_t                                           ally_master_id;                                           // 0x012C(0x0004) (ZeroConstructor, IsPlainOldData)
};
...
{
	TArray<struct FAIWeaponStateInfo>                  Values;                                                   // 0x0014(0x000C) (ZeroConstructor)
	TArray<uint64_t>                                   del_item_id;                                              // 0x0020(0x000C) (ZeroConstructor)
	unsigned char                                      UnknownData00[0x4];                                       // 0x002C(0x0004) MISSED OFFSET
};
...
{
	struct FDiffAIWeaponStateInfoGeneral               player_weapon;                                            // 0x0018(0x0030)
};
...
{
	TArray<struct FAIBackpackItem>                     Values;                                                   // 0x0014(0x000C) (ZeroConstructor)
	TArray<uint64_t>                                   del_item_id;                                              // 0x0020(0x000C) (ZeroConstructor)
	unsigned char                                      UnknownData00[0x4];                                       // 0x002C(0x0004) MISSED OFFSET
};
...
{
	struct FDiffAIBackpackItemGeneral                  backpack_item;                                            // 0x0018(0x0030)
};
...
{
	TArray<struct FAIEquipmentInfo>                    Values;                                                   // 0x0014(0x000C) (ZeroConstructor)
	TArray<uint64_t>                                   del_item_id;                                              // 0x0020(0x000C) (ZeroConstructor)
	unsigned char                                      UnknownData00[0x4];                                       // 0x002C(0x0004) MISSED OFFSET
};
...
{
	struct FDiffAIEquipmentInfoGeneral                 equipment_item;                                           // 0x0018(0x0030)
};
...
{
	TMap<uint32_t, struct FAINearbyPlayerBaseMod>      Values;                                                   // 0x0014(0x0050) (ZeroConstructor)
	TArray<uint64_t>                                   del_item_id;                                              // 0x0050(0x000C) (ZeroConstructor)
...
{
	TArray<struct FItemStateData>                      Values;                                                   // 0x0014(0x000C) (ZeroConstructor)
	TArray<uint64_t>                                   del_item_id;                                              // 0x0020(0x000C) (ZeroConstructor)
	unsigned char                                      UnknownData00[0x4];                                       // 0x002C(0x0004) MISSED OFFSET
};
...
{
	TArray<struct FAINearbyThrown>                     Values;                                                   // 0x0014(0x000C) (ZeroConstructor)
	TArray<uint64_t>                                   del_item_id;                                              // 0x0020(0x000C) (ZeroConstructor)
	unsigned char                                      UnknownData00[0x4];                                       // 0x002C(0x0004) MISSED OFFSET
};
...
{
	TArray<struct FAIDestroyBulletProbInfo>            Values;                                                   // 0x0014(0x000C) (ZeroConstructor)
	TArray<uint64_t>                                   del_item_id;                                              // 0x0020(0x000C) (ZeroConstructor)
	unsigned char                                      UnknownData00[0x4];                                       // 0x002C(0x0004) MISSED OFFSET
};

// ScriptStruct AI.DiffAIStateInfoBaseModGeneral
// 0x04E8 (0x0508 - 0x0020)
struct FDiffAIStateInfoBaseModGeneral : public FDiffUniqueStateInfo
{
	struct FDiffAIPlayerStateBaseModGeneral            State;                                                    // 0x0020(0x0130)
	struct FAIHeardSound                               Sound;                                                    // 0x0150(0x000C)
	unsigned char                                      UnknownData00[0x4];                                       // 0x015C(0x0004) MISSED OFFSET
	struct FAIDamageSources                            damage_sources;                                           // 0x0160(0x0038)
	struct FAIPlayerInteractInfo                       player_interact_info;                                     // 0x0198(0x0048)
	struct FCameraState                                Camera;                                                   // 0x01E0(0x0038)
	struct FDiffAIPlayerWeaponGeneral                  Weapon;                                                   // 0x0218(0x0048)
	struct FDiffAIPlayerBackpackGeneral                BackPack;                                                 // 0x0260(0x0048)
	struct FDiffAIPlayerEquipmentGeneral               equipment;                                                // 0x02A8(0x0048)
	struct FProgressBarState                           progress_bar;                                             // 0x02F0(0x0020)
	struct FDiffAINearbyPlayersBaseModGeneral          nearby_player;                                            // 0x0310(0x0060)
	struct FDiffItemStateDatasGeneral                  nearby_item;                                              // 0x0370(0x0030)
	TArray<uint64_t>                                   nearby_item_index;                                        // 0x03A0(0x000C) (ZeroConstructor)
	unsigned char                                      UnknownData01[0x4];                                       // 0x03AC(0x0004) MISSED OFFSET
	struct FDiffAINearbyThrownGeneral                  nearby_thrown;                                            // 0x03B0(0x0030)
	TArray<uint64_t>                                   nearby_thrown_index;                                      // 0x03E0(0x000C) (ZeroConstructor)
	unsigned char                                      UnknownData02[0x4];                                       // 0x03EC(0x0004) MISSED OFFSET
	struct FAIPlayerHitInfo                            player_hit_info;                                          // 0x03F0(0x0028)
	uint32_t                                           Key;                                                      // 0x0418(0x0004) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData03[0x4];                                       // 0x041C(0x0004) MISSED OFFSET
	struct FAIBulletHoles                              bullet_holes;                                             // 0x0420(0x0030)
	...
	struct FAIStateConfig                              Config;                                                   // 0x0458(0x0020)
	struct FDamageRateInfo                             damage_rate_info;                                         // 0x0478(0x0030)
	TArray<struct FChatMsgInfo>                        chatmsg_info_list;                                        // 0x04A8(0x000C) (ZeroConstructor)
	TArray<struct FSignMsgInfo>                        signmsg_info_list;                                        // 0x04B4(0x000C) (ZeroConstructor)
	TArray<struct FMapMarkInfo>                        mapmark_info_list;                                        // 0x04C0(0x000C) (ZeroConstructor)
	TArray<struct FAIAvatarInfo>                       avatar_info;                                              // 0x04CC(0x000C) (ZeroConstructor)
	struct FDiffAIDestroyBulletProbInfoListGeneral     destroy_bullet_prob_info;                                 // 0x04D8(0x0030)
};
...
{
	uint32_t                                           ID;                                                       // 0x0014(0x0004) (ZeroConstructor, IsPlainOldData)
	struct FDiffStateInfoFloat                         Value;                                                    // 0x0018(0x0004)
	unsigned char                                      UnknownData00[0x4];                                       // 0x001C(0x0004) MISSED OFFSET
};
...
{
	TArray<struct FDiffAttribute>                      attribute_state;                                          // 0x0014(0x000C) (ZeroConstructor)
	TArray<uint32_t>                                   item_state;                                               // 0x0020(0x000C) (ZeroConstructor)
	unsigned char                                      UnknownData00[0x4];                                       // 0x002C(0x0004) MISSED OFFSET
};
...
struct FDiffAIPlayerStateBaseMod : public FDiffStateInfoBase
{
	...
	struct FDiffStateInfoInt32                         assist_count;                                             // 0x006C(0x0004)
	struct FDiffStateInfoInt32                         Damages;                                                  // 0x0070(0x0004)
	unsigned char                                      UnknownData01[0x4];                                       // 0x0074(0x0004) MISSED OFFSET
	struct FDiffStateInfoUInt64                        pawn_states;                                              // 0x0078(0x0008)
	struct FDiffStateInfoBool                          is_left_probe;                                            // 0x0080(0x0001)
	struct FDiffStateInfoBool                          is_right_probe;                                           // 0x0081(0x0001)
	struct FDiffStateInfoBool                          is_floating;                                              // 0x0082(0x0001)
	unsigned char                                      UnknownData02[0x1];                                       // 0x0083(0x0001) MISSED OFFSET
	struct FDiffStateInfoInt32                         using_skill_id;                                           // 0x0084(0x0004)
	struct FDiffStateInfoInt32                         skill_phase_index;                                        // 0x0088(0x0004)
	struct FDiffStateInfoBool                          is_pose_acting;                                           // 0x008C(0x0001)
	struct FDiffStateInfoBool                          is_picking;                                               // 0x008D(0x0001)
	unsigned char                                      UnknownData03[0x2];                                       // 0x008E(0x0002) MISSED OFFSET
	struct FDiffStateInfoInt32                         body_state;                                               // 0x0090(0x0004)
	struct FDiffStateInfoInt32                         location_state;                                           // 0x0094(0x0004)
	struct FDiffStateInfoBool                          has_smoke;                                                // 0x0098(0x0001)
	unsigned char                                      UnknownData04[0x3];                                       // 0x0099(0x0003) MISSED OFFSET
	struct FDiffStateInfoInt32                         player_type;                                              // 0x009C(0x0004)
	struct FDiffStateInfoInt32                         ai_level;                                                 // 0x00A0(0x0004)
	unsigned char                                      UnknownData05[0x4];                                       // 0x00A4(0x0004) MISSED OFFSET
	struct FDiffAIAttributes                           Attributes;                                               // 0x00A8(0x0030)
	struct FDiffStateInfoBool                          is_lost_connection;                                       // 0x00D8(0x0001)
	unsigned char                                      UnknownData06[0x3];                                       // 0x00D9(0x0003) MISSED OFFSET
	struct FDiffStateInfoInt32                         ai_kill_count;                                            // 0x00DC(0x0004)
	struct FDiffStateInfoBool                          in_delivery_pool;                                         // 0x00E0(0x0001)
	struct FDiffStateInfoBool                          has_gone;                                                 // 0x00E1(0x0001)
	struct FDiffStateInfoBool                          in_afk;                                                   // 0x00E2(0x0001)
	unsigned char                                      UnknownData07[0x1];                                       // 0x00E3(0x0001) MISSED OFFSET
	struct FDiffStateInfoInt32                         emote_id;                                                 // 0x00E4(0x0004)
	struct FDiffStateInfoBool                          is_move_has_collision;                                    // 0x00E8(0x0001)
	unsigned char                                      UnknownData08[0x3];                                       // 0x00E9(0x0003) MISSED OFFSET
	struct FDiffStateInfoInt32                         high_hp_destroy_bullet_num;                               // 0x00EC(0x0004)
	struct FDiffStateInfoInt32                         low_hp_destroy_bullet_num;                                // 0x00F0(0x0004)
	struct FDiffStateInfoInt32                         fatal_damage_destroy_bullet_num;                          // 0x00F4(0x0004)
};
...
struct FDiffCameraState : public FDiffStateInfoBase
{
	...
	struct FDiffStateInfoVector                        view_position;                                            // 0x002C(0x000C)
};
...
{
	uint32_t                                           slot_id;                                                  // 0x0014(0x0004) (ZeroConstructor, IsPlainOldData)
	struct FDiffStateInfoInt32                         Category;                                                 // 0x0018(0x0004)
	struct FDiffStateInfoInt32                         Type;                                                     // 0x001C(0x0004)
	struct FDiffStateInfoInt32                         Bullet;                                                   // 0x0020(0x0004)
	struct FDiffStateInfoFloat                         remain_reloading;                                         // 0x0024(0x0004)
	TArray<int>                                        attachments;                                              // 0x0028(0x000C) (ZeroConstructor)
	unsigned char                                      UnknownData00[0x4];                                       // 0x0034(0x0004) MISSED OFFSET
};
...
{
	TArray<struct FDiffAIWeaponStateInfo>              player_weapon;                                            // 0x0014(0x000C) (ZeroConstructor)
	TArray<uint32_t>                                   item_state;                                               // 0x0020(0x000C) (ZeroConstructor)
	unsigned char                                      UnknownData00[0x4];                                       // 0x002C(0x0004) MISSED OFFSET
};
...
struct FDiffAIBackpackItem : public FDiffStateInfoBase
{
	...
	struct FDiffStateInfoUInt32                        Count;                                                    // 0x001C(0x0004)
};
...
{
	TArray<struct FDiffAIBackpackItem>                 backpack_item;                                            // 0x0014(0x000C) (ZeroConstructor)
	TArray<uint32_t>                                   item_state;                                               // 0x0020(0x000C) (ZeroConstructor)
	unsigned char                                      UnknownData00[0x4];                                       // 0x002C(0x0004) MISSED OFFSET
};
...
struct FDiffAIEquipmentInfo : public FDiffStateInfoBase
{
	struct FDiffStateInfoInt32                         Category;                                                 // 0x0014(0x0004)
	uint32_t                                           ID;                                                       // 0x0018(0x0004) (ZeroConstructor, IsPlainOldData)
	struct FDiffStateInfoFloat                         Durability;                                               // 0x001C(0x0004)
};
...
{
	TArray<struct FDiffAIEquipmentInfo>                equipment_item;                                           // 0x0014(0x000C) (ZeroConstructor)
	TArray<uint32_t>                                   item_state;                                               // 0x0020(0x000C) (ZeroConstructor)
	unsigned char                                      UnknownData00[0x4];                                       // 0x002C(0x0004) MISSED OFFSET
};
...
struct FDiffProgressBarState : public FDiffStateInfoBase
{
	...
	struct FDiffStateInfoFloat                         remain_time;                                              // 0x0018(0x0004)
	unsigned char                                      UnknownData00[0x4];                                       // 0x001C(0x0004) MISSED OFFSET
};
...
{
	uint32_t                                           ID;                                                       // 0x0014(0x0004) (ZeroConstructor, IsPlainOldData)
	struct FDiffStateInfoBool                          has_smoke;                                                // 0x0018(0x0001)
...
{
	TArray<struct FDiffAINearbyPlayerBaseMod>          Players;                                                  // 0x0014(0x000C) (ZeroConstructor)
	TArray<uint32_t>                                   item_state;                                               // 0x0020(0x000C) (ZeroConstructor)
	unsigned char                                      UnknownData00[0x4];                                       // 0x002C(0x0004) MISSED OFFSET
};
...
struct FDiffItemStateData : public FDiffStateInfoBase
{
	struct FDiffStateInfoInt32                         Type;                                                     // 0x0014(0x0004)
	struct FDiffStateInfoInt32                         Category;                                                 // 0x0018(0x0004)
	struct FDiffStateInfoUInt32                        ID;                                                       // 0x001C(0x0004)
	int                                                UID;                                                      // 0x0020(0x0004) (ZeroConstructor, IsPlainOldData)
	struct FDiffStateInfoFloat                         Durability;                                               // 0x0024(0x0004)
	struct FDiffStateInfoVector                        Position;                                                 // 0x0028(0x000C)
	struct FDiffStateInfoUInt32                        player_id;                                                // 0x0034(0x0004)
...
{
	TArray<struct FDiffItemStateData>                  Items;                                                    // 0x0014(0x000C) (ZeroConstructor)
	TArray<uint32_t>                                   item_state;                                               // 0x0020(0x000C) (ZeroConstructor)
	unsigned char                                      UnknownData00[0x4];                                       // 0x002C(0x0004) MISSED OFFSET
};
...
{
	struct FDiffStateInfoInt32                         Level;                                                    // 0x0014(0x0004)
	struct FDiffStateInfoInt32                         Style;                                                    // 0x0018(0x0004)
	unsigned char                                      UnknownData00[0x4];                                       // 0x001C(0x0004) MISSED OFFSET
};
...
{
	struct FDiffStateInfoFloat                         max_destroy_time_float;                                   // 0x0014(0x0004)
	struct FDiffStateInfoInt32                         max_destroy_num;                                          // 0x0018(0x0004)
	struct FDiffStateInfoFloat                         destroy_cd_float;                                         // 0x001C(0x0004)
	struct FDiffStateInfoFloat                         destroy_bullet_prob;                                      // 0x0020(0x0004)
	unsigned char                                      UnknownData00[0x4];                                       // 0x0024(0x0004) MISSED OFFSET
};
...
{
	int                                                bullet_id;                                                // 0x0014(0x0004) (ZeroConstructor, IsPlainOldData)
	struct FDiffStateInfoFloat                         low_hp_threshold;                                         // 0x0018(0x0004)
	unsigned char                                      UnknownData00[0x4];                                       // 0x001C(0x0004) MISSED OFFSET
...
{
	TArray<struct FDiffAIDestroyBulletProbInfo>        States;                                                   // 0x0014(0x000C) (ZeroConstructor)
	TArray<uint32_t>                                   item_state;                                               // 0x0020(0x000C) (ZeroConstructor)
	unsigned char                                      UnknownData00[0x4];                                       // 0x002C(0x0004) MISSED OFFSET
};
...
{
	struct FDiffAIPlayerStateBaseMod                   State;                                                    // 0x0018(0x00F8)
	...
	uint32_t                                           Key;                                                      // 0x01D8(0x0004) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x4];                                       // 0x01DC(0x0004) MISSED OFFSET
	struct FAIPlayerInteractInfo                       player_interact_info;                                     // 0x01E0(0x0048)
	struct FAIHeardSound                               Sound;                                                    // 0x0228(0x000C)
	TArray<struct FDamageSource>                       all_damage_source;                                        // 0x0234(0x000C) (ZeroConstructor)
	struct FDiffProgressBarState                       progress_bar;                                             // 0x0240(0x0020)
	struct FDiffAINearbyPlayersBaseMod                 nearby_player;                                            // 0x0260(0x0030)
	struct FDiffItemStateDatas                         nearby_item;                                              // 0x0290(0x0030)
	TArray<struct FAINearbyThrown>                     nearby_thrown;                                            // 0x02C0(0x000C) (ZeroConstructor)
	TArray<struct FItemStateData>                      nearby_box_item;                                          // 0x02CC(0x000C) (ZeroConstructor)
	struct FAIPlayerHitInfo                            player_hit_info;                                          // 0x02D8(0x0028)
	TArray<struct FAIBulletHole>                       all_bullet_hole;                                          // 0x0300(0x000C) (ZeroConstructor)
	uint32_t                                           ai_style;                                                 // 0x030C(0x0004) (ZeroConstructor, IsPlainOldData)
	struct FDiffAIConfig                               Config;                                                   // 0x0310(0x0020)
	struct FDiffAIDestroyBulletProbInfos               destroy_bullet_prob_info;                                 // 0x0330(0x0030)
};
...
struct FAIPlayerStateBRBase : public FAIStateInfoBase
{
	...
	bool                                               is_be_spectated;                                          // 0x0024(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x3];                                       // 0x0025(0x0003) MISSED OFFSET
	int                                                parallel_world_id;                                        // 0x0028(0x0004) (ZeroConstructor, IsPlainOldData)
	uint32_t                                           related_id;                                               // 0x002C(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                revival_type;                                             // 0x0030(0x0004) (ZeroConstructor, IsPlainOldData)
	uint32_t                                           parachute_state;                                          // 0x0034(0x0004) (ZeroConstructor, IsPlainOldData)
	uint32_t                                           plane_id;                                                 // 0x0038(0x0004) (ZeroConstructor, IsPlainOldData)
	...
	bool                                               can_self_revival;                                         // 0x0044(0x0001) (ZeroConstructor, IsPlainOldData)
...
{
	uint32_t                                           vehicle_id;                                               // 0x0014(0x0004) (ZeroConstructor, IsPlainOldData)
	uint32_t                                           PlayerKey;                                                // 0x0018(0x0004) (ZeroConstructor, IsPlainOldData)
	float                                              Damage;                                                   // 0x001C(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                damage_type;                                              // 0x0020(0x0004) (ZeroConstructor, IsPlainOldData)
	bool                                               is_kill;                                                  // 0x0024(0x0001) (ZeroConstructor, IsPlainOldData)
...
struct FVehicleState : public FUniqueStateInfo
{
	...
	struct FCameraState                                Camera;                                                   // 0x0060(0x0038)
	int                                                location_state;                                           // 0x0098(0x0004) (ZeroConstructor, IsPlainOldData)
	bool                                               is_attached;                                              // 0x009C(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x3];                                       // 0x009D(0x0003) MISSED OFFSET
	TArray<float>                                      wheels_hp;                                                // 0x00A0(0x000C) (ZeroConstructor)
	TArray<struct FVehicleDamageInfo>                  damage_info;                                              // 0x00AC(0x000C) (ZeroConstructor)
...
{
	uint32_t                                           ID;                                                       // 0x0014(0x0004) (ZeroConstructor, IsPlainOldData)
	uint32_t                                           team_id;                                                  // 0x0018(0x0004) (ZeroConstructor, IsPlainOldData)
	struct FAIStateXYZ                                 Position;                                                 // 0x001C(0x000C)
	float                                              HP;                                                       // 0x0028(0x0004) (ZeroConstructor, IsPlainOldData)
...
struct FAIStateInfoBRBase : public FUniqueStateInfo
{
	...
	struct FVehicleState                               vehicle_state;                                            // 0x0088(0x00C8)
	TArray<struct FDoorState>                          nearby_door;                                              // 0x0150(0x000C) (ZeroConstructor)
	TArray<struct FVehicleState>                       nearby_vehicles;                                          // 0x015C(0x000C) (ZeroConstructor)
	TArray<struct FAIRecipients>                       recipients;                                               // 0x0168(0x000C) (ZeroConstructor)
	TArray<struct FMonsterState>                       monster_states;                                           // 0x0174(0x000C) (ZeroConstructor)
	TArray<struct FDynamicItem>                        dynamic_items;                                            // 0x0180(0x000C) (ZeroConstructor)
	TArray<uint64_t>                                   nearby_door_index;                                        // 0x018C(0x000C) (ZeroConstructor)
	uint32_t                                           deliver_target_id;                                        // 0x0198(0x0004) (ZeroConstructor, IsPlainOldData)
	TArray<uint64_t>                                   nearby_vehicles_index;                                    // 0x019C(0x000C) (ZeroConstructor)
	TArray<uint64_t>                                   dynamic_items_index;                                      // 0x01A8(0x000C) (ZeroConstructor)
	TArray<uint64_t>                                   monster_states_index;                                     // 0x01B4(0x000C) (ZeroConstructor)
	TArray<struct FLandScapeDestroyState>              landscape_destroy_info;                                   // 0x01C0(0x000C) (ZeroConstructor)
...
{
	TArray<struct FDoorState>                          Values;                                                   // 0x0014(0x000C) (ZeroConstructor)
	TArray<uint64_t>                                   del_item_id;                                              // 0x0020(0x000C) (ZeroConstructor)
	unsigned char                                      UnknownData00[0x4];                                       // 0x002C(0x0004) MISSED OFFSET
};
...
{
	TArray<struct FVehicleState>                       Values;                                                   // 0x0014(0x000C) (ZeroConstructor)
	TArray<uint64_t>                                   del_item_id;                                              // 0x0020(0x000C) (ZeroConstructor)
	unsigned char                                      UnknownData00[0x4];                                       // 0x002C(0x0004) MISSED OFFSET
};
...
{
	TArray<struct FDynamicItem>                        Values;                                                   // 0x0014(0x000C) (ZeroConstructor)
	TArray<uint64_t>                                   del_item_id;                                              // 0x0020(0x000C) (ZeroConstructor)
	unsigned char                                      UnknownData00[0x4];                                       // 0x002C(0x0004) MISSED OFFSET
};
...
{
	TArray<struct FMonsterState>                       Values;                                                   // 0x0014(0x000C) (ZeroConstructor)
	TArray<uint64_t>                                   del_item_id;                                              // 0x0020(0x000C) (ZeroConstructor)
	unsigned char                                      UnknownData00[0x4];                                       // 0x002C(0x0004) MISSED OFFSET
};
...
{
	struct FAIPlayerStateBRBase                        State;                                                    // 0x0020(0x0068)
	struct FDiffDoorStateGeneral                       nearby_door;                                              // 0x0088(0x0030)
	TArray<uint64_t>                                   nearby_door_index;                                        // 0x00B8(0x000C) (ZeroConstructor)
	unsigned char                                      UnknownData00[0x4];                                       // 0x00C4(0x0004) MISSED OFFSET
	struct FVehicleState                               vehicle_state;                                            // 0x00C8(0x00C8)
	struct FDiffVehicleStatesGeneral                   nearby_vehicles;                                          // 0x0190(0x0030)
	TArray<uint64_t>                                   nearby_vehicles_index;                                    // 0x01C0(0x000C) (ZeroConstructor)
	uint32_t                                           deliver_target_id;                                        // 0x01CC(0x0004) (ZeroConstructor, IsPlainOldData)
	TArray<struct FAIRecipients>                       recipients;                                               // 0x01D0(0x000C) (ZeroConstructor)
	unsigned char                                      UnknownData01[0x4];                                       // 0x01DC(0x0004) MISSED OFFSET
	struct FDiffDynamicItemStatesGeneral               dynamic_items;                                            // 0x01E0(0x0030)
	TArray<uint64_t>                                   dynamic_items_index;                                      // 0x0210(0x000C) (ZeroConstructor)
	unsigned char                                      UnknownData02[0x4];                                       // 0x021C(0x0004) MISSED OFFSET
	struct FDiffMonsterStatesGeneral                   monster_states;                                           // 0x0220(0x0030)
	TArray<uint64_t>                                   monster_states_index;                                     // 0x0250(0x000C) (ZeroConstructor)
...
struct FDiffAIPlayerStateBRBase : public FAIStateInfoBase
{
	...
	unsigned char                                      UnknownData00[0x3];                                       // 0x0019(0x0003) MISSED OFFSET
	struct FDiffStateInfoInt32                         vehicle_role;                                             // 0x001C(0x0004)
	struct FDiffStateInfoInt32                         revival_count;                                            // 0x0020(0x0004)
	struct FDiffStateInfoBool                          is_be_spectated;                                          // 0x0024(0x0001)
	unsigned char                                      UnknownData01[0x3];                                       // 0x0025(0x0003) MISSED OFFSET
	struct FDiffStateInfoInt32                         parallel_world_id;                                        // 0x0028(0x0004)
	struct FDiffStateInfoUInt32                        related_id;                                               // 0x002C(0x0004)
	struct FDiffStateInfoInt32                         revival_type;                                             // 0x0030(0x0004)
	struct FDiffStateInfoUInt32                        plane_id;                                                 // 0x0034(0x0004)
	struct FDiffStateInfoUInt32                        parachute_state;                                          // 0x0038(0x0004)
	struct FDiffStateInfoBool                          can_parachute_jump;                                       // 0x003C(0x0001)
	unsigned char                                      UnknownData02[0x3];                                       // 0x003D(0x0003) MISSED OFFSET
	struct FDiffStateInfoUInt32                        follow_state;                                             // 0x0040(0x0004)
	struct FDiffStateInfoUInt32                        leader_id;                                                // 0x0044(0x0004)
	struct FDiffStateInfoUInt32                        parachute_type;                                           // 0x0048(0x0004)
	struct FDiffStateInfoVector                        target_position;                                          // 0x004C(0x000C)
};
...
struct FDiffVehicleState : public FDiffStateInfoBase
{
	...
	struct FDiffStateInfoFloat                         HP;                                                       // 0x0030(0x0004)
	struct FDiffStateInfoFloat                         gas;                                                      // 0x0034(0x0004)
	struct FDiffStateInfoVector                        Speed;                                                    // 0x0038(0x000C)
	struct FDiffStateInfoUInt32                        damaged_num;                                              // 0x0044(0x0004)
	struct FDiffStateInfoUInt32                        Category;                                                 // 0x0048(0x0004)
	struct FDiffStateInfoBool                          is_reverse;                                               // 0x004C(0x0001)
	struct FDiffStateInfoBool                          has_player;                                               // 0x004D(0x0001)
	struct FDiffStateInfoBool                          is_full;                                                  // 0x004E(0x0001)
...
{
	TArray<struct FDiffVehicleState>                   vehicle_states;                                           // 0x0014(0x000C) (ZeroConstructor)
	TArray<uint32_t>                                   item_state;                                               // 0x0020(0x000C) (ZeroConstructor)
	unsigned char                                      UnknownData00[0x4];                                       // 0x002C(0x0004) MISSED OFFSET
};
...
{
	uint32_t                                           ID;                                                       // 0x0014(0x0004) (ZeroConstructor, IsPlainOldData)
	struct FDiffStateInfoUInt32                        Category;                                                 // 0x0018(0x0004)
	...
	struct FDiffStateInfoFloat                         hp_max;                                                   // 0x0044(0x0004)
	struct FDiffStateInfoInt32                         using_skill_id;                                           // 0x0048(0x0004)
	unsigned char                                      UnknownData00[0x4];                                       // 0x004C(0x0004) MISSED OFFSET
};
...
{
	TArray<struct FDiffMonsterState>                   States;                                                   // 0x0014(0x000C) (ZeroConstructor)
	TArray<uint32_t>                                   item_state;                                               // 0x0020(0x000C) (ZeroConstructor)
	unsigned char                                      UnknownData00[0x4];                                       // 0x002C(0x0004) MISSED OFFSET
};
...
struct FDiffDynamicItem : public FDiffStateInfoBase
{
	...
	struct FDiffStateInfoVector                        Rotation;                                                 // 0x0028(0x000C)
	struct FDiffStateInfoFloat                         Durability;                                               // 0x0034(0x0004)
	struct FDiffStateInfoUInt32                        Custom;                                                   // 0x0038(0x0004)
	struct FDiffStateInfoInt32                         parallel_world_id;                                        // 0x003C(0x0004)
};
...
{
	TArray<struct FDiffDynamicItem>                    dynamic_items;                                            // 0x0014(0x000C) (ZeroConstructor)
	TArray<uint32_t>                                   item_state;                                               // 0x0020(0x000C) (ZeroConstructor)
	unsigned char                                      UnknownData00[0x4];                                       // 0x002C(0x0004) MISSED OFFSET
};
...
{
	uint32_t                                           ID;                                                       // 0x0014(0x0004) (ZeroConstructor, IsPlainOldData)
	struct FDiffStateInfoVector                        Location;                                                 // 0x0018(0x000C)
	struct FDiffStateInfoInt32                         Radius;                                                   // 0x0024(0x0004)
	struct FDiffStateInfoInt32                         Depth;                                                    // 0x0028(0x0004)
	unsigned char                                      UnknownData00[0x4];                                       // 0x002C(0x0004) MISSED OFFSET
};
...
{
	TArray<struct FDiffLandScapeDestroyState>          States;                                                   // 0x0014(0x000C) (ZeroConstructor)
	TArray<uint32_t>                                   item_state;                                               // 0x0020(0x000C) (ZeroConstructor)
	unsigned char                                      UnknownData00[0x4];                                       // 0x002C(0x0004) MISSED OFFSET
};

// ScriptStruct AI.DiffAIStateInfoBRBase
// 0x01C8 (0x01E0 - 0x0018)
struct FDiffAIStateInfoBRBase : public FDiffStateInfoBase
{
	struct FDiffAIPlayerStateBRBase                    State;                                                    // 0x0018(0x0058)
	struct FDiffVehicleState                           vehicle_state;                                            // 0x0070(0x0090)
	TArray<struct FDoorState>                          nearby_door;                                              // 0x0100(0x000C) (ZeroConstructor)
	unsigned char                                      UnknownData00[0x4];                                       // 0x010C(0x0004) MISSED OFFSET
	struct FDiffVehicleStates                          nearby_vehicles;                                          // 0x0110(0x0030)
	TArray<struct FAIRecipients>                       recipients;                                               // 0x0140(0x000C) (ZeroConstructor)
	unsigned char                                      UnknownData01[0x4];                                       // 0x014C(0x0004) MISSED OFFSET
	struct FDiffMonsterStates                          monster_states;                                           // 0x0150(0x0030)
	struct FDiffDynamicItemStates                      dynamic_item_states;                                      // 0x0180(0x0030)
	struct FDiffLandScapeDestroyStateInfo              landscape_destroy_info;                                   // 0x01B0(0x0030)
};
...
{
	TArray<struct FTeamScoreData>                      team_score_datas;                                         // 0x0014(0x000C) (ZeroConstructor)
};
...
{
	int                                                slot_index;                                               // 0x0014(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                item_id;                                                  // 0x0018(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                Count;                                                    // 0x001C(0x0004) (ZeroConstructor, IsPlainOldData)
	TArray<int>                                        attach_list;                                              // 0x0020(0x000C) (ZeroConstructor)
	unsigned char                                      UnknownData00[0x4];                                       // 0x002C(0x0004) MISSED OFFSET
};
...
{
	int                                                scheme_index;                                             // 0x0014(0x0004) (ZeroConstructor, IsPlainOldData)
	bool                                               is_locked;                                                // 0x0018(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x3];                                       // 0x0019(0x0003) MISSED OFFSET
	TArray<struct FAIGameModePlayerWeaponSchemeSlotInfo> slot_list;                                                // 0x001C(0x000C) (ZeroConstructor)
};
...
{
	TArray<struct FAIGameModePlayerWeaponSchemeInfo>   weapon_scheme_info_list;                                  // 0x0014(0x000C) (ZeroConstructor)
...
struct FAIStateInfoMPBase : public FUniqueStateInfo
{
	...
	struct FAIGameStateMPBase                          Game;                                                     // 0x0058(0x0020)
...
{
	struct FDiffGameScoreDatas                         team_score_datas;                                         // 0x0014(0x0018)
	unsigned char                                      UnknownData00[0x4];                                       // 0x002C(0x0004) MISSED OFFSET
};
...
{
	struct FAIPlayerStateMPBase                        State;                                                    // 0x0020(0x0038)
	struct FDiffAIGameStateMPBaseGeneral               Game;                                                     // 0x0058(0x0030)
	struct FDeathMatchAIPlayerEquipment                deathmatch_backpack;                                      // 0x0088(0x0028)
};
...
{
	struct FDeathMatchAIPlayerEquipment                deathmatch_backpack;                                      // 0x0020(0x0028)
};
...
{
	struct FAIHeardSound                               Sound;                                                    // 0x0020(0x000C)
	unsigned char                                      UnknownData00[0x4];                                       // 0x002C(0x0004) MISSED OFFSET
	struct FAIDamageSources                            damage_sources;                                           // 0x0030(0x0038)
	struct FProgressBarState                           progress_bar;                                             // 0x0068(0x0020)
	struct FAIPlayerHitInfo                            player_hit_info;                                          // 0x0088(0x0028)
	struct FAIStateConfig                              Config;                                                   // 0x00B0(0x0020)
	struct FDamageRateInfo                             damage_rate_info;                                         // 0x00D0(0x0030)
	TArray<struct FAIDestroyBulletProbInfo>            destroy_bullet_prob_info;                                 // 0x0100(0x000C) (ZeroConstructor)
	unsigned char                                      UnknownData01[0x4];                                       // 0x010C(0x0004) MISSED OFFSET
	struct FAIBulletHoles                              bullet_holes;                                             // 0x0110(0x0030)
	TArray<struct FDamageSource>                       all_damage_source;                                        // 0x0140(0x000C) (ZeroConstructor)
	TArray<struct FAIBulletHole>                       all_bullet_hole;                                          // 0x014C(0x000C) (ZeroConstructor)
};
...
{
	TMap<uint32_t, struct FMLAIStateInfoBaseMod>       AllAIStateInfo;                                           // 0x0014(0x0050) (ZeroConstructor)
	TMap<uint32_t, struct FDiffMLAIStateInfoBaseModGeneral> AllDiffAIStateInfo;                                       // 0x0050(0x0050) (ZeroConstructor)
	TMap<uint32_t, struct FMLAIStateInfoBaseMod>       DebugAllAIStateInfo;                                      // 0x008C(0x0050) (ZeroConstructor)
};
...
struct FDiffMLAIStateInfoBaseMod : public FUniqueStateInfo
{
	struct FAIHeardSound                               Sound;                                                    // 0x0020(0x000C)
	unsigned char                                      UnknownData00[0x4];                                       // 0x002C(0x0004) MISSED OFFSET
	struct FDiffProgressBarState                       progress_bar;                                             // 0x0030(0x0020)
	struct FAIPlayerHitInfo                            player_hit_info;                                          // 0x0050(0x0028)
	struct FDiffAIConfig                               Config;                                                   // 0x0078(0x0020)
	TArray<struct FDamageSource>                       all_damage_source;                                        // 0x0098(0x000C) (ZeroConstructor)
	TArray<struct FAIBulletHole>                       all_bullet_hole;                                          // 0x00A4(0x000C) (ZeroConstructor)
};
...
{
	TMap<uint32_t, struct FDiffMLAIStateInfoBaseMod>   diff_states;                                              // 0x0014(0x0050) (ZeroConstructor)
	TMap<uint32_t, struct FMLAIStateInfoBaseMod>       State;                                                    // 0x0050(0x0050) (ZeroConstructor)
...
{
	struct FAIPlayerStateBaseMod                       State;                                                    // 0x0020(0x0110)
	struct FAIPlayerInteractInfo                       player_interact_info;                                     // 0x0130(0x0048)
	struct FCameraState                                Camera;                                                   // 0x0178(0x0038)
	struct FAIPlayerWeapon                             Weapon;                                                   // 0x01B0(0x000C)
	struct FAIPlayerBackpack                           BackPack;                                                 // 0x01BC(0x000C)
	struct FAIPlayerEquipment                          equipment;                                                // 0x01C8(0x000C)
	uint32_t                                           Key;                                                      // 0x01D4(0x0004) (ZeroConstructor, IsPlainOldData)
	uint32_t                                           ai_style;                                                 // 0x01D8(0x0004) (ZeroConstructor, IsPlainOldData)
	TArray<struct FChatMsgInfo>                        chatmsg_info_list;                                        // 0x01DC(0x000C) (ZeroConstructor)
	TArray<struct FSignMsgInfo>                        signmsg_info_list;                                        // 0x01E8(0x000C) (ZeroConstructor)
	TArray<struct FMapMarkInfo>                        mapmark_info_list;                                        // 0x01F4(0x000C) (ZeroConstructor)
	TArray<struct FAIAvatarInfo>                       avatar_info;                                              // 0x0200(0x000C) (ZeroConstructor)
	unsigned char                                      UnknownData00[0x4];                                       // 0x020C(0x0004) MISSED OFFSET
};

// ScriptStruct AI.DiffAIBaseStateInfoGeneral
// 0x02C0 (0x02E0 - 0x0020)
struct FDiffAIBaseStateInfoGeneral : public FDiffUniqueStateInfo
{
	struct FDiffAIPlayerStateBaseModGeneral            State;                                                    // 0x0020(0x0130)
	struct FAIPlayerInteractInfo                       player_interact_info;                                     // 0x0150(0x0048)
	struct FCameraState                                Camera;                                                   // 0x0198(0x0038)
	struct FDiffAIPlayerWeaponGeneral                  Weapon;                                                   // 0x01D0(0x0048)
	struct FDiffAIPlayerBackpackGeneral                BackPack;                                                 // 0x0218(0x0048)
	struct FDiffAIPlayerEquipmentGeneral               equipment;                                                // 0x0260(0x0048)
	uint32_t                                           Key;                                                      // 0x02A8(0x0004) (ZeroConstructor, IsPlainOldData)
	uint32_t                                           ai_style;                                                 // 0x02AC(0x0004) (ZeroConstructor, IsPlainOldData)
	TArray<struct FChatMsgInfo>                        chatmsg_info_list;                                        // 0x02B0(0x000C) (ZeroConstructor)
	TArray<struct FSignMsgInfo>                        signmsg_info_list;                                        // 0x02BC(0x000C) (ZeroConstructor)
	TArray<struct FMapMarkInfo>                        mapmark_info_list;                                        // 0x02C8(0x000C) (ZeroConstructor)
	TArray<struct FAIAvatarInfo>                       avatar_info;                                              // 0x02D4(0x000C) (ZeroConstructor)
};
...
{
	uint32_t                                           Key;                                                      // 0x0014(0x0004) (ZeroConstructor, IsPlainOldData)
	TMap<uint32_t, struct FAIBaseStateInfo>            AllAIStateInfo;                                           // 0x0018(0x0050) (ZeroConstructor)
	TMap<uint32_t, struct FDiffAIBaseStateInfoGeneral> AllDiffAIStateInfo;                                       // 0x0054(0x0050) (ZeroConstructor)
	TMap<uint32_t, struct FAIBaseStateInfo>            DebugAllAIStateInfo;                                      // 0x0090(0x0050) (ZeroConstructor)
	TArray<uint64_t>                                   del_item_id;                                              // 0x00CC(0x000C) (ZeroConstructor)
};
...
struct FDiffAIBaseStateInfo : public FDiffStateInfoBase
{
	...
	struct FDiffAIPlayerEquipment                      equipment;                                                // 0x01A8(0x0030)
	uint32_t                                           Key;                                                      // 0x01D8(0x0004) (ZeroConstructor, IsPlainOldData)
	uint32_t                                           ai_style;                                                 // 0x01DC(0x0004) (ZeroConstructor, IsPlainOldData)
	struct FAIPlayerInteractInfo                       player_interact_info;                                     // 0x01E0(0x0048)
};
...
{
	bool                                               is_over;                                                  // 0x0014(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x3];                                       // 0x0015(0x0003) MISSED OFFSET
	int                                                alive_player_count;                                       // 0x0018(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                Stage;                                                    // 0x001C(0x0004) (ZeroConstructor, IsPlainOldData)
	uint32_t                                           mode_map;                                                 // 0x0020(0x0004) (ZeroConstructor, IsPlainOldData)
	uint32_t                                           mode_type;                                                // 0x0024(0x0004) (ZeroConstructor, IsPlainOldData)
	struct FString                                     game_ds_version;                                          // 0x0028(0x000C) (ZeroConstructor)
	int                                                zone_id;                                                  // 0x0034(0x0004) (ZeroConstructor, IsPlainOldData)
	uint64_t                                           left_time;                                                // 0x0038(0x0008) (ZeroConstructor, IsPlainOldData)
	uint64_t                                           stage_time;                                               // 0x0040(0x0008) (ZeroConstructor, IsPlainOldData)
	int                                                can_jump_sky;                                             // 0x0048(0x0004) (ZeroConstructor, IsPlainOldData)
...
struct FBattleVoiceRoomInfo : public FUniqueStateInfo
{
	...
	struct FString                                     battle_voice_room_id;                                     // 0x0024(0x000C) (ZeroConstructor)
};
...
{
	struct FAIGameStateBaseMod                         Game;                                                     // 0x0018(0x0050)
	TArray<struct FBattleVoiceRoomInfo>                voice_room_list;                                          // 0x0068(0x000C) (ZeroConstructor)
...
{
	struct FDiffStateInfoBool                          is_over;                                                  // 0x0014(0x0001)
	unsigned char                                      UnknownData00[0x3];                                       // 0x0015(0x0003) MISSED OFFSET
	struct FDiffStateInfoInt32                         alive_player_count;                                       // 0x0018(0x0004)
	struct FDiffStateInfoInt32                         Stage;                                                    // 0x001C(0x0004)
	struct FDiffStateInfoUInt32                        mode_map;                                                 // 0x0020(0x0004)
	struct FDiffStateInfoUInt32                        mode_type;                                                // 0x0024(0x0004)
	struct FString                                     game_ds_version;                                          // 0x0028(0x000C) (ZeroConstructor)
	struct FDiffStateInfoInt32                         zone_id;                                                  // 0x0034(0x0004)
	struct FDiffStateInfoUInt64                        left_time;                                                // 0x0038(0x0008)
	struct FDiffStateInfoUInt64                        stage_time;                                               // 0x0040(0x0008)
	struct FDiffStateInfoInt32                         can_jump_sky;                                             // 0x0048(0x0004)
	unsigned char                                      UnknownData01[0x4];                                       // 0x004C(0x0004) MISSED OFFSET
};
...
{
	struct FDiffAIGameStateBaseMod                     Game;                                                     // 0x0018(0x0050)
};
...
{
	struct FAIPoolPlayerState                          State;                                                    // 0x0018(0x0018)
	uint32_t                                           Key;                                                      // 0x0030(0x0004) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x4];                                       // 0x0034(0x0004) MISSED OFFSET
};
...
{
	TMap<uint32_t, struct FDiffAIBaseStateInfo>        diff_states;                                              // 0x0014(0x0050) (ZeroConstructor)
	TMap<uint32_t, struct FAIBaseStateInfo>            State;                                                    // 0x0050(0x0050) (ZeroConstructor)
	unsigned char                                      UnknownData00[0x4];                                       // 0x008C(0x0004) MISSED OFFSET
	struct FGlobalGameBaseState                        global_state;                                             // 0x0090(0x0078)
	struct FDiffGlobalGameBaseState                    diff_global_state;                                        // 0x0108(0x0068)
	TMap<uint32_t, struct FAIBaseStateInfo>            global_player_states;                                     // 0x0170(0x0050) (ZeroConstructor)
	TMap<uint32_t, struct FDiffAIBaseStateInfo>        global_player_diff_states;                                // 0x01AC(0x0050) (ZeroConstructor)
	TMap<uint32_t, struct FAIBaseStateInfo>            in_pool_states;                                           // 0x01E8(0x0050) (ZeroConstructor)
	TMap<uint32_t, struct FDiffAIPoolStateInfo>        in_pool_diff_states;                                      // 0x0224(0x0050) (ZeroConstructor)
	TMap<uint32_t, struct FAIBaseStateInfo>            near_player_states;                                       // 0x0260(0x0050) (ZeroConstructor)
	TMap<uint32_t, struct FDiffAIBaseStateInfo>        near_player_diff_states;                                  // 0x029C(0x0050) (ZeroConstructor)
	TMap<uint32_t, struct FAIBaseStateInfo>            global_btai_states;                                       // 0x02D8(0x0050) (ZeroConstructor)
	TMap<uint32_t, struct FDiffAIBaseStateInfo>        global_btai_diff_states;                                  // 0x0314(0x0050) (ZeroConstructor)
};
...
{
	TArray<struct FBattleVoiceRoomInfo>                Values;                                                   // 0x0014(0x000C) (ZeroConstructor)
	TArray<uint64_t>                                   del_item_id;                                              // 0x0020(0x000C) (ZeroConstructor)
	unsigned char                                      UnknownData00[0x4];                                       // 0x002C(0x0004) MISSED OFFSET
};
...
{
	struct FDiffAIGameStateBaseModGeneral              Game;                                                     // 0x0018(0x0050)
	struct FDiffBattleVoiceRoomInfoListGeneral         voice_room_list;                                          // 0x0068(0x0030)
};
...
struct FAIPlayerBRBaseState : public FAIStateInfoBase
{
	...
	int                                                revival_count;                                            // 0x0020(0x0004) (ZeroConstructor, IsPlainOldData)
	bool                                               can_self_revival;                                         // 0x0024(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x3];                                       // 0x0025(0x0003) MISSED OFFSET
...
struct FAIBRBaseStateInfo : public FUniqueStateInfo
{
	...
	TArray<struct FAIRecipients>                       recipients;                                               // 0x0084(0x000C) (ZeroConstructor)
};
...
{
	TMap<uint32_t, struct FAIBRBaseStateInfo>          AllAIStateInfo;                                           // 0x0014(0x0050) (ZeroConstructor)
	TMap<uint32_t, struct FAIBRBaseStateInfo>          AllDiffAIStateInfo;                                       // 0x0050(0x0050) (ZeroConstructor)
	TMap<uint32_t, struct FAIBRBaseStateInfo>          DebugAllAIStateInfo;                                      // 0x008C(0x0050) (ZeroConstructor)
};
...
struct FDiffAIPlayerBRBaseState : public FAIStateInfoBase
{
	...
	struct FDiffStateInfoUInt32                        plane_id;                                                 // 0x002C(0x0004)
	struct FDiffStateInfoUInt32                        parachute_state;                                          // 0x0030(0x0004)
	struct FDiffStateInfoBool                          can_parachute_jump;                                       // 0x0034(0x0001)
	unsigned char                                      UnknownData02[0x3];                                       // 0x0035(0x0003) MISSED OFFSET
	struct FDiffStateInfoUInt32                        follow_state;                                             // 0x0038(0x0004)
	struct FDiffStateInfoUInt32                        leader_id;                                                // 0x003C(0x0004)
	struct FDiffStateInfoUInt32                        parachute_type;                                           // 0x0040(0x0004)
	struct FDiffStateInfoVector                        target_position;                                          // 0x0044(0x000C)
};
...
{
	struct FDiffAIPlayerBRBaseState                    State;                                                    // 0x0018(0x0050)
	TArray<struct FAIRecipients>                       recipients;                                               // 0x0068(0x000C) (ZeroConstructor)
	unsigned char                                      UnknownData00[0x4];                                       // 0x0074(0x0004) MISSED OFFSET
};
...
struct FRedZoneState : public FAIStateInfoBase
{
	...
	float                                              remain_time;                                              // 0x0024(0x0004) (ZeroConstructor, IsPlainOldData)
	float                                              start_time;                                               // 0x0028(0x0004) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x4];                                       // 0x002C(0x0004) MISSED OFFSET
};
...
{
	int                                                State;                                                    // 0x0014(0x0004) (ZeroConstructor, IsPlainOldData)
	struct FAIStateXYZ                                 Center;                                                   // 0x0018(0x000C)
	float                                              Radius;                                                   // 0x0024(0x0004) (ZeroConstructor, IsPlainOldData)
	struct FAIStateXYZ                                 next_center;                                              // 0x0028(0x000C)
	float                                              next_radius;                                              // 0x0034(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                Time;                                                     // 0x0038(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                total_time;                                               // 0x003C(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                circle_index;                                             // 0x0040(0x0004) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x4];                                       // 0x0044(0x0004) MISSED OFFSET
};
...
{
	struct FAIStateXYZ                                 start_loc;                                                // 0x0014(0x000C)
	struct FAIStateXYZ                                 end_loc;                                                  // 0x0020(0x000C)
	struct FAIStateXYZ                                 can_jump_loc;                                             // 0x002C(0x000C)
	struct FAIStateXYZ                                 force_jump_loc;                                           // 0x0038(0x000C)
	int                                                player_num;                                               // 0x0044(0x0004) (ZeroConstructor, IsPlainOldData)
};
...
struct FPlaneInfo : public FUniqueStateInfo
{
	...
	struct FAIStateXYZ                                 Position;                                                 // 0x0028(0x000C)
	unsigned char                                      UnknownData00[0x4];                                       // 0x0034(0x0004) MISSED OFFSET
	struct FFlightInfo                                 flight_info;                                              // 0x0038(0x0048)
};
...
{
	int                                                airdrop_tag;                                              // 0x0014(0x0004) (ZeroConstructor, IsPlainOldData)
};
...
{
	TArray<struct FAirDropBoxState>                    air_drop_box_states;                                      // 0x0014(0x000C) (ZeroConstructor)
	TArray<struct FSpecialZoneState>                   special_zones;                                            // 0x0020(0x000C) (ZeroConstructor)
	unsigned char                                      UnknownData00[0x4];                                       // 0x002C(0x0004) MISSED OFFSET
	struct FRedZoneState                               red_zone;                                                 // 0x0030(0x0030)
	struct FSafetyAreaState                            safety_area;                                              // 0x0060(0x0048)
	TArray<struct FPlaneInfo>                          airplane_list;                                            // 0x00A8(0x000C) (ZeroConstructor)
	unsigned char                                      UnknownData01[0x4];                                       // 0x00B4(0x0004) MISSED OFFSET
	struct FGlobalControlInfo                          control_info;                                             // 0x00B8(0x0018)
	unsigned char                                      UnknownData02[0x4];                                       // 0x00D0(0x0004) MISSED OFFSET
	TArray<uint32_t>                                   silent_list;                                              // 0x00D4(0x000C) (ZeroConstructor)
};
...
{
	TArray<struct FDiffAirDropBoxState>                States;                                                   // 0x0014(0x000C) (ZeroConstructor)
	TArray<uint32_t>                                   item_state;                                               // 0x0020(0x000C) (ZeroConstructor)
	unsigned char                                      UnknownData00[0x4];                                       // 0x002C(0x0004) MISSED OFFSET
};
...
struct FDiffSpecialZoneState : public FDiffStateInfoBase
{
	...
	struct FDiffStateInfoUInt32                        Type;                                                     // 0x0028(0x0004)
	struct FDiffStateInfoVector                        Position;                                                 // 0x002C(0x000C)
	struct FDiffStateInfoVector                        Rotation;                                                 // 0x0038(0x000C)
	struct FDiffStateInfoInt32                         custom_state;                                             // 0x0044(0x0004)
	struct FDiffStateInfoVector                        Scale;                                                    // 0x0048(0x000C)
...
{
	TArray<struct FDiffSpecialZoneState>               State;                                                    // 0x0014(0x000C) (ZeroConstructor)
	TArray<uint32_t>                                   item_state;                                               // 0x0020(0x000C) (ZeroConstructor)
	unsigned char                                      UnknownData00[0x4];                                       // 0x002C(0x0004) MISSED OFFSET
};
...
struct FDiffRedZoneState : public FDiffStateInfoBase
{
	...
	struct FDiffStateInfoFloat                         remain_time;                                              // 0x0024(0x0004)
	struct FDiffStateInfoFloat                         start_time;                                               // 0x0028(0x0004)
	unsigned char                                      UnknownData00[0x4];                                       // 0x002C(0x0004) MISSED OFFSET
};
...
{
	struct FDiffStateInfoInt32                         State;                                                    // 0x0014(0x0004)
	struct FDiffStateInfoVector                        Center;                                                   // 0x0018(0x000C)
	struct FDiffStateInfoFloat                         Radius;                                                   // 0x0024(0x0004)
	struct FDiffStateInfoVector                        next_center;                                              // 0x0028(0x000C)
	struct FDiffStateInfoFloat                         next_radius;                                              // 0x0034(0x0004)
	struct FDiffStateInfoInt32                         Time;                                                     // 0x0038(0x0004)
	struct FDiffStateInfoInt32                         total_time;                                               // 0x003C(0x0004)
	struct FDiffStateInfoInt32                         circle_index;                                             // 0x0040(0x0004)
	unsigned char                                      UnknownData00[0x4];                                       // 0x0044(0x0004) MISSED OFFSET
};
...
{
	struct FDiffStateInfoVector                        start_loc;                                                // 0x0014(0x000C)
	struct FDiffStateInfoVector                        end_loc;                                                  // 0x0020(0x000C)
	struct FDiffStateInfoVector                        can_jump_loc;                                             // 0x002C(0x000C)
	struct FDiffStateInfoVector                        force_jump_loc;                                           // 0x0038(0x000C)
	struct FDiffStateInfoInt32                         player_num;                                               // 0x0044(0x0004)
};
...
{
	uint32_t                                           ID;                                                       // 0x0014(0x0004) (ZeroConstructor, IsPlainOldData)
	struct FDiffStateInfoUInt32                        Type;                                                     // 0x0018(0x0004)
	struct FDiffStateInfoVector                        Position;                                                 // 0x001C(0x000C)
	struct FDiffFlightInfo                             flight_info;                                              // 0x0028(0x0048)
};
...
{
	TArray<struct FDiffPlaneInfoState>                 States;                                                   // 0x0014(0x000C) (ZeroConstructor)
	TArray<uint32_t>                                   item_state;                                               // 0x0020(0x000C) (ZeroConstructor)
	unsigned char                                      UnknownData00[0x4];                                       // 0x002C(0x0004) MISSED OFFSET
};
...
{
	struct FDiffAirDropBoxStates                       air_drop_box_states;                                      // 0x0018(0x0030)
	struct FDiffSpecialZone                            special_zones;                                            // 0x0048(0x0030)
	struct FDiffRedZoneState                           red_zone;                                                 // 0x0078(0x0030)
	struct FDiffSafetyAreaState                        safety_area;                                              // 0x00A8(0x0048)
	struct FDiffPlaneInfo                              airplane_list;                                            // 0x00F0(0x0030)
	TArray<uint32_t>                                   silent_list;                                              // 0x0120(0x000C) (ZeroConstructor)
...
{
	TMap<uint32_t, struct FDiffAIBRBaseStateInfo>      diff_states;                                              // 0x0014(0x0050) (ZeroConstructor)
	TMap<uint32_t, struct FAIBRBaseStateInfo>          State;                                                    // 0x0050(0x0050) (ZeroConstructor)
	unsigned char                                      UnknownData00[0x4];                                       // 0x008C(0x0004) MISSED OFFSET
	struct FGlobalGameBRBaseState                      global_state;                                             // 0x0090(0x00E0)
	struct FDiffGlobalGameBRBaseState                  diff_global_state;                                        // 0x0170(0x0130)
	TMap<uint32_t, struct FAIBRBaseStateInfo>          global_player_states;                                     // 0x02A0(0x0050) (ZeroConstructor)
	TMap<uint32_t, struct FDiffAIBRBaseStateInfo>      global_player_diff_states;                                // 0x02DC(0x0050) (ZeroConstructor)
	TMap<uint32_t, struct FAIBRBaseStateInfo>          near_player_states;                                       // 0x0318(0x0050) (ZeroConstructor)
	TMap<uint32_t, struct FDiffAIBRBaseStateInfo>      near_player_diff_states;                                  // 0x0354(0x0050) (ZeroConstructor)
	TMap<uint32_t, struct FAIBRBaseStateInfo>          global_btai_states;                                       // 0x0390(0x0050) (ZeroConstructor)
	TMap<uint32_t, struct FDiffAIBRBaseStateInfo>      global_btai_diff_states;                                  // 0x03CC(0x0050) (ZeroConstructor)
};
...
{
	TArray<struct FAirDropBoxState>                    Values;                                                   // 0x0014(0x000C) (ZeroConstructor)
	TArray<uint64_t>                                   del_item_id;                                              // 0x0020(0x000C) (ZeroConstructor)
	unsigned char                                      UnknownData00[0x4];                                       // 0x002C(0x0004) MISSED OFFSET
};
...
{
	TArray<struct FSpecialZoneState>                   Values;                                                   // 0x0014(0x000C) (ZeroConstructor)
	TArray<uint64_t>                                   del_item_id;                                              // 0x0020(0x000C) (ZeroConstructor)
	unsigned char                                      UnknownData00[0x4];                                       // 0x002C(0x0004) MISSED OFFSET
};
...
{
	TArray<struct FPlaneInfo>                          Values;                                                   // 0x0014(0x000C) (ZeroConstructor)
	TArray<uint64_t>                                   del_item_id;                                              // 0x0020(0x000C) (ZeroConstructor)
	unsigned char                                      UnknownData00[0x4];                                       // 0x002C(0x0004) MISSED OFFSET
};
...
{
	struct FDiffAirDropBoxStatesGeneral                air_drop_box_states;                                      // 0x0018(0x0030)
	struct FDiffSpecialZoneGeneral                     special_zones;                                            // 0x0048(0x0030)
	struct FRedZoneState                               red_zone;                                                 // 0x0078(0x0030)
	struct FSafetyAreaState                            safety_area;                                              // 0x00A8(0x0048)
	struct FDiffPlaneInfoGeneral                       airplane_list;                                            // 0x00F0(0x0030)
	struct FGlobalControlInfo                          control_info;                                             // 0x0120(0x0018)
	TArray<uint32_t>                                   silent_list;                                              // 0x0138(0x000C) (ZeroConstructor)
...
{
	TArray<struct FDynamicItem>                        dynamic_items;                                            // 0x0020(0x000C) (ZeroConstructor)
	TArray<uint64_t>                                   dynamic_items_index;                                      // 0x002C(0x000C) (ZeroConstructor)
};
...
{
	struct FDiffDynamicItemStatesGeneral               dynamic_items;                                            // 0x0020(0x0030)
	TArray<uint64_t>                                   dynamic_items_index;                                      // 0x0050(0x000C) (ZeroConstructor)
	unsigned char                                      UnknownData00[0x4];                                       // 0x005C(0x0004) MISSED OFFSET
};
...
{
	TMap<uint32_t, struct FAIDynamicItemStateInfo>     AllAIStateInfo;                                           // 0x0014(0x0050) (ZeroConstructor)
	TMap<uint32_t, struct FDiffAIDynamicItemStateInfoGeneral> AllDiffAIStateInfo;                                       // 0x0050(0x0050) (ZeroConstructor)
	TMap<uint32_t, struct FAIDynamicItemStateInfo>     DebugAllAIStateInfo;                                      // 0x008C(0x0050) (ZeroConstructor)
};
...
{
	struct FDiffDynamicItemStates                      dynamic_item_states;                                      // 0x0018(0x0030)
};
...
{
	TArray<struct FDynamicItem>                        dynamic_items;                                            // 0x0014(0x000C) (ZeroConstructor)
};
...
{
	struct FGlobalNearbyDynamicItemInfo                global_nearby_info;                                       // 0x0018(0x0020)
};
...
{
	struct FDiffGlobalNearbyDynamicItemInfo            global_nearby_info;                                       // 0x0018(0x0048)
};
...
{
	TMap<uint32_t, struct FDiffAIDynamicItemStateInfo> diff_states;                                              // 0x0014(0x0050) (ZeroConstructor)
	TMap<uint32_t, struct FAIDynamicItemStateInfo>     State;                                                    // 0x0050(0x0050) (ZeroConstructor)
	unsigned char                                      UnknownData00[0x4];                                       // 0x008C(0x0004) MISSED OFFSET
	struct FGlobalDynamicItemState                     global_state;                                             // 0x0090(0x0038)
	struct FDiffGlobalDynamicItemState                 diff_global_state;                                        // 0x00C8(0x0060)
};
...
{
	struct FDiffGlobalNearbyDynamicItemInfoGeneral     global_nearby_info;                                       // 0x0018(0x0048)
};
...
{
	TArray<struct FLandScapeDestroyState>              landscape_destroy_info;                                   // 0x0020(0x000C) (ZeroConstructor)
	unsigned char                                      UnknownData00[0x4];                                       // 0x002C(0x0004) MISSED OFFSET
};
...
{
	struct FDiffLandScapeDestroyStateInfo              landscape_destroy_info;                                   // 0x0018(0x0030)
};
...
{
	TMap<uint32_t, struct FDiffAILandScapeDestroyInfo> diff_states;                                              // 0x0014(0x0050) (ZeroConstructor)
	TMap<uint32_t, struct FAILandScapeDestroyInfo>     State;                                                    // 0x0050(0x0050) (ZeroConstructor)
	unsigned char                                      UnknownData00[0x4];                                       // 0x008C(0x0004) MISSED OFFSET
};
...
struct FLandScapeChange : public FUniqueStateInfo
{
	...
	TArray<uint16_t>                                   heights_data;                                             // 0x0038(0x000C) (ZeroConstructor)
	unsigned char                                      UnknownData00[0x4];                                       // 0x0044(0x0004) MISSED OFFSET
};
...
{
	uint32_t                                           ID;                                                       // 0x0020(0x0004) (ZeroConstructor, IsPlainOldData)
	TArray<struct FLandScapeChange>                    changes;                                                  // 0x0024(0x000C) (ZeroConstructor)
};
...
{
	TArray<struct FLandScapeChangeState>               landscape_change_info;                                    // 0x0014(0x000C) (ZeroConstructor)
};
...
{
	TArray<struct FLandScapeChangeState>               Values;                                                   // 0x0014(0x000C) (ZeroConstructor)
	TArray<uint64_t>                                   del_item_id;                                              // 0x0020(0x000C) (ZeroConstructor)
	unsigned char                                      UnknownData00[0x4];                                       // 0x002C(0x0004) MISSED OFFSET
};
...
{
	struct FDiffLandScapeChangeStateGeneral            landscape_change_info;                                    // 0x0018(0x0030)
};
...
{
	TArray<struct FDoorState>                          nearby_door;                                              // 0x0020(0x000C) (ZeroConstructor)
	TArray<uint64_t>                                   nearby_door_index;                                        // 0x002C(0x000C) (ZeroConstructor)
};
...
{
	struct FDiffDoorStateGeneral                       nearby_door;                                              // 0x0020(0x0030)
	TArray<uint64_t>                                   nearby_door_index;                                        // 0x0050(0x000C) (ZeroConstructor)
	unsigned char                                      UnknownData00[0x4];                                       // 0x005C(0x0004) MISSED OFFSET
};
...
{
	TMap<uint32_t, struct FAIDoorStateInfo>            AllAIStateInfo;                                           // 0x0014(0x0050) (ZeroConstructor)
	TMap<uint32_t, struct FDiffAIDoorStateInfoGeneral> AllDiffAIStateInfo;                                       // 0x0050(0x0050) (ZeroConstructor)
	TMap<uint32_t, struct FAIDoorStateInfo>            DebugAllAIStateInfo;                                      // 0x008C(0x0050) (ZeroConstructor)
};
...
{
	TArray<struct FDoorState>                          nearby_door;                                              // 0x0014(0x000C) (ZeroConstructor)
};
...
{
	struct FGlobalNearbyDoorInfo                       global_nearby_info;                                       // 0x0018(0x0020)
};
...
{
	struct FDiffGlobalNearbyDoorInfo                   global_nearby_info;                                       // 0x0018(0x0048)
};
...
{
	TMap<uint32_t, struct FAIDoorStateInfo>            diff_states;                                              // 0x0014(0x0050) (ZeroConstructor)
	TMap<uint32_t, struct FAIDoorStateInfo>            State;                                                    // 0x0050(0x0050) (ZeroConstructor)
	unsigned char                                      UnknownData00[0x4];                                       // 0x008C(0x0004) MISSED OFFSET
	struct FGlobalDoorState                            global_state;                                             // 0x0090(0x0038)
	struct FDiffGlobalDoorState                        diff_global_state;                                        // 0x00C8(0x0060)
};
...
{
	struct FDiffGlobalNearbyDoorStateGeneral           global_nearby_info;                                       // 0x0018(0x0048)
};
...
{
	TArray<struct FMonsterState>                       monster_states;                                           // 0x0020(0x000C) (ZeroConstructor)
	TArray<uint64_t>                                   monster_states_index;                                     // 0x002C(0x000C) (ZeroConstructor)
};
...
{
	struct FDiffMonsterStatesGeneral                   monster_states;                                           // 0x0020(0x0030)
	TArray<uint64_t>                                   monster_states_index;                                     // 0x0050(0x000C) (ZeroConstructor)
	unsigned char                                      UnknownData00[0x4];                                       // 0x005C(0x0004) MISSED OFFSET
};
...
{
	TMap<uint32_t, struct FAINearbyMonsterStateInfo>   AllAIStateInfo;                                           // 0x0014(0x0050) (ZeroConstructor)
	TMap<uint32_t, struct FDiffAINearbyMonsterStateInfoGeneral> AllDiffAIStateInfo;                                       // 0x0050(0x0050) (ZeroConstructor)
	TMap<uint32_t, struct FAINearbyMonsterStateInfo>   DebugAllAIStateInfo;                                      // 0x008C(0x0050) (ZeroConstructor)
};
...
{
	struct FDiffMonsterStates                          monster_states;                                           // 0x0018(0x0030)
};
...
{
	TArray<struct FMonsterState>                       monster_states;                                           // 0x0014(0x000C) (ZeroConstructor)
};
...
{
	struct FGlobalNearbyMonsterInfo                    global_nearby_info;                                       // 0x0018(0x0020)
};
...
{
	struct FDiffGlobalNearbyMonsterInfo                global_nearby_info;                                       // 0x0018(0x0048)
};
...
{
	TMap<uint32_t, struct FDiffAINearbyMonsterStateInfo> diff_states;                                              // 0x0014(0x0050) (ZeroConstructor)
	TMap<uint32_t, struct FAINearbyMonsterStateInfo>   State;                                                    // 0x0050(0x0050) (ZeroConstructor)
	unsigned char                                      UnknownData00[0x4];                                       // 0x008C(0x0004) MISSED OFFSET
	struct FGlobalMonsterState                         global_state;                                             // 0x0090(0x0038)
	struct FDiffGlobalMonsterState                     diff_global_state;                                        // 0x00C8(0x0060)
};
...
{
	struct FDiffGlobalNearbyMonsterInfoGeneral         global_nearby_info;                                       // 0x0018(0x0048)
};
...
{
	TArray<struct FAINearbyPlayerBaseMod>              nearby_player;                                            // 0x0020(0x000C) (ZeroConstructor)
	unsigned char                                      UnknownData00[0x4];                                       // 0x002C(0x0004) MISSED OFFSET
};
...
{
	struct FDiffAINearbyPlayersBaseModGeneral          nearby_player;                                            // 0x0020(0x0060)
};
...
{
	TMap<uint32_t, struct FAINearbyPlayerStateInfo>    AllAIStateInfo;                                           // 0x0014(0x0050) (ZeroConstructor)
	TMap<uint32_t, struct FDiffAINearbyPlayerStateInfoGeneral> AllDiffAIStateInfo;                                       // 0x0050(0x0050) (ZeroConstructor)
	TMap<uint32_t, struct FAINearbyPlayerStateInfo>    DebugAllAIStateInfo;                                      // 0x008C(0x0050) (ZeroConstructor)
};
...
{
	struct FDiffAINearbyPlayersBaseMod                 nearby_player;                                            // 0x0020(0x0030)
};
...
{
	TMap<uint32_t, struct FDiffAINearbyPlayerStateInfo> diff_states;                                              // 0x0014(0x0050) (ZeroConstructor)
	TMap<uint32_t, struct FAINearbyPlayerStateInfo>    State;                                                    // 0x0050(0x0050) (ZeroConstructor)
	unsigned char                                      UnknownData00[0x4];                                       // 0x008C(0x0004) MISSED OFFSET
};
...
{
	TArray<struct FItemStateData>                      nearby_item;                                              // 0x0020(0x000C) (ZeroConstructor)
	TArray<uint64_t>                                   nearby_item_index;                                        // 0x002C(0x000C) (ZeroConstructor)
	unsigned char                                      UnknownData00[0x1C];                                      // 0x0038(0x001C) MISSED OFFSET
	TArray<struct FAINearbyThrown>                     nearby_thrown;                                            // 0x0054(0x000C) (ZeroConstructor)
	TArray<uint64_t>                                   nearby_thrown_index;                                      // 0x0060(0x000C) (ZeroConstructor)
...
{
	struct FDiffItemStateDatasGeneral                  nearby_item;                                              // 0x0020(0x0030)
	TArray<uint64_t>                                   nearby_item_index;                                        // 0x0050(0x000C) (ZeroConstructor)
	unsigned char                                      UnknownData00[0x4];                                       // 0x005C(0x0004) MISSED OFFSET
	struct FDiffAINearbyThrownGeneral                  nearby_thrown;                                            // 0x0060(0x0030)
	TArray<uint64_t>                                   nearby_thrown_index;                                      // 0x0090(0x000C) (ZeroConstructor)
...
{
	TMap<uint32_t, struct FMLAINearbyStateInfoBaseMod> AllAIStateInfo;                                           // 0x0014(0x0050) (ZeroConstructor)
	TMap<uint32_t, struct FDiffMLAINearbyStateInfoBaseModGeneral> AllDiffAIStateInfo;                                       // 0x0050(0x0050) (ZeroConstructor)
	TMap<uint32_t, struct FMLAINearbyStateInfoBaseMod> DebugAllAIStateInfo;                                      // 0x008C(0x0050) (ZeroConstructor)
};
...
{
	struct FDiffItemStateDatas                         nearby_item;                                              // 0x0020(0x0030)
	TArray<uint64_t>                                   nearby_item_index;                                        // 0x0050(0x000C) (ZeroConstructor)
	TArray<struct FAINearbyThrown>                     nearby_thrown;                                            // 0x005C(0x000C) (ZeroConstructor)
	TArray<uint64_t>                                   nearby_thrown_index;                                      // 0x0068(0x000C) (ZeroConstructor)
	TArray<struct FItemStateData>                      nearby_box_item;                                          // 0x0074(0x000C) (ZeroConstructor)
};
...
{
	TArray<struct FItemStateData>                      nearby_item;                                              // 0x0014(0x000C) (ZeroConstructor)
	TArray<struct FAINearbyThrown>                     nearby_thrown;                                            // 0x0020(0x000C) (ZeroConstructor)
	unsigned char                                      UnknownData00[0x4];                                       // 0x002C(0x0004) MISSED OFFSET
};
...
{
	struct FGlobalNearbyInfoBaseMod                    global_nearby_info;                                       // 0x0018(0x0030)
};
...
{
	struct FDiffGlobalNearbyInfoBaseMod                global_nearby_info;                                       // 0x0018(0x0058)
};
...
{
	TMap<uint32_t, struct FDiffMLAINearbyStateInfoBaseMod> diff_states;                                              // 0x0014(0x0050) (ZeroConstructor)
	TMap<uint32_t, struct FMLAINearbyStateInfoBaseMod> State;                                                    // 0x0050(0x0050) (ZeroConstructor)
	unsigned char                                      UnknownData00[0x4];                                       // 0x008C(0x0004) MISSED OFFSET
	struct FGlobalNearbyStateBaseMod                   global_state;                                             // 0x0090(0x0048)
	struct FDiffGlobalNearbyStateBaseMod               diff_global_state;                                        // 0x00D8(0x0070)
};
...
struct FDiffGlobalNearbyInfoBaseModGeneral : public FAIStateInfoBase
{
	...
	struct FDiffAINearbyThrownGeneral                  nearby_thrown;                                            // 0x0048(0x0030)
};
...
{
	struct FDiffGlobalNearbyInfoBaseModGeneral         global_nearby_info;                                       // 0x0018(0x0078)
};
...
struct FBulletHoleRecordInfo : public FBulletHole
{
	...
	uint32_t                                           ShooterId;                                                // 0x001C(0x0004) (ZeroConstructor, IsPlainOldData)
};
...
{
	TArray<struct FDoorState>                          nearby_door;                                              // 0x0014(0x000C) (ZeroConstructor)
	TArray<struct FVehicleState>                       nearby_vehicles;                                          // 0x0020(0x000C) (ZeroConstructor)
	TArray<struct FDynamicItem>                        dynamic_items;                                            // 0x002C(0x000C) (ZeroConstructor)
	TArray<struct FMonsterState>                       monster_states;                                           // 0x0038(0x000C) (ZeroConstructor)
	unsigned char                                      UnknownData00[0x4];                                       // 0x0044(0x0004) MISSED OFFSET
};
...
struct FGlobalGameStateBRBase : public FAIStateInfoBase
{
	...
	TArray<struct FPlaneInfo>                          airplane_list;                                            // 0x00A8(0x000C) (ZeroConstructor)
	unsigned char                                      UnknownData01[0x4];                                       // 0x00B4(0x0004) MISSED OFFSET
	struct FGlobalNearbyInfoBRBase                     global_nearby_info;                                       // 0x00B8(0x0048)
	struct FGlobalControlInfo                          control_info;                                             // 0x0100(0x0018)
	unsigned char                                      UnknownData02[0x4];                                       // 0x0118(0x0004) MISSED OFFSET
	TArray<struct FAIStateXYZ>                         vehicle_spot_position;                                    // 0x011C(0x000C) (ZeroConstructor)
	TArray<struct FLandScapeChangeState>               landscape_change_info;                                    // 0x0128(0x000C) (ZeroConstructor)
	TArray<uint32_t>                                   silent_list;                                              // 0x0134(0x000C) (ZeroConstructor)
};
...
{
	struct FAIGameStateBaseMod                         Game;                                                     // 0x0018(0x0050)
	struct FGlobalNearbyInfoBaseMod                    global_nearby_info;                                       // 0x0068(0x0030)
	TArray<struct FBattleVoiceRoomInfo>                voice_room_list;                                          // 0x0098(0x000C) (ZeroConstructor)
...
{
	struct FDiffAIGameStateBaseModGeneral              Game;                                                     // 0x0018(0x0050)
	struct FDiffGlobalNearbyInfoBaseModGeneral         global_nearby_info;                                       // 0x0068(0x0078)
	struct FDiffBattleVoiceRoomInfoListGeneral         voice_room_list;                                          // 0x00E0(0x0030)
};
...
{
	uint32_t                                           Key;                                                      // 0x0014(0x0004) (ZeroConstructor, IsPlainOldData)
	TArray<struct FAIStateInfoBaseMod>                 AllAIStateInfo;                                           // 0x0018(0x000C) (ZeroConstructor)
	TMap<uint32_t, struct FDiffAIStateInfoBaseModGeneral> AllDiffAIStateInfo;                                       // 0x0024(0x0050) (ZeroConstructor)
	TArray<struct FAIStateInfoBaseMod>                 DebugAllAIStateInfo;                                      // 0x0060(0x000C) (ZeroConstructor)
	TArray<uint64_t>                                   del_item_id;                                              // 0x006C(0x000C) (ZeroConstructor)
};
...
{
	TArray<struct FDiffAIStateInfoBaseMod>             diff_states;                                              // 0x0014(0x000C) (ZeroConstructor)
	TArray<struct FAIStateInfoBaseMod>                 State;                                                    // 0x0020(0x000C) (ZeroConstructor)
	unsigned char                                      UnknownData00[0x4];                                       // 0x002C(0x0004) MISSED OFFSET
	struct FGlobalGameStateBaseMod                     global_state;                                             // 0x0030(0x00A8)
	struct FDiffGlobalGameStateBaseMod                 diff_global_state;                                        // 0x00D8(0x0068)
	TArray<struct FAIStateInfoBaseMod>                 global_player_states;                                     // 0x0140(0x000C) (ZeroConstructor)
	TArray<struct FDiffBTAIAndPlayerStateInfoBaseMod>  global_player_diff_states;                                // 0x014C(0x000C) (ZeroConstructor)
	...
	TArray<struct FDiffBTAIAndPlayerStateInfoBaseMod>  near_player_diff_states;                                  // 0x017C(0x000C) (ZeroConstructor)
	TArray<struct FAIStateInfoBaseMod>                 global_btai_states;                                       // 0x0188(0x000C) (ZeroConstructor)
	TArray<struct FDiffBTAIAndPlayerStateInfoBaseMod>  global_btai_diff_states;                                  // 0x0194(0x000C) (ZeroConstructor)
};
...
{
	struct FDiffDoorStateGeneral                       nearby_door;                                              // 0x0018(0x0030)
	struct FDiffVehicleStatesGeneral                   nearby_vehicles;                                          // 0x0048(0x0030)
	struct FDiffDynamicItemStatesGeneral               dynamic_items;                                            // 0x0078(0x0030)
	struct FDiffMonsterStatesGeneral                   monster_states;                                           // 0x00A8(0x0030)
};
...
struct FDiffGlobalGameStateBRBaseGeneral : public FAIStateInfoBase
{
	...
	struct FSafetyAreaState                            safety_area;                                              // 0x00A8(0x0048)
	struct FDiffPlaneInfoGeneral                       airplane_list;                                            // 0x00F0(0x0030)
	struct FDiffGlobalNearbyInfoBRBaseGeneral          global_nearby_info;                                       // 0x0120(0x00D8)
	struct FGlobalControlInfo                          control_info;                                             // 0x01F8(0x0018)
	TArray<struct FAIStateXYZ>                         vehicle_spot_position;                                    // 0x0210(0x000C) (ZeroConstructor)
	unsigned char                                      UnknownData00[0x4];                                       // 0x021C(0x0004) MISSED OFFSET
	struct FDiffLandScapeChangeStateGeneral            landscape_change_info;                                    // 0x0220(0x0030)
	TArray<uint32_t>                                   silent_list;                                              // 0x0250(0x000C) (ZeroConstructor)
...
{
	TArray<struct FAIStateInfoBRBase>                  AllAIStateInfo;                                           // 0x0014(0x000C) (ZeroConstructor)
	TMap<uint32_t, struct FDiffAIStateInfoBRBaseGeneral> AllDiffAIStateInfo;                                       // 0x0020(0x0050) (ZeroConstructor)
	TArray<struct FAIStateInfoBRBase>                  DebugAllAIStateInfo;                                      // 0x005C(0x000C) (ZeroConstructor)
	TArray<uint64_t>                                   del_item_id;                                              // 0x0068(0x000C) (ZeroConstructor)
	unsigned char                                      UnknownData00[0x4];                                       // 0x0074(0x0004) MISSED OFFSET
};
...
{
	TArray<struct FDiffAIStateInfoBRBase>              diff_states;                                              // 0x0014(0x000C) (ZeroConstructor)
	TArray<struct FAIStateInfoBRBase>                  State;                                                    // 0x0020(0x000C) (ZeroConstructor)
	unsigned char                                      UnknownData00[0x4];                                       // 0x002C(0x0004) MISSED OFFSET
	struct FGlobalGameStateBRBase                      global_state;                                             // 0x0030(0x0140)
	struct FDiffGlobalGameStateBRBase                  diff_global_state;                                        // 0x0170(0x0130)
	TArray<struct FAIStateInfoBRBase>                  global_player_states;                                     // 0x02A0(0x000C) (ZeroConstructor)
	TArray<struct FDiffBTAIAndPlayerStateInfoBRBase>   global_player_diff_states;                                // 0x02AC(0x000C) (ZeroConstructor)
	TArray<struct FAIStateInfoBRBase>                  near_player_states;                                       // 0x02B8(0x000C) (ZeroConstructor)
	TArray<struct FDiffBTAIAndPlayerStateInfoBRBase>   near_player_diff_states;                                  // 0x02C4(0x000C) (ZeroConstructor)
	TArray<struct FAIStateInfoBRBase>                  global_btai_states;                                       // 0x02D0(0x000C) (ZeroConstructor)
	TArray<struct FDiffBTAIAndPlayerStateInfoBRBase>   global_btai_diff_states;                                  // 0x02DC(0x000C) (ZeroConstructor)
};
...
{
	struct FAIGameStateMPBase                          Game;                                                     // 0x0018(0x0020)
};
...
{
	struct FDiffAIGameStateMPBaseGeneral               Game;                                                     // 0x0018(0x0030)
};
...
{
	TArray<struct FAIStateInfoMPBase>                  AllAIStateInfo;                                           // 0x0014(0x000C) (ZeroConstructor)
	TMap<uint32_t, struct FDiffAIStateInfoMPBaseGeneral> AllDiffAIStateInfo;                                       // 0x0020(0x0050) (ZeroConstructor)
	TArray<struct FAIStateInfoMPBase>                  DebugAllAIStateInfo;                                      // 0x005C(0x000C) (ZeroConstructor)
	TArray<uint64_t>                                   del_item_id;                                              // 0x0068(0x000C) (ZeroConstructor)
	unsigned char                                      UnknownData00[0x4];                                       // 0x0074(0x0004) MISSED OFFSET
};
...
{
	struct FAIPlayerStateMPBase                        State;                                                    // 0x0020(0x0038)
	struct FDeathMatchAIPlayerEquipment                deathmatch_backpack;                                      // 0x0058(0x0028)
};
...
{
	struct FAIPlayerMPState                            State;                                                    // 0x0020(0x0030)
	struct FDeathMatchAIPlayerEquipment                deathmatch_backpack;                                      // 0x0050(0x0028)
};
...
{
	TMap<uint32_t, struct FAIMPStateInfo>              AllAIStateInfo;                                           // 0x0014(0x0050) (ZeroConstructor)
	TMap<uint32_t, struct FDiffAIMPStateInfoGeneral>   AllDiffAIStateInfo;                                       // 0x0050(0x0050) (ZeroConstructor)
	TMap<uint32_t, struct FAIMPStateInfo>              DebugAllAIStateInfo;                                      // 0x008C(0x0050) (ZeroConstructor)
	TArray<uint64_t>                                   del_item_id;                                              // 0x00C8(0x000C) (ZeroConstructor)
...
{
	int                                                vehicle_role;                                             // 0x0014(0x0004) (ZeroConstructor, IsPlainOldData)
};
...
{
	struct FAIPlayerVehicleStateInfo                   State;                                                    // 0x0020(0x0018)
	struct FVehicleState                               vehicle_state;                                            // 0x0038(0x00C8)
	TArray<struct FVehicleState>                       nearby_vehicles;                                          // 0x0100(0x000C) (ZeroConstructor)
	TArray<uint64_t>                                   nearby_vehicles_index;                                    // 0x010C(0x000C) (ZeroConstructor)
};
...
struct FDiffAIVehicleStateInfoGeneral : public FUniqueStateInfo
{
	struct FAIPlayerVehicleStateInfo                   State;                                                    // 0x0020(0x0018)
	struct FVehicleState                               vehicle_state;                                            // 0x0038(0x00C8)
	struct FDiffVehicleStatesGeneral                   nearby_vehicles;                                          // 0x0100(0x0030)
	TArray<uint64_t>                                   nearby_vehicles_index;                                    // 0x0130(0x000C) (ZeroConstructor)
...
{
	TMap<uint32_t, struct FAIVehicleStateInfo>         AllAIStateInfo;                                           // 0x0014(0x0050) (ZeroConstructor)
	TMap<uint32_t, struct FDiffAIVehicleStateInfoGeneral> AllDiffAIStateInfo;                                       // 0x0050(0x0050) (ZeroConstructor)
	TMap<uint32_t, struct FAIVehicleStateInfo>         DebugAllAIStateInfo;                                      // 0x008C(0x0050) (ZeroConstructor)
};
...
{
	struct FDiffAIPlayerVehicleStateInfo               State;                                                    // 0x0020(0x0018)
	struct FDiffVehicleState                           vehicle_state;                                            // 0x0038(0x0090)
...
{
	TArray<struct FVehicleState>                       nearby_vehicles;                                          // 0x0014(0x000C) (ZeroConstructor)
};
...
{
	struct FGlobalNearbyVehicleInfo                    global_nearby_info;                                       // 0x0018(0x0020)
	TArray<struct FAIStateXYZ>                         vehicle_spot_position;                                    // 0x0038(0x000C) (ZeroConstructor)
	unsigned char                                      UnknownData00[0x4];                                       // 0x0044(0x0004) MISSED OFFSET
};
...
{
	struct FDiffVehicleStates                          nearby_vehicles;                                          // 0x0018(0x0030)
};
...
{
	struct FDiffGlobalNearbyVehicleState               global_nearby_info;                                       // 0x0018(0x0048)
};

// ScriptStruct AI.DiffAllPlayerVehicleInfo
// 0x0288 (0x02A0 - 0x0018)
struct FDiffAllPlayerVehicleInfo : public FAIStateInfoBase
{
	TMap<uint32_t, struct FDiffAIVehicleStateInfo>     diff_states;                                              // 0x0014(0x0050) (ZeroConstructor)
	TMap<uint32_t, struct FAIVehicleStateInfo>         State;                                                    // 0x0050(0x0050) (ZeroConstructor)
	unsigned char                                      UnknownData00[0x4];                                       // 0x008C(0x0004) MISSED OFFSET
	struct FGlobalVehicleState                         global_state;                                             // 0x0090(0x0048)
	struct FDiffGlobalVehicleState                     diff_global_state;                                        // 0x00D8(0x0060)
	TMap<uint32_t, struct FAIVehicleStateInfo>         global_player_states;                                     // 0x0138(0x0050) (ZeroConstructor)
	TMap<uint32_t, struct FDiffAIVehicleStateInfo>     global_player_diff_states;                                // 0x0174(0x0050) (ZeroConstructor)
	TMap<uint32_t, struct FAIVehicleStateInfo>         near_player_states;                                       // 0x01B0(0x0050) (ZeroConstructor)
	TMap<uint32_t, struct FDiffAIVehicleStateInfo>     near_player_diff_states;                                  // 0x01EC(0x0050) (ZeroConstructor)
	TMap<uint32_t, struct FAIVehicleStateInfo>         global_btai_states;                                       // 0x0228(0x0050) (ZeroConstructor)
	TMap<uint32_t, struct FDiffAIVehicleStateInfo>     global_btai_diff_states;                                  // 0x0264(0x0050) (ZeroConstructor)
};
...
{
	struct FDiffVehicleStatesGeneral                   nearby_vehicles;                                          // 0x0018(0x0030)
};
...
{
	struct FDiffGlobalNearbyVehicleStateGeneral        global_nearby_info;                                       // 0x0018(0x0048)
	TArray<struct FAIStateXYZ>                         vehicle_spot_position;                                    // 0x0060(0x000C) (ZeroConstructor)
...
{
	int                                                team_id;                                                  // 0x0014(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                player_id;                                                // 0x0018(0x0004) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x4];                                       // 0x001C(0x0004) MISSED OFFSET
};
...
struct FDiffCmd
{
	...
	class UProperty*                                   DelItemProperty;                                          // 0x000C(0x0004) (ZeroConstructor, IsPlainOldData)
	class UProperty*                                   UnChangedProperty;                                        // 0x0010(0x0004) (ZeroConstructor, IsPlainOldData)
	class UProperty*                                   DiffUnChangedProperty;                                    // 0x0014(0x0004) (ZeroConstructor, IsPlainOldData)
...
{
	struct FDiffStateInfoBool                          is_invincible;                                            // 0x0014(0x0001)
	struct FDiffStateInfoBool                          in_shoveling;                                             // 0x0015(0x0001)
	unsigned char                                      UnknownData00[0x2];                                       // 0x0016(0x0002) MISSED OFFSET
	struct FDiffStateInfoInt32                         death_count;                                              // 0x0018(0x0004)
	struct FDiffStateInfoFloat                         survive_time;                                             // 0x001C(0x0004)
	struct FDiffStateInfoFloat                         kd_ratio;                                                 // 0x0020(0x0004)
	struct FDiffStateInfoInt32                         continue_kill;                                            // 0x0024(0x0004)
	struct FDiffStateInfoInt32                         revenge;                                                  // 0x0028(0x0004)
	struct FDiffStateInfoInt32                         top_spot_end;                                             // 0x002C(0x0004)
};
...
{
	struct FDiffStateInfoInt32                         slot_index;                                               // 0x0014(0x0004)
	struct FDiffStateInfoInt32                         item_id;                                                  // 0x0018(0x0004)
	struct FDiffStateInfoInt32                         Count;                                                    // 0x001C(0x0004)
	TArray<int>                                        attach_list;                                              // 0x0020(0x000C) (ZeroConstructor)
	unsigned char                                      UnknownData00[0x4];                                       // 0x002C(0x0004) MISSED OFFSET
};
...
{
	TArray<struct FDiffAIGameModePlayerWeaponSchemeSlotInfo> slot_info;                                                // 0x0014(0x000C) (ZeroConstructor)
	TArray<uint32_t>                                   item_state;                                               // 0x0020(0x000C) (ZeroConstructor)
	unsigned char                                      UnknownData00[0x4];                                       // 0x002C(0x0004) MISSED OFFSET
};
...
{
	struct FDiffStateInfoInt32                         scheme_index;                                             // 0x0014(0x0004)
	struct FDiffStateInfoBool                          is_locked;                                                // 0x0018(0x0001)
	unsigned char                                      UnknownData00[0x7];                                       // 0x0019(0x0007) MISSED OFFSET
	struct FDiffAIGameModePlayerWeaponSchemeSlotInfoList slot_list;                                                // 0x0020(0x0030)
};
...
{
	TArray<struct FDiffAIGameModePlayerWeaponSchemeInfo> weapon_scheme_info;                                       // 0x0014(0x000C) (ZeroConstructor)
	TArray<uint32_t>                                   item_state;                                               // 0x0020(0x000C) (ZeroConstructor)
	unsigned char                                      UnknownData00[0x4];                                       // 0x002C(0x0004) MISSED OFFSET
};
...
{
	struct FDiffAIGameModePlayerWeaponSchemeInfoList   weapon_scheme_info_list;                                  // 0x0018(0x0030)
	struct FDiffStateInfoInt32                         cur_weapon_scheme_index;                                  // 0x0048(0x0004)
	unsigned char                                      UnknownData00[0x4];                                       // 0x004C(0x0004) MISSED OFFSET
};
...
{
	struct FDiffAIPlayerMPState                        State;                                                    // 0x0020(0x0030)
	struct FDiffDeathMatchAIPlayerEquipment            deathmatch_backpack;                                      // 0x0050(0x0050)
};
...
{
	TArray<struct FObstacleState>                      Values;                                                   // 0x0014(0x000C) (ZeroConstructor)
	TArray<uint64_t>                                   del_item_id;                                              // 0x0020(0x000C) (ZeroConstructor)
	unsigned char                                      UnknownData00[0x4];                                       // 0x002C(0x0004) MISSED OFFSET
};
