...
{
public:
	unsigned char                                      UnknownData00[0x10C];                                     // 0x001C(0x010C) MISSED OFFSET
...
// 0x0430 (0x0450 - 0x0020)
class UClientGlueHiaSystem : public UWorldSubsystem
{
public:
	unsigned char                                      UnknownData00[0x48];                                      // 0x0020(0x0048) MISSED OFFSET
	bool                                               bEnglish;                                                 // 0x0068(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x3];                                       // 0x0069(0x0003) MISSED OFFSET
	class UBaziState*                                  BaziState;                                                // 0x006C(0x0004) (ZeroConstructor, IsPlainOldData)
	class UMakeWoe*                                    MakeWoe;                                                  // 0x0070(0x0004) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData02[0x3DC];                                     // 0x0074(0x03DC) MISSED OFFSET
...
public:
	unsigned char                                      UnknownData00[0x4];                                       // 0x001C(0x0004) MISSED OFFSET
	float                                              ConfigMarginTime;                                         // 0x0020(0x0004) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x4];                                       // 0x0024(0x0004) MISSED OFFSET
	TMap<uint32_t, class UFullCoverMarginIntervalCharacterTickerInterval*> CurrentIntervalMap;                                       // 0x0028(0x0050) (ZeroConstructor)
	TMap<uint32_t, struct FPendingJudgeStruct>         PendingJudgeMap;                                          // 0x0064(0x0050) (ZeroConstructor)
	TArray<class UFullCoverMarginIntervalCharacterTickerInterval*> InfoObjectPool;                                           // 0x00A0(0x000C) (ZeroConstructor)
...
public:
	...
	struct FScriptMulticastDelegate                    OnEzioDelegate;                                           // 0x02A0(0x000C) (ZeroConstructor, InstancedReference)
	...
	unsigned char                                      UnknownData05[0x7B8];                                     // 0x0318(0x07B8) MISSED OFFSET
	class USCoronaClientData*                          SecurityCoronaLabClientDataPointer;                       // 0x0AD0(0x0004) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData06[0x54];                                      // 0x0AD4(0x0054) MISSED OFFSET
	bool                                               bMHActive;                                                // 0x0B28(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData07[0x83];                                      // 0x0B29(0x0083) MISSED OFFSET
	TMap<int, int>                                     FFItemIDMap;                                              // 0x0BAC(0x0050) (ZeroConstructor)
	TMap<int, int>                                     FFWeaponItemIDMap;                                        // 0x0BE8(0x0050) (ZeroConstructor)
	unsigned char                                      UnknownData08[0x1C];                                      // 0x0C24(0x001C) MISSED OFFSET
	int                                                ReceivedRotationModifiedCount;                            // 0x0C40(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                ReceivedTranslationModifiedCount;                         // 0x0C44(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                ReceivedScale3DModifiedCount;                             // 0x0C48(0x0004) (ZeroConstructor, IsPlainOldData)
	TArray<int>                                        LastInvalidIndexListInPakLite;                            // 0x0C4C(0x000C) (ZeroConstructor)
	unsigned char                                      UnknownData09[0x4];                                       // 0x0C58(0x0004) MISSED OFFSET
	struct FScriptMulticastDelegate                    OnServerReceiveInvalidFilesInPakLiteDelegate;             // 0x0C5C(0x000C) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	unsigned char                                      UnknownData10[0xB8];                                      // 0x0C68(0x00B8) MISSED OFFSET
	float                                              TouchScreenActiveTimeRatioThreshold;                      // 0x0D20(0x0004) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData11[0x4];                                       // 0x0D24(0x0004) MISSED OFFSET
	float                                              MouTa;                                                    // 0x0D28(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                BandaCountThreshold;                                      // 0x0D2C(0x0004) (ZeroConstructor, IsPlainOldData)
	bool                                               bEnableBandCount;                                         // 0x0D30(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData12[0x3];                                       // 0x0D31(0x0003) MISSED OFFSET
	float                                              IntervalThreshold1;                                       // 0x0D34(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                HongThreshold;                                            // 0x0D38(0x0004) (ZeroConstructor, IsPlainOldData)
	float                                              NovoThreshold;                                            // 0x0D3C(0x0004) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData13[0x38];                                      // 0x0D40(0x0038) MISSED OFFSET
	int                                                MaxCountOfPlayerHistoryLocationToDetectCamouflage;        // 0x0D78(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData14[0xC];                                       // 0x0D7C(0x000C) MISSED OFFSET
	float                                              MinDistanceToDetectCamouflage;                            // 0x0D88(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData15[0x4];                                       // 0x0D8C(0x0004) MISSED OFFSET
