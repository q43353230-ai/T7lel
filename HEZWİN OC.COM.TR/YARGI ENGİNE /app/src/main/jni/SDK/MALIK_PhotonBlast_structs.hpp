...
struct FPhotonHideReplicationData
{
	...
	TArray<EPhotonFracturedMeshFragmentState>          TargetFragmentsState;                                     // 0x0018(0x000C) (ZeroConstructor)
	float                                              ImpactTime;                                               // 0x0024(0x0004) (ZeroConstructor, Transient, IsPlainOldData, RepSkip, RepNotify, Interp, NonTransactional, EditorOnly, NoDestructor, AutoWeak, ContainsInstancedReference, AssetRegistrySearchable, SimpleDisplay, AdvancedDisplay, Protected, BlueprintCallable, BlueprintAuthorityOnly, TextExportTransient, NonPIEDuplicateTransient, ExposeOnSpawn, PersistentInstance, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic, NativeAccessSpecifierProtected, NativeAccessSpecifierPrivate)
};
...
{
	TArray<struct FChunkTransformData>                 ChunkTransformData;                                       // 0x0000(0x000C) (ZeroConstructor)
	EPhotonDestructibleState                           TargetDestructibleState;                                  // 0x000C(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x3];                                       // 0x000D(0x0003) MISSED OFFSET
	TArray<EPhotonFracturedMeshFragmentState>          TargetFragmentsState;                                     // 0x0010(0x000C) (ZeroConstructor)
};
...
struct FPhotonDestructibleFragmentStateData
{
	...
	TArray<EPhotonFracturedMeshFragmentState>          TargetFragmentsState;                                     // 0x001C(0x000C) (ZeroConstructor)
};
...
struct FEdgeNode
{
	TArray<int>                                        Edges;                                                    // 0x0000(0x000C) (ZeroConstructor)
	int                                                Size;                                                     // 0x000C(0x0004) (ZeroConstructor, IsPlainOldData)
};
...
{
	TArray<struct FEdgeNode>                           EdgeDatas;                                                // 0x0000(0x000C) (ZeroConstructor)
	int                                                Size;                                                     // 0x000C(0x0004) (ZeroConstructor, IsPlainOldData)
};
...
{
	TArray<struct FKConvexElem>                        ConvexElem;                                               // 0x0000(0x000C) (ZeroConstructor)
};
