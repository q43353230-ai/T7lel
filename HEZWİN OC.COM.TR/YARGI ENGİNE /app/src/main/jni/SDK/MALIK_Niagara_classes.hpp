...
{
public:
	unsigned char                                      UnknownData00[0xE4];                                      // 0x06C0(0x00E4) MISSED OFFSET
	unsigned char                                      bForceSolo : 1;                                           // 0x07A4(0x0001) (Edit)
	unsigned char                                      UnknownData01[0x1C];                                      // 0x07A5(0x001C) MISSED OFFSET
	unsigned char                                      bAutoDestroy : 1;                                         // 0x07C1(0x0001)
	unsigned char                                      bRenderingEnabled : 1;                                    // 0x07C1(0x0001)
	unsigned char                                      bAutoManageAttachment : 1;                                // 0x07C1(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly)
	unsigned char                                      UnknownData02[0x2];                                       // 0x07C2(0x0002) MISSED OFFSET
	struct FScriptMulticastDelegate                    OnSystemFinished;                                         // 0x07C4(0x000C) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	TWeakObjectPtr<class USceneComponent>              AutoAttachParent;                                         // 0x07D0(0x0008) (Edit, BlueprintVisible, ExportObject, ZeroConstructor, DisableEditOnTemplate, EditConst, InstancedReference, IsPlainOldData)
	struct FName                                       AutoAttachSocketName;                                     // 0x07D8(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	EAttachmentRule                                    AutoAttachLocationRule;                                   // 0x07E0(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	EAttachmentRule                                    AutoAttachRotationRule;                                   // 0x07E1(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	EAttachmentRule                                    AutoAttachScaleRule;                                      // 0x07E2(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData03[0x1];                                       // 0x07E3(0x0001) MISSED OFFSET
	int                                                PreviewDetailLevel;                                       // 0x07E4(0x0004) (Edit, ZeroConstructor, Transient, IsPlainOldData)
	float                                              PreviewLODDistance;                                       // 0x07E8(0x0004) (Edit, ZeroConstructor, Transient, IsPlainOldData)
	unsigned char                                      bEnablePreviewDetailLevel : 1;                            // 0x07EC(0x0001) (Edit, Transient)
	unsigned char                                      bEnablePreviewLODDistance : 1;                            // 0x07EC(0x0001) (Edit, Transient)
	unsigned char                                      UnknownData04[0x33];                                      // 0x07ED(0x0033) MISSED OFFSET
...
{
public:
	float                                              DecalScreenSizeFade;                                      // 0x0028(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x4];                                       // 0x002C(0x0004) MISSED OFFSET
	struct FNiagaraVariableAttributeBinding            PositionBinding;                                          // 0x0030(0x0060) (Edit)
	struct FNiagaraVariableAttributeBinding            DecalOrientationBinding;                                  // 0x0090(0x0060) (Edit)
	struct FNiagaraVariableAttributeBinding            DecalSizeBinding;                                         // 0x00F0(0x0060) (Edit)
	struct FNiagaraVariableAttributeBinding            DecalFadeBinding;                                         // 0x0150(0x0060) (Edit)
	struct FNiagaraVariableAttributeBinding            DecalSortOrderBinding;                                    // 0x01B0(0x0060) (Edit)
	struct FNiagaraVariableAttributeBinding            DecalVisibleBinding;                                      // 0x0210(0x0060) (Edit)
...
{
public:
	ENiagaraPreviewGridResetMode                       ResetMode;                                                // 0x0340(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x3];                                       // 0x0341(0x0003) MISSED OFFSET
	class UNiagaraPreviewAxis*                         PreviewAxisX;                                             // 0x0344(0x0004) (Edit, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData)
	class UNiagaraPreviewAxis*                         PreviewAxisY;                                             // 0x0348(0x0004) (Edit, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData)
	class UClass*                                      PreviewClass;                                             // 0x034C(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	float                                              SpacingX;                                                 // 0x0350(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	float                                              SpacingY;                                                 // 0x0354(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	int                                                NumX;                                                     // 0x0358(0x0004) (ZeroConstructor, Transient, IsPlainOldData)
	int                                                NumY;                                                     // 0x035C(0x0004) (ZeroConstructor, Transient, IsPlainOldData)
	TArray<class UChildActorComponent*>                PreviewComponents;                                        // 0x0360(0x000C) (ExportObject, ZeroConstructor, Transient)
