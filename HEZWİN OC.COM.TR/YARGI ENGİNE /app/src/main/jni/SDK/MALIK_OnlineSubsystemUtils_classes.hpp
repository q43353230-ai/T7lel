...
// 0x0040 (0x2B518 - 0x2B4D8)
class UIpConnection : public UNetConnection
{
public:
	unsigned char                                      UnknownData00[0x40];                                      // 0x2B4D8(0x0040) MISSED OFFSET
...
{
public:
	uint32_t                                           MaxPortCountToTry;                                        // 0x0520(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData00[0xC];                                       // 0x0524(0x000C) MISSED OFFSET
	uint32_t                                           ServerDesiredSocketReceiveBufferBytes;                    // 0x0530(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	uint32_t                                           ServerDesiredSocketSendBufferBytes;                       // 0x0534(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	uint32_t                                           ClientDesiredSocketReceiveBufferBytes;                    // 0x0538(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	uint32_t                                           ClientDesiredSocketSendBufferBytes;                       // 0x053C(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData01[0x4C];                                      // 0x0540(0x004C) MISSED OFFSET
	float                                              RecreateSocketCooldownTime;                               // 0x058C(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	float                                              RecreateSocketMaxTryCount;                                // 0x0590(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	bool                                               bResolveRemoteHostOnRecreateSocket;                       // 0x0594(0x0001) (ZeroConstructor, Config, IsPlainOldData)
	bool                                               bContinueProcessWhenReceiveEmptyPackets;                  // 0x0595(0x0001) (ZeroConstructor, Config, IsPlainOldData)
	bool                                               bContinueProcessWhenConReceiveEmptyPackets;               // 0x0596(0x0001) (ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData02[0x9];                                       // 0x0597(0x0009) MISSED OFFSET
...
public:
	...
	class UNetDriver*                                  NetDriver;                                                // 0x0348(0x0004) (ZeroConstructor, IsPlainOldData)
...
{
public:
	class AOnlineBeaconHostObject*                     BeaconOwner;                                              // 0x0358(0x0004) (ZeroConstructor, IsPlainOldData)
	class UNetConnection*                              BeaconConnection;                                         // 0x035C(0x0004) (ZeroConstructor, IsPlainOldData)
	EBeaconConnectionState                             ConnectionState;                                          // 0x0360(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x27];                                      // 0x0361(0x0027) MISSED OFFSET
...
{
public:
	int                                                ListenPort;                                               // 0x0358(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	TArray<class AOnlineBeaconClient*>                 ClientActors;                                             // 0x035C(0x000C) (ZeroConstructor)
	unsigned char                                      UnknownData00[0x78];                                      // 0x0368(0x0078) MISSED OFFSET
...
public:
	...
	class UClass*                                      ClientBeaconActorClass;                                   // 0x0348(0x0004) (ZeroConstructor, IsPlainOldData)
	TArray<class AOnlineBeaconClient*>                 ClientActors;                                             // 0x034C(0x000C) (ZeroConstructor)
...
{
public:
	unsigned char                                      UnknownData00[0x14];                                      // 0x0388(0x0014) MISSED OFFSET
	struct FString                                     DestSessionId;                                            // 0x039C(0x000C) (ZeroConstructor)
	struct FPartyReservation                           PendingReservation;                                       // 0x03A8(0x001C)
	EClientRequestType                                 RequestType;                                              // 0x03C4(0x0001) (ZeroConstructor, IsPlainOldData)
	bool                                               bPendingReservationSent;                                  // 0x03C5(0x0001) (ZeroConstructor, IsPlainOldData)
	bool                                               bCancelReservation;                                       // 0x03C6(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x29];                                      // 0x03C7(0x0029) MISSED OFFSET
...
{
public:
	class UPartyBeaconState*                           State;                                                    // 0x0358(0x0004) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x28];                                      // 0x035C(0x0028) MISSED OFFSET
	bool                                               bLogoutOnSessionTimeout;                                  // 0x0384(0x0001) (ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData01[0x3];                                       // 0x0385(0x0003) MISSED OFFSET
	float                                              SessionTimeoutSecs;                                       // 0x0388(0x0004) (ZeroConstructor, Transient, Config, IsPlainOldData)
	float                                              TravelSessionTimeoutSecs;                                 // 0x038C(0x0004) (ZeroConstructor, Transient, Config, IsPlainOldData)
