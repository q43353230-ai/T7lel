...
public:
	...
	bool                                               bStaticAddNetworkActor;                                   // 0x03D0(0x0001) (Edit, BlueprintVisible, ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      AutoDormancyType;                                         // 0x03D1(0x0001) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
...
public:
	...
	int                                                ModeID;                                                   // 0x0380(0x0004) (ZeroConstructor, IsPlainOldData)
	struct FString                                     ModType;                                                  // 0x0384(0x000C) (ZeroConstructor)
	struct FString                                     ModType2;                                                 // 0x0390(0x000C) (ZeroConstructor)
	TArray<struct FString>                             ExtraModules;                                             // 0x039C(0x000C) (ZeroConstructor)
...
{
public:
	unsigned char                                      UnknownData00[0xB4];                                      // 0x00C8(0x00B4) MISSED OFFSET
	int                                                ConfigAutoAddAttId;                                       // 0x017C(0x0004) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	unsigned char                                      UnknownData01[0x7C];                                      // 0x0180(0x007C) MISSED OFFSET
	TArray<struct FAttrModifyItem>                     ConfigAttrModifyList;                                     // 0x01FC(0x000C) (Edit, ZeroConstructor, DisableEditOnInstance)
	unsigned char                                      UnknownData02[0x3C];                                      // 0x0208(0x003C) MISSED OFFSET
	uint32_t                                           AttrModifyStateList;                                      // 0x0244(0x0004) (Net, ZeroConstructor, Transient, IsPlainOldData)
	unsigned char                                      UnknownData03[0x58];                                      // 0x0248(0x0058) MISSED OFFSET
	struct FRepAttributeModify                         DynamicModifierRep;                                       // 0x02A0(0x0010) (Net)
	struct FRepAttributeModify                         DynamicModifierRepOnlyOwner;                              // 0x02B0(0x0010) (Net)
	unsigned char                                      UnknownData04[0x14];                                      // 0x02C0(0x0014) MISSED OFFSET
	struct FScriptMulticastDelegate                    OnAttrModified;                                           // 0x02D4(0x000C) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptMulticastDelegate                    OnAttrRemoved;                                            // 0x02E0(0x000C) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FAttrDynamicModifier                        DynamicModifier;                                          // 0x02EC(0x007C)
	unsigned char                                      UnknownData05[0x3C];                                      // 0x0368(0x003C) MISSED OFFSET
	TArray<struct FAttributeExpand>                    AttributeExpands;                                         // 0x03A4(0x000C) (Edit, ZeroConstructor)
	bool                                               bAddReserveNum;                                           // 0x03B0(0x0001) (ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData06[0x3];                                       // 0x03B1(0x0003) MISSED OFFSET
	TMap<struct FString, struct FRelateAttributeGroup> RelateAttributeGroup;                                     // 0x03B4(0x0050) (ZeroConstructor)
	EActorRegAttrTableType                             ActorAttrType;                                            // 0x03F0(0x0001) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	unsigned char                                      UnknownData07[0xC7];                                      // 0x03F1(0x00C7) MISSED OFFSET
	TArray<struct FModAttrSimulateSyncItem>            ModSimulateSyncList;                                      // 0x04B8(0x000C) (Net, ZeroConstructor)
	unsigned char                                      UnknownData08[0xC8];                                      // 0x04C4(0x00C8) MISSED OFFSET
	struct FScriptMulticastDelegate                    OnNeedSetSpeedOverLimit;                                  // 0x058C(0x000C) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	unsigned char                                      UnknownData09[0xBC];                                      // 0x0598(0x00BC) MISSED OFFSET
...
public:
	...
	TMap<class UObject*, int>                          InstancedNodeNameToMemoryMap;                             // 0x00A8(0x0050) (ZeroConstructor)
	int                                                InstancedNodesTotalSize;                                  // 0x00E4(0x0004) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData05[0x40];                                      // 0x00E8(0x0040) MISSED OFFSET
...
public:
	...
	TMap<struct FName, struct FString>                 ActionParams;                                             // 0x00E0(0x0050) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor)
...
public:
	...
	bool                                               IsNeedExecute;                                            // 0x0063(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               IsSetFalseWhenExecute;                                    // 0x0064(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x3];                                       // 0x0065(0x0003) MISSED OFFSET
	TArray<struct FBuffConditionActionItem>            LinkActions;                                              // 0x0068(0x000C) (Edit, BlueprintVisible, ZeroConstructor)
...
public:
	...
	unsigned char                                      UnknownData01[0xCC];                                      // 0x008C(0x00CC) MISSED OFFSET
...
{
public:
	TArray<float>                                      FramesSkippedScreenSizeThresholds;                        // 0x00C8(0x000C) (Edit, BlueprintVisible, ZeroConstructor)
	TArray<int>                                        LODToFramesSkipped;                                       // 0x00D4(0x000C) (Edit, BlueprintVisible, ZeroConstructor)
	int                                                NonRenderedFramesSkipped;                                 // 0x00E0(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	int                                                MaxFramesSkippedForInterpolation;                         // 0x00E4(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bForceEnableAnimUpdateRateOptimizations;                  // 0x00E8(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
...
public:
	...
	bool                                               EnableTickOptimization;                                   // 0x02E4(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	ETickOptimizationDistanceMode                      DistanceMode;                                             // 0x02E5(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	...
	bool                                               bActorTickChange;                                         // 0x02FD(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               bComponentsTickControl;                                   // 0x02FE(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bComponentsTickChange;                                    // 0x02FF(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               bForceExecuteFirstTick;                                   // 0x0300(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData02[0x3];                                       // 0x0301(0x0003) MISSED OFFSET
	TArray<struct FTickOptimizationTickSettings>       TickSettings;                                             // 0x0304(0x000C) (Edit, BlueprintVisible, ZeroConstructor)
	bool                                               bForced;                                                  // 0x0310(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData03[0x3];                                       // 0x0311(0x0003) MISSED OFFSET
	int                                                TickZone;                                                 // 0x0314(0x0004) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	struct FScriptMulticastDelegate                    OnTickChanged;                                            // 0x0318(0x000C) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptMulticastDelegate                    OnTickZoneChanged;                                        // 0x0324(0x000C) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptMulticastDelegate                    OnTickEnabledChanged;                                     // 0x0330(0x000C) (ZeroConstructor, InstancedReference, BlueprintAssignable)
...
// 0x0290 (0x2B7A8 - 0x2B518)
class UUAENetConnection : public UIpConnection
{
public:
	unsigned char                                      UnknownData00[0x9C];                                      // 0x2B518(0x009C) MISSED OFFSET
	int                                                InitialHandshakeTimeoutNumThreshold;                      // 0x2B5B4(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData01[0x4];                                       // 0x2B5B8(0x0004) MISSED OFFSET
	int                                                ActorChannelProcessBunchErrorNumThreshold_Server_Global;  // 0x2B5BC(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	int                                                ActorChannelProcessBunchErrorNumThreshold_Client_Global;  // 0x2B5C0(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	int                                                ActorChannelProcessBunchErrorNumThreshold_Client_PerActor;// 0x2B5C4(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData02[0x3C];                                      // 0x2B5C8(0x003C) MISSED OFFSET
	bool                                               bEnableHTTPDNS;                                           // 0x2B604(0x0001) (ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData03[0x3];                                       // 0x2B605(0x0003) MISSED OFFSET
	struct FString                                     HTTPDNSServerAddr;                                        // 0x2B608(0x000C) (ZeroConstructor, Config)
	float                                              HTTPDNSResponseTimeout;                                   // 0x2B614(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData04[0x10];                                      // 0x2B618(0x0010) MISSED OFFSET
	float                                              CheckLevelInitializedTime;                                // 0x2B628(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	float                                              CheckLevelActorsOvertime;                                 // 0x2B62C(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	float                                              TempCheckLevelInitializedTime;                            // 0x2B630(0x0004) (ZeroConstructor, IsPlainOldData)
	TMap<struct FName, struct FUnLoadLevelActorCollection> UnLevelInitActors;                                        // 0x2B634(0x0050) (ZeroConstructor)
	class UNetRelevancyGroup*                          RelevancyGroup;                                           // 0x2B670(0x0004) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData05[0xC8];                                      // 0x2B674(0x00C8) MISSED OFFSET
	TArray<struct FPendingRegionNetworkObject>         PendingRegionNetworkObjects;                              // 0x2B73C(0x000C) (ZeroConstructor)
	float                                              MinRegionActorTickDelta;                                  // 0x2B748(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	float                                              MaxRegionActorTickDelta;                                  // 0x2B74C(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData06[0xC];                                       // 0x2B750(0x000C) MISSED OFFSET
	bool                                               EnableWeakNetUpdate;                                      // 0x2B75C(0x0001) (ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData07[0x3];                                       // 0x2B75D(0x0003) MISSED OFFSET
	float                                              MinWeakNetUpdateDelay;                                    // 0x2B760(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	float                                              MaxWeakNetUpdateDelay;                                    // 0x2B764(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	float                                              SquareSegmentSize;                                        // 0x2B768(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	float                                              MaxSegmentDistance;                                       // 0x2B76C(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	int                                                MaxObjectNumInSegments;                                   // 0x2B770(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData08[0xD];                                       // 0x2B774(0x000D) MISSED OFFSET
	bool                                               bRecreateSocketOnLost;                                    // 0x2B781(0x0001) (ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData09[0x12];                                      // 0x2B782(0x0012) MISSED OFFSET
	float                                              UpdateClientPingTimeThreshold;                            // 0x2B794(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData10[0x10];                                      // 0x2B798(0x0010) MISSED OFFSET
...
{
public:
	bool                                               bEnableCollectNetStats;                                   // 0x05A0(0x0001) (ZeroConstructor, Config, IsPlainOldData)
	bool                                               bEnableResetNetStats;                                     // 0x05A1(0x0001) (ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData00[0x106];                                     // 0x05A2(0x0106) MISSED OFFSET
...
public:
	...
	bool                                               bSpeedUpLoadLocalizationText;                             // 0x027A(0x0001) (ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData05[0x5];                                       // 0x027B(0x0005) MISSED OFFSET
	...
	struct FString                                     SplitModTableRelativeDir;                                 // 0x0298(0x000C) (ZeroConstructor, Config)
	TArray<struct FString>                             BaseModTableConfig;                                       // 0x02A4(0x000C) (ZeroConstructor, Config)
	TMap<struct FName, class UModTable*>               ModTableMap;                                              // 0x02B0(0x0050) (ZeroConstructor)
	TMap<struct FName, TWeakObjectPtr<class UUAEDataTable>> ModTableObjMap;                                           // 0x02EC(0x0050) (ZeroConstructor)
	TArray<class UUAEDataTable*>                       InGameTableObjList;                                       // 0x0328(0x000C) (ZeroConstructor)
	TMap<struct FName, bool>                           CheckNeedModMap;                                          // 0x0334(0x0050) (ZeroConstructor)
	struct FString                                     CurrentModName;                                           // 0x0370(0x000C) (ZeroConstructor)
	struct FString                                     EmptyModName;                                             // 0x037C(0x000C) (ZeroConstructor)
	TMap<struct FString, class UBaseTableResMap*>      LoadedTableMap;                                           // 0x0388(0x0050) (ZeroConstructor)
	TMap<struct FString, bool>                         CheckMapTable;                                            // 0x03C4(0x0050) (ZeroConstructor)
	unsigned char                                      UnknownData06[0x48];                                      // 0x0400(0x0048) MISSED OFFSET
