...
struct FUTSkillCreateData
{
	...
	TArray<class UUTSkillPhase*>                       Phases;                                                   // 0x001C(0x000C) (Edit, BlueprintVisible, ExportObject, ZeroConstructor, DisableEditOnInstance)
...
{
	TArray<struct FSkillActiveData>                    SkillData;                                                // 0x0000(0x000C) (ZeroConstructor)
...
{
	TArray<struct FSkillAttrData>                      SkillData;                                                // 0x0000(0x000C) (ZeroConstructor)
	unsigned char                                      UnknownData00[0x9C];                                      // 0x000C(0x009C) MISSED OFFSET
};
...
{
	TArray<int>                                        SkillData;                                                // 0x0000(0x000C) (ZeroConstructor)
	unsigned char                                      UnknownData00[0x9C];                                      // 0x000C(0x009C) MISSED OFFSET
};
...
{
	TArray<unsigned char>                              Data;                                                     // 0x0000(0x000C) (BlueprintVisible, ZeroConstructor)
};
...
struct FUTSkillSyncData_CD
{
	...
	TArray<unsigned char>                              SkillSyncDatas;                                           // 0x0008(0x000C) (ZeroConstructor)
	struct FSkillNetBytesData                          CDSyncDatas;                                              // 0x0014(0x000C)
};
...
{
	unsigned char                                      UnknownData00[0x3C];                                      // 0x0000(0x003C) UNKNOWN PROPERTY: SetProperty Skill.SkillDisableKeySet.KeySet
};
...
{
	unsigned char                                      UnknownData00[0x3C];                                      // 0x0000(0x003C) UNKNOWN PROPERTY: SetProperty Skill.SkillLimitKeySet.KeySet
};
...
struct FUTMultiSkillSynData
{
	...
	struct FSkillNetBytesData                          PhaseIndexArray;                                          // 0x0018(0x000C) (Edit, BlueprintVisible)
	TArray<unsigned char>                              BlackboardContent;                                        // 0x0024(0x000C) (Edit, BlueprintVisible, ZeroConstructor)
	struct FSkillNetBytesData                          BlackboardBytesData;                                      // 0x0030(0x000C) (BlueprintVisible)
...
{
	TArray<struct FUTMultiSkillSynData>                SkillData;                                                // 0x0000(0x000C) (ZeroConstructor)
	TArray<struct FUTMultiSkillSynData>                LastSkillData;                                            // 0x000C(0x000C) (ZeroConstructor, RepSkip, RepNotify, Interp, NonTransactional, EditorOnly, NoDestructor, AutoWeak, ContainsInstancedReference, AssetRegistrySearchable, SimpleDisplay, AdvancedDisplay, Protected, BlueprintCallable, BlueprintAuthorityOnly, TextExportTransient, NonPIEDuplicateTransient, ExposeOnSpawn, PersistentInstance, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic, NativeAccessSpecifierProtected, NativeAccessSpecifierPrivate)
	unsigned char                                      UnknownData00[0x9C];                                      // 0x0018(0x009C) MISSED OFFSET
};
...
struct FUTSkillSynSinglePhaseData
{
	...
	struct FSkillNetBytesData                          BlackboardBytesData;                                      // 0x0020(0x000C) (BlueprintVisible)
...
{
	TArray<struct FUTSkillSynSinglePhaseData>          SkillData;                                                // 0x0000(0x000C) (ZeroConstructor)
	TArray<struct FUTSkillSynSinglePhaseData>          LastSkillData;                                            // 0x000C(0x000C) (ZeroConstructor, RepSkip, RepNotify, Interp, NonTransactional, EditorOnly, NoDestructor, AutoWeak, ContainsInstancedReference, AssetRegistrySearchable, SimpleDisplay, AdvancedDisplay, Protected, BlueprintCallable, BlueprintAuthorityOnly, TextExportTransient, NonPIEDuplicateTransient, ExposeOnSpawn, PersistentInstance, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic, NativeAccessSpecifierProtected, NativeAccessSpecifierPrivate)
	unsigned char                                      UnknownData00[0x9C];                                      // 0x0018(0x009C) MISSED OFFSET
};
...
struct FUTSkillPhaseCreateData
{
	...
	bool                                               bAllowSimulateEvent;                                      // 0x0016(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bKeepTickState;                                           // 0x0017(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bKeepTickStateWithConditionCheck;                         // 0x0018(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x3];                                       // 0x0019(0x0003) MISSED OFFSET
	int                                                CoolDownIndex;                                            // 0x001C(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	TArray<class UUTSkillCondition*>                   PhaseConditions;                                          // 0x0020(0x000C) (Edit, BlueprintVisible, ExportObject, ZeroConstructor, DisableEditOnInstance)
	class UUTSkillPicker*                              Picker;                                                   // 0x002C(0x0004) (Edit, BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData)
	...
	TArray<struct FUAEBlackboardKeySelector>           SyncBBKArray;                                             // 0x0050(0x000C) (Edit, BlueprintVisible, ZeroConstructor)
...
struct FUTSkillPickerCreateData
{
	...
	bool                                               bForceSimPick;                                            // 0x001A(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bEnableTrace;                                             // 0x001B(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bEnableVehicleTrace;                                      // 0x001C(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bIsUsingViewRotation;                                     // 0x001D(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bIgnoreViewRotationPitch;                                 // 0x001E(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bPickByTrace;                                             // 0x001F(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bUseNewOffset;                                            // 0x0020(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bIgnoreOwnerVehicleWhenTracePlayer;                       // 0x0021(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bIgnoreDriverCharacter;                                   // 0x0022(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bOwnerActorMustBuilding;                                  // 0x0023(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
