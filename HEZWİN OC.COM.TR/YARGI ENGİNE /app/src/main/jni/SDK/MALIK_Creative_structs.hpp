...
{
	struct FString                                     EventType;                                                // 0x0000(0x000C) (ZeroConstructor)
	struct FString                                     EventID;                                                  // 0x000C(0x000C) (ZeroConstructor)
	struct FString                                     FunctionName;                                             // 0x0018(0x000C) (ZeroConstructor)
};
...
{
	struct FString                                     DestructionMeshPath;                                      // 0x0000(0x000C) (ZeroConstructor)
	struct FString                                     MeshPath;                                                 // 0x000C(0x000C) (ZeroConstructor)
	unsigned char                                      UnknownData00[0x8];                                       // 0x0018(0x0008) MISSED OFFSET
	struct FTransform                                  Transform;                                                // 0x0020(0x0030) (IsPlainOldData)
	TArray<struct FString>                             MaterialPaths;                                            // 0x0050(0x000C) (ZeroConstructor)
...
struct FCreativeAssetInfo
{
	...
	bool                                               bIsGroup;                                                 // 0x002D(0x0001) (ZeroConstructor, IsPlainOldData)
	int8_t                                             AssetCategory;                                            // 0x002E(0x0001) (ZeroConstructor, IsPlainOldData)
...
{
	TArray<struct FCreativeAutoGenItemDataSegment>     DataSegments;                                             // 0x0000(0x000C) (ZeroConstructor)
...
{
	struct FString                                     BlockIdString;                                            // 0x0000(0x000C) (Edit, BlueprintVisible, ZeroConstructor)
	struct FString                                     FormatString;                                             // 0x000C(0x000C) (Edit, BlueprintVisible, ZeroConstructor)
};
...
{
	class AActor*                                      AttachRoot;                                               // 0x0000(0x0004) (ZeroConstructor, IsPlainOldData)
	struct FVector                                     AttachPos;                                                // 0x0004(0x000C) (IsPlainOldData)
	int                                                Sequence;                                                 // 0x0010(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                ConfigId;                                                 // 0x0014(0x0004) (ZeroConstructor, IsPlainOldData)
	bool                                               bShowMark;                                                // 0x0018(0x0001) (ZeroConstructor, IsPlainOldData)
...
{
	TArray<struct FCreativePrefabDataSegmentSlice>     NodeSegmentContent;                                       // 0x0000(0x000C) (ZeroConstructor)
	int                                                MaxDataSize;                                              // 0x000C(0x0004) (ZeroConstructor, IsPlainOldData, RepSkip, RepNotify, Interp, NonTransactional, EditorOnly, NoDestructor, AutoWeak, ContainsInstancedReference, AssetRegistrySearchable, SimpleDisplay, AdvancedDisplay, Protected, BlueprintCallable, BlueprintAuthorityOnly, TextExportTransient, NonPIEDuplicateTransient, ExposeOnSpawn, PersistentInstance, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic, NativeAccessSpecifierProtected, NativeAccessSpecifierPrivate)
...
{
	int                                                PoolId;                                                   // 0x0000(0x0004) (ZeroConstructor, IsPlainOldData)
	class UObject*                                     NewOuter;                                                 // 0x0004(0x0004) (ZeroConstructor, IsPlainOldData)
	struct FString                                     InName;                                                   // 0x0008(0x000C) (ZeroConstructor)
};
...
struct FCreativeGameParameter : public FFastArraySerializerItem
{
	...
	uint32_t                                           ParameterHeadHash;                                        // 0x0040(0x0004) (ZeroConstructor, IsPlainOldData)
	uint32_t                                           ParameterHeadSize;                                        // 0x0044(0x0004) (ZeroConstructor, IsPlainOldData, RepSkip, RepNotify, Interp, NonTransactional, EditorOnly, NoDestructor, AutoWeak, ContainsInstancedReference, AssetRegistrySearchable, SimpleDisplay, AdvancedDisplay, Protected, BlueprintCallable, BlueprintAuthorityOnly, TextExportTransient, NonPIEDuplicateTransient, ExposeOnSpawn, PersistentInstance, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic, NativeAccessSpecifierProtected, NativeAccessSpecifierPrivate)
};
...
struct FCreativeGameParameterResume : public FFastArraySerializerItem
{
	...
	struct FString                                     ParameterKey;                                             // 0x0014(0x000C) (ZeroConstructor, RepSkip, RepNotify, Interp, NonTransactional, EditorOnly, NoDestructor, AutoWeak, ContainsInstancedReference, AssetRegistrySearchable, SimpleDisplay, AdvancedDisplay, Protected, BlueprintCallable, BlueprintAuthorityOnly, TextExportTransient, NonPIEDuplicateTransient, ExposeOnSpawn, PersistentInstance, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic, NativeAccessSpecifierProtected, NativeAccessSpecifierPrivate)
...
{
	TArray<struct FCreativeGameParameterResume>        Nodes;                                                    // 0x0088(0x000C) (ZeroConstructor)
	class UCreativeGameParameterManager*               GameParameterManager;                                     // 0x0094(0x0004) (ZeroConstructor, IsPlainOldData, RepSkip, RepNotify, Interp, NonTransactional, EditorOnly, NoDestructor, AutoWeak, ContainsInstancedReference, AssetRegistrySearchable, SimpleDisplay, AdvancedDisplay, Protected, BlueprintCallable, BlueprintAuthorityOnly, TextExportTransient, NonPIEDuplicateTransient, ExposeOnSpawn, PersistentInstance, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic, NativeAccessSpecifierProtected, NativeAccessSpecifierPrivate)
};
...
{
	TArray<struct FCreativeReplicatNode>               Nodes;                                                    // 0x0000(0x000C) (ZeroConstructor)
};
...
struct FCreativeNodeContainer : public FFastArraySerializer
{
	...
	bool                                               bIsRPCReplicatedContainer;                                // 0x0098(0x0001) (ZeroConstructor, IsPlainOldData, RepSkip, RepNotify, Interp, NonTransactional, EditorOnly, NoDestructor, AutoWeak, ContainsInstancedReference, AssetRegistrySearchable, SimpleDisplay, AdvancedDisplay, Protected, BlueprintCallable, BlueprintAuthorityOnly, TextExportTransient, NonPIEDuplicateTransient, ExposeOnSpawn, PersistentInstance, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic, NativeAccessSpecifierProtected, NativeAccessSpecifierPrivate)
	unsigned char                                      UnknownData00[0x3];                                       // 0x0099(0x0003) MISSED OFFSET
	uint32_t                                           CurRPCReplicatedInstanceContainerSeq;                     // 0x009C(0x0004) (ZeroConstructor, IsPlainOldData, RepSkip, RepNotify, Interp, NonTransactional, EditorOnly, NoDestructor, AutoWeak, ContainsInstancedReference, AssetRegistrySearchable, SimpleDisplay, AdvancedDisplay, Protected, BlueprintCallable, BlueprintAuthorityOnly, TextExportTransient, NonPIEDuplicateTransient, ExposeOnSpawn, PersistentInstance, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic, NativeAccessSpecifierProtected, NativeAccessSpecifierPrivate)
	TMap<uint32_t, struct FCreativeNodeContainerCacheInfo> HistoryContainerMap;                                      // 0x00A0(0x0050) (ZeroConstructor, RepSkip, RepNotify, Interp, NonTransactional, EditorOnly, NoDestructor, AutoWeak, ContainsInstancedReference, AssetRegistrySearchable, SimpleDisplay, AdvancedDisplay, Protected, BlueprintCallable, BlueprintAuthorityOnly, TextExportTransient, NonPIEDuplicateTransient, ExposeOnSpawn, PersistentInstance, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic, NativeAccessSpecifierProtected, NativeAccessSpecifierPrivate)
};
...
struct FCreativeInstanceNode
{
	...
	ECreativeDestructibleState                         DestructibleMeshState;                                    // 0x005C(0x0001) (ZeroConstructor, IsPlainOldData)
	ECreativeModeLoadType                              LoadType;                                                 // 0x005D(0x0001) (ZeroConstructor, IsPlainOldData)
	bool                                               bIsCustomUI;                                              // 0x005E(0x0001) (ZeroConstructor, IsPlainOldData)
...
{
	class UInstancedStaticMeshComponent*               ISMComponent;                                             // 0x0000(0x0004) (ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData)
	TMap<int, struct FCreativeFineBatchDataInfo>       BatchDataInfoMap;                                         // 0x0004(0x0050) (ZeroConstructor)
	TArray<int>                                        RecoveryBufferIndex;                                      // 0x0040(0x000C) (ZeroConstructor)
	bool                                               bIsUseHISM;                                               // 0x004C(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x3];                                       // 0x004D(0x0003) MISSED OFFSET
	TArray<struct FString>                             AllLoadedInstanceID;                                      // 0x0050(0x000C) (ZeroConstructor)
};
...
struct FCreativePerfData
{
	...
	struct FString                                     ObjName;                                                  // 0x0028(0x000C) (ZeroConstructor)
...
{
	struct FString                                     UGCInstanceID;                                            // 0x0000(0x000C) (ZeroConstructor)
	bool                                               IsActive;                                                 // 0x000C(0x0001) (ZeroConstructor, IsPlainOldData)
	bool                                               EnableDestructible;                                       // 0x000D(0x0001) (ZeroConstructor, IsPlainOldData)
	bool                                               CanBeDamagedByMelee;                                      // 0x000E(0x0001) (ZeroConstructor, IsPlainOldData)
	bool                                               CanBeDamagedByRocketLauncher;                             // 0x000F(0x0001) (ZeroConstructor, IsPlainOldData)
	bool                                               CanBeDamagedByThrowable;                                  // 0x0010(0x0001) (ZeroConstructor, IsPlainOldData)
	bool                                               CanBeDamagedByVehicle;                                    // 0x0011(0x0001) (ZeroConstructor, IsPlainOldData)
	bool                                               OnlyHalfBroken;                                           // 0x0012(0x0001) (ZeroConstructor, IsPlainOldData)
...
struct FCreativeInstanceGridCellInfo
{
	...
	struct FIntVector                                  CellIndex;                                                // 0x000C(0x000C) (IsPlainOldData)
};
...
struct FCreativeObjectPoolClassConfig
{
	...
	bool                                               bPickObjectHandleIsExist;                                 // 0x001A(0x0001) (ZeroConstructor, IsPlainOldData)
	bool                                               bObjectReturnHandleIsExist;                               // 0x001B(0x0001) (ZeroConstructor, IsPlainOldData)
};
...
struct FCreativeDestructibleMeshInstanceInfo
{
	...
	struct FString                                     InstanceID;                                               // 0x0008(0x000C) (ZeroConstructor)
	struct FIntVector                                  CellIndex;                                                // 0x0014(0x000C) (IsPlainOldData)
	bool                                               bManualLoad;                                              // 0x0020(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x3];                                       // 0x0021(0x0003) MISSED OFFSET
};
...
struct FCreativeDestructibleMeshBatchInfo
{
	...
	TMap<struct FString, int>                          CurInstances;                                             // 0x003C(0x0050) (ZeroConstructor)
	bool                                               bIsUseHISM;                                               // 0x0078(0x0001) (ZeroConstructor, IsPlainOldData)
	bool                                               bIsDirty;                                                 // 0x0079(0x0001) (ZeroConstructor, IsPlainOldData)
...
struct FCreativeSpawnObjectInfo
{
	...
	bool                                               bIsGroupObj;                                              // 0x0051(0x0001) (ZeroConstructor, IsPlainOldData)
	bool                                               bCanBatch;                                                // 0x0052(0x0001) (ZeroConstructor, IsPlainOldData)
...
struct FCreativeEventBindingChangeInfo
{
	...
	uint16_t                                           FuncIndex;                                                // 0x001C(0x0002) (ZeroConstructor, IsPlainOldData)
...
struct FDancerDeviceSyncPlayerInfo
{
	...
	TArray<struct FDancerDeviceSyncPlayerAvatarDataInfo> AvatarDataList;                                           // 0x0024(0x000C) (ZeroConstructor)
	int                                                PlayingActionID;                                          // 0x0030(0x0004) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x4];                                       // 0x0034(0x0004) MISSED OFFSET
	double                                             StartPlayActionServerTime;                                // 0x0038(0x0008) (ZeroConstructor, IsPlainOldData)
};
